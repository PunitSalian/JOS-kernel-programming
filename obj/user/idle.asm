...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 c4 	movl   $0x800fc4,0x802000
  800040:	0f 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800107:	68 d3 0f 80 00       	push   $0x800fd3
  80010c:	6a 23                	push   $0x23
  80010e:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800188:	68 d3 0f 80 00       	push   $0x800fd3
  80018d:	6a 23                	push   $0x23
  80018f:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ca:	68 d3 0f 80 00       	push   $0x800fd3
  8001cf:	6a 23                	push   $0x23
  8001d1:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80020c:	68 d3 0f 80 00       	push   $0x800fd3
  800211:	6a 23                	push   $0x23
  800213:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80024e:	68 d3 0f 80 00       	push   $0x800fd3
  800253:	6a 23                	push   $0x23
  800255:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800290:	68 d3 0f 80 00       	push   $0x800fd3
  800295:	6a 23                	push   $0x23
  800297:	68 f0 0f 80 00       	push   $0x800ff0
...
sys_ipc_recv(void *dstva)
{
  ...
  8002f4:	68 d3 0f 80 00       	push   $0x800fd3
  8002f9:	6a 23                	push   $0x23
  8002fb:	68 f0 0f 80 00       	push   $0x800ff0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800329:	56                   	push   %esi
  80032a:	50                   	push   %eax
  80032b:	68 00 10 80 00       	push   $0x801000
  ...
  80033c:	e8 54 00 00 00       	call   800395 <vcprintf>
	cprintf("\n");
  800341:	c7 04 24 24 10 80 00 	movl   $0x801024,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800494:	0f be 80 26 10 80 00 	movsbl 0x801026(%eax),%eax
  80049b:	50                   	push   %eax
...
void
  ...
  800556:	ff 24 85 b4 10 80 00 	jmp    *0x8010b4(,%eax,4)
  ...
  80061d:	8b 14 85 0c 12 80 00 	mov    0x80120c(,%eax,4),%edx
  800624:	85 d2                	test   %edx,%edx
  800626:	75 1b                	jne    800643 <vprintfmt+0x160>
				err = -err;
  800628:	50                   	push   %eax
  800629:	68 3e 10 80 00       	push   $0x80103e
  80062e:	53                   	push   %ebx
  80062f:	56                   	push   %esi
  ...
  800643:	52                   	push   %edx
  800644:	68 47 10 80 00       	push   $0x801047
  800649:	53                   	push   %ebx
  80064a:	56                   	push   %esi
  ...
  80066e:	b8 37 10 80 00       	mov    $0x801037,%eax
