...
umain(int argc, char **argv)
{
  ...
  80003f:	68 c4 0f 80 00       	push   $0x800fc4
...
libmain(int argc, char **argv)
{
  ...
  800059:	e8 a4 0a 00 00       	call   800b02 <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e7:	0f be 80 f5 0f 80 00 	movsbl 0x800ff5(%eax),%eax
  8001ee:	50                   	push   %eax
...
void
  ...
  8002a9:	ff 24 85 84 10 80 00 	jmp    *0x801084(,%eax,4)
  ...
  800369:	29 d0                	sub    %edx,%eax
		case 'e':
			err = va_arg(ap, int);
			if (err < 0)
  80036b:	83 f8 06             	cmp    $0x6,%eax
  80036e:	7f 0b                	jg     80037b <vprintfmt+0x145>
  800370:	8b 14 85 dc 11 80 00 	mov    0x8011dc(,%eax,4),%edx
  800377:	85 d2                	test   %edx,%edx
  800379:	75 1b                	jne    800396 <vprintfmt+0x160>
				err = -err;
  80037b:	50                   	push   %eax
  80037c:	68 0d 10 80 00       	push   $0x80100d
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  800396:	52                   	push   %edx
  800397:	68 16 10 80 00       	push   $0x801016
  80039c:	53                   	push   %ebx
  80039d:	56                   	push   %esi
  ...
  8003c1:	b8 06 10 80 00       	mov    $0x801006,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae9:	68 f8 11 80 00       	push   $0x8011f8
  800aee:	6a 23                	push   $0x23
  800af0:	68 15 12 80 00       	push   $0x801215
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b6a:	68 f8 11 80 00       	push   $0x8011f8
  800b6f:	6a 23                	push   $0x23
  800b71:	68 15 12 80 00       	push   $0x801215
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bac:	68 f8 11 80 00       	push   $0x8011f8
  800bb1:	6a 23                	push   $0x23
  800bb3:	68 15 12 80 00       	push   $0x801215
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bee:	68 f8 11 80 00       	push   $0x8011f8
  800bf3:	6a 23                	push   $0x23
  800bf5:	68 15 12 80 00       	push   $0x801215
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c30:	68 f8 11 80 00       	push   $0x8011f8
  800c35:	6a 23                	push   $0x23
  800c37:	68 15 12 80 00       	push   $0x801215
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c72:	68 f8 11 80 00       	push   $0x8011f8
  800c77:	6a 23                	push   $0x23
  800c79:	68 15 12 80 00       	push   $0x801215
...
sys_ipc_recv(void *dstva)
{
  ...
  800cd6:	68 f8 11 80 00       	push   $0x8011f8
  800cdb:	6a 23                	push   $0x23
  800cdd:	68 15 12 80 00       	push   $0x801215
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d0b:	56                   	push   %esi
  800d0c:	50                   	push   %eax
  800d0d:	68 24 12 80 00       	push   $0x801224
  ...
  800d1e:	e8 c5 f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800d23:	c7 04 24 48 12 80 00 	movl   $0x801248,(%esp)
