...
handler(struct UTrapframe *utf)
{
  ...
  80003d:	8b 18                	mov    (%eax),%ebx
	...
	cprintf("fault %x\n", addr);
  80003f:	53                   	push   %ebx
  800040:	68 64 10 80 00       	push   $0x801064
  ...
  800068:	50                   	push   %eax
  800069:	53                   	push   %ebx
  80006a:	68 84 10 80 00       	push   $0x801084
  80006f:	6a 0e                	push   $0xe
  800071:	68 6e 10 80 00       	push   $0x80106e
  800076:	e8 a7 00 00 00       	call   800122 <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  80007b:	53                   	push   %ebx
  80007c:	68 b0 10 80 00       	push   $0x8010b0
...
umain(int argc, char **argv)
{
  ...
  8000a9:	68 80 10 80 00       	push   $0x801080
  8000ae:	e8 48 01 00 00       	call   8001fb <cprintf>
	cprintf("%s\n", (char*)0xCafeBffe);
  8000b3:	83 c4 08             	add    $0x8,%esp
  8000b6:	68 fe bf fe ca       	push   $0xcafebffe
  8000bb:	68 80 10 80 00       	push   $0x801080
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013e:	56                   	push   %esi
  80013f:	50                   	push   %eax
  800140:	68 dc 10 80 00       	push   $0x8010dc
  ...
  800151:	e8 54 00 00 00       	call   8001aa <vcprintf>
	cprintf("\n");
  800156:	c7 04 24 82 10 80 00 	movl   $0x801082,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a9:	0f be 80 ff 10 80 00 	movsbl 0x8010ff(%eax),%eax
  8002b0:	50                   	push   %eax
...
void
  ...
  80036b:	ff 24 85 8c 11 80 00 	jmp    *0x80118c(,%eax,4)
  ...
  800432:	8b 14 85 e4 12 80 00 	mov    0x8012e4(,%eax,4),%edx
  800439:	85 d2                	test   %edx,%edx
  80043b:	75 1b                	jne    800458 <vprintfmt+0x160>
				err = -err;
  80043d:	50                   	push   %eax
  80043e:	68 17 11 80 00       	push   $0x801117
  800443:	53                   	push   %ebx
  800444:	56                   	push   %esi
  ...
  800458:	52                   	push   %edx
  800459:	68 20 11 80 00       	push   $0x801120
  80045e:	53                   	push   %ebx
  80045f:	56                   	push   %esi
  ...
  800483:	b8 10 11 80 00       	mov    $0x801110,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bab:	68 00 13 80 00       	push   $0x801300
  800bb0:	6a 23                	push   $0x23
  800bb2:	68 1d 13 80 00       	push   $0x80131d
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c2c:	68 00 13 80 00       	push   $0x801300
  800c31:	6a 23                	push   $0x23
  800c33:	68 1d 13 80 00       	push   $0x80131d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c6e:	68 00 13 80 00       	push   $0x801300
  800c73:	6a 23                	push   $0x23
  800c75:	68 1d 13 80 00       	push   $0x80131d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb0:	68 00 13 80 00       	push   $0x801300
  800cb5:	6a 23                	push   $0x23
  800cb7:	68 1d 13 80 00       	push   $0x80131d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf2:	68 00 13 80 00       	push   $0x801300
  800cf7:	6a 23                	push   $0x23
  800cf9:	68 1d 13 80 00       	push   $0x80131d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d34:	68 00 13 80 00       	push   $0x801300
  800d39:	6a 23                	push   $0x23
  800d3b:	68 1d 13 80 00       	push   $0x80131d
...
sys_ipc_recv(void *dstva)
{
  ...
  800d98:	68 00 13 80 00       	push   $0x801300
  800d9d:	6a 23                	push   $0x23
  800d9f:	68 1d 13 80 00       	push   $0x80131d
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dbe:	75 14                	jne    800dd4 <set_pgfault_handler+0x23>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800dc0:	83 ec 04             	sub    $0x4,%esp
  800dc3:	68 2c 13 80 00       	push   $0x80132c
  800dc8:	6a 20                	push   $0x20
  800dca:	68 50 13 80 00       	push   $0x801350
  800dcf:	e8 4e f3 ff ff       	call   800122 <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800dd4:	8b 45 08             	mov    0x8(%ebp),%eax
  800dd7:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800ddc:	c9                   	leave  
  800ddd:	c3                   	ret    
