...
f0100046:	b8 d0 cc 17 f0       	mov    $0xf017ccd0,%eax
f010004b:	2d aa bd 17 f0       	sub    $0xf017bdaa,%eax
f0100050:	50                   	push   %eax
f0100051:	6a 00                	push   $0x0
f0100053:	68 aa bd 17 f0       	push   $0xf017bdaa
f0100058:	e8 86 40 00 00       	call   f01040e3 <memset>
...
f010006a:	68 80 45 10 f0       	push   $0xf0104580
...
f0100088:	68 e6 0b 13 f0       	push   $0xf0130be6
...
f0100095:	ff 35 04 c0 17 f0    	pushl  0xf017c004
...
f01000a5:	8b 75 10             	mov    0x10(%ebp),%esi
	...
	if (panicstr)
f01000a8:	83 3d c0 cc 17 f0 00 	cmpl   $0x0,0xf017ccc0
f01000af:	75 37                	jne    f01000e8 <_panic+0x48>
		goto dead;
	panicstr = fmt;
f01000b1:	89 35 c0 cc 17 f0    	mov    %esi,0xf017ccc0
...
f01000c5:	68 9b 45 10 f0       	push   $0xf010459b
...
f01000d4:	e8 31 2d 00 00       	call   f0102e0a <vcprintf>
	cprintf("\n");
f01000d9:	c7 04 24 3f 55 10 f0 	movl   $0xf010553f,(%esp)
...
f0100107:	68 b3 45 10 f0       	push   $0xf01045b3
...
f0100118:	e8 ed 2c 00 00       	call   f0102e0a <vcprintf>
	cprintf("\n");
f010011d:	c7 04 24 3f 55 10 f0 	movl   $0xf010553f,(%esp)
...
f010015f:	8b 0d e4 bf 17 f0    	mov    0xf017bfe4,%ecx
f0100165:	8d 51 01             	lea    0x1(%ecx),%edx
f0100168:	89 15 e4 bf 17 f0    	mov    %edx,0xf017bfe4
f010016e:	88 81 e0 bd 17 f0    	mov    %al,-0xfe84220(%ecx)
		if (cons.wpos == CONSBUFSIZE)
f0100174:	81 fa 00 02 00 00    	cmp    $0x200,%edx
f010017a:	75 0a                	jne    f0100186 <cons_intr+0x36>
			cons.wpos = 0;
f010017c:	c7 05 e4 bf 17 f0 00 	movl   $0x0,0xf017bfe4
f0100183:	00 00 00 
static void
cons_intr(int (*proc)(void))
{
...
f01001b3:	75 0d                	jne    f01001c2 <kbd_proc_data+0x2f>
		// E0 escape character
		shift |= E0ESC;
f01001b5:	83 0d c0 bd 17 f0 40 	orl    $0x40,0xf017bdc0
		return 0;
...
f01001cd:	8b 0d c0 bd 17 f0    	mov    0xf017bdc0,%ecx
...
f0100216:	89 0d c0 bd 17 f0    	mov    %ecx,0xf017bdc0
	}

	shift |= shiftcode[data];
f010021c:	0f b6 d2             	movzbl %dl,%edx
	shift ^= togglecode[data];
f010021f:	0f b6 82 20 47 10 f0 	movzbl -0xfefb8e0(%edx),%eax
f0100226:	0b 05 c0 bd 17 f0    	or     0xf017bdc0,%eax
f010022c:	0f b6 8a 20 46 10 f0 	movzbl -0xfefb9e0(%edx),%ecx
f0100233:	31 c8                	xor    %ecx,%eax
f0100235:	a3 c0 bd 17 f0       	mov    %eax,0xf017bdc0

	c = charcode[shift & (CTL | SHIFT)][data];
f010023a:	89 c1                	mov    %eax,%ecx
f010023c:	83 e1 03             	and    $0x3,%ecx
f010023f:	8b 0c 8d 00 46 10 f0 	mov    -0xfefba00(,%ecx,4),%ecx
...
f010027d:	68 cd 45 10 f0       	push   $0xf01045cd
...
f0100397:	eb 78                	jmp    f0100411 <cons_putc+0x165>
	...
	case '\n':
		crt_pos += CRT_COLS;
f0100399:	66 83 05 e8 bf 17 f0 	addw   $0x50,0xf017bfe8
f01003a0:	50 
		/* fallthru */
	case '\r':
		crt_pos -= (crt_pos % CRT_COLS);
f01003a1:	0f b7 05 e8 bf 17 f0 	movzwl 0xf017bfe8,%eax
...
f01003b7:	66 a3 e8 bf 17 f0    	mov    %ax,0xf017bfe8
...
f01003f3:	0f b7 05 e8 bf 17 f0 	movzwl 0xf017bfe8,%eax
f01003fa:	8d 50 01             	lea    0x1(%eax),%edx
f01003fd:	66 89 15 e8 bf 17 f0 	mov    %dx,0xf017bfe8
f0100404:	0f b7 c0             	movzwl %ax,%eax
f0100407:	8b 15 ec bf 17 f0    	mov    0xf017bfec,%edx
f010040d:	66 89 3c 42          	mov    %di,(%edx,%eax,2)
	...
	if (crt_pos >= CRT_SIZE) {
f0100411:	66 81 3d e8 bf 17 f0 	cmpw   $0x7cf,0xf017bfe8
f0100418:	cf 07 
f010041a:	76 43                	jbe    f010045f <cons_putc+0x1b3>
		int i;

		memmove(crt_buf, crt_buf + CRT_COLS, (CRT_SIZE - CRT_COLS) * sizeof(uint16_t));
f010041c:	a1 ec bf 17 f0       	mov    0xf017bfec,%eax
...
f0100431:	e8 fa 3c 00 00       	call   f0104130 <memmove>
		for (i = CRT_SIZE - CRT_COLS; i < CRT_SIZE; i++)
			crt_buf[i] = 0x0700 | ' ';
f0100436:	8b 15 ec bf 17 f0    	mov    0xf017bfec,%edx
...
f0100455:	75 f4                	jne    f010044b <cons_putc+0x19f>
			crt_buf[i] = 0x0700 | ' ';
		crt_pos -= CRT_COLS;
f0100457:	66 83 2d e8 bf 17 f0 	subw   $0x50,0xf017bfe8
f010045e:	50 
	}

	/* move that little blinky thing */
	outb(addr_6845, 14);
f010045f:	8b 0d f0 bf 17 f0    	mov    0xf017bff0,%ecx
f0100465:	b8 0e 00 00 00       	mov    $0xe,%eax
f010046a:	89 ca                	mov    %ecx,%edx
f010046c:	ee                   	out    %al,(%dx)
	outb(addr_6845 + 1, crt_pos >> 8);
f010046d:	0f b7 1d e8 bf 17 f0 	movzwl 0xf017bfe8,%ebx
...
{
	if (serial_exists)
f0100495:	80 3d f4 bf 17 f0 00 	cmpb   $0x0,0xf017bff4
...
f01004d3:	a1 e0 bf 17 f0       	mov    0xf017bfe0,%eax
f01004d8:	3b 05 e4 bf 17 f0    	cmp    0xf017bfe4,%eax
f01004de:	74 26                	je     f0100506 <cons_getc+0x43>
		c = cons.buf[cons.rpos++];
f01004e0:	8d 50 01             	lea    0x1(%eax),%edx
f01004e3:	89 15 e0 bf 17 f0    	mov    %edx,0xf017bfe0
f01004e9:	0f b6 88 e0 bd 17 f0 	movzbl -0xfe84220(%eax),%ecx
...
f01004f8:	75 11                	jne    f010050b <cons_getc+0x48>
			cons.rpos = 0;
f01004fa:	c7 05 e0 bf 17 f0 00 	movl   $0x0,0xf017bfe0
f0100501:	00 00 00 
...
f0100531:	74 11                	je     f0100544 <cons_init+0x37>
		...
		addr_6845 = MONO_BASE;
f0100533:	c7 05 f0 bf 17 f0 b4 	movl   $0x3b4,0xf017bff0
f010053a:	03 00 00 
...
f0100544:	66 89 15 00 80 0b f0 	mov    %dx,0xf00b8000
		addr_6845 = CGA_BASE;
f010054b:	c7 05 f0 bf 17 f0 d4 	movl   $0x3d4,0xf017bff0
f0100552:	03 00 00 
{
	volatile uint16_t *cp;
	uint16_t was;
...
f0100555:	be 00 80 0b f0       	mov    $0xf00b8000,%esi
	...
	outb(addr_6845, 14);
f010055a:	8b 3d f0 bf 17 f0    	mov    0xf017bff0,%edi
...
f010057e:	ec                   	in     (%dx),%al
	...
	crt_buf = (uint16_t*) cp;
f010057f:	89 35 ec bf 17 f0    	mov    %esi,0xf017bfec
	crt_pos = pos;
f0100585:	0f b6 c0             	movzbl %al,%eax
f0100588:	09 c8                	or     %ecx,%eax
f010058a:	66 a3 e8 bf 17 f0    	mov    %ax,0xf017bfe8
}
...
f01005eb:	0f 95 05 f4 bf 17 f0 	setne  0xf017bff4
...
f0100600:	68 d9 45 10 f0       	push   $0xf01045d9
...
f0100646:	68 20 48 10 f0       	push   $0xf0104820
f010064b:	68 3e 48 10 f0       	push   $0xf010483e
f0100650:	68 43 48 10 f0       	push   $0xf0104843
f0100655:	e8 d6 27 00 00       	call   f0102e30 <cprintf>
f010065a:	83 c4 0c             	add    $0xc,%esp
f010065d:	68 ac 48 10 f0       	push   $0xf01048ac
f0100662:	68 4c 48 10 f0       	push   $0xf010484c
f0100667:	68 43 48 10 f0       	push   $0xf0104843
...
f01006a7:	68 fc 48 10 f0       	push   $0xf01048fc
f01006ac:	e8 7f 27 00 00       	call   f0102e30 <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f01006b1:	83 c4 0c             	add    $0xc,%esp
f01006b4:	68 71 45 10 00       	push   $0x104571
f01006b9:	68 71 45 10 f0       	push   $0xf0104571
f01006be:	68 20 49 10 f0       	push   $0xf0104920
f01006c3:	e8 68 27 00 00       	call   f0102e30 <cprintf>
	cprintf("  edata  %08x (virt)  %08x (phys)\n", edata, edata - KERNBASE);
f01006c8:	83 c4 0c             	add    $0xc,%esp
f01006cb:	68 aa bd 17 00       	push   $0x17bdaa
f01006d0:	68 aa bd 17 f0       	push   $0xf017bdaa
f01006d5:	68 44 49 10 f0       	push   $0xf0104944
f01006da:	e8 51 27 00 00       	call   f0102e30 <cprintf>
	cprintf("  end    %08x (virt)  %08x (phys)\n", end, end - KERNBASE);
f01006df:	83 c4 0c             	add    $0xc,%esp
f01006e2:	68 d0 cc 17 00       	push   $0x17ccd0
f01006e7:	68 d0 cc 17 f0       	push   $0xf017ccd0
f01006ec:	68 68 49 10 f0       	push   $0xf0104968
f01006f1:	e8 3a 27 00 00       	call   f0102e30 <cprintf>
	cprintf("Kernel executable memory footprint: %dKB\n",
		ROUNDUP(end - entry, 1024) / 1024);
f01006f6:	b8 cf d0 17 f0       	mov    $0xf017d0cf,%eax
...
f0100717:	68 8c 49 10 f0       	push   $0xf010498c
...
f010073b:	68 b8 49 10 f0       	push   $0xf01049b8
f0100740:	e8 eb 26 00 00       	call   f0102e30 <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f0100745:	c7 04 24 dc 49 10 f0 	movl   $0xf01049dc,(%esp)
...
f0100760:	e8 05 2b 00 00       	call   f010326a <print_trapframe>
f0100765:	83 c4 10             	add    $0x10,%esp

	while (1) {
		buf = readline("K> ");
f0100768:	83 ec 0c             	sub    $0xc,%esp
f010076b:	68 6e 48 10 f0       	push   $0xf010486e
f0100770:	e8 17 37 00 00       	call   f0103e8c <readline>
...
f01007a4:	68 72 48 10 f0       	push   $0xf0104872
f01007a9:	e8 f8 38 00 00       	call   f01040a6 <strchr>
...
f01007c4:	68 77 48 10 f0       	push   $0xf0104877
...
f01007ed:	68 72 48 10 f0       	push   $0xf0104872
f01007f2:	e8 af 38 00 00       	call   f01040a6 <strchr>
...
f0100813:	68 3e 48 10 f0       	push   $0xf010483e
f0100818:	ff 75 a8             	pushl  -0x58(%ebp)
f010081b:	e8 28 38 00 00       	call   f0104048 <strcmp>
...
f010082a:	68 4c 48 10 f0       	push   $0xf010484c
f010082f:	ff 75 a8             	pushl  -0x58(%ebp)
f0100832:	e8 11 38 00 00       	call   f0104048 <strcmp>
...
f010085a:	ff 14 85 0c 4a 10 f0 	call   *-0xfefb5f4(,%eax,4)
		print_trapframe(tf);
...
f0100873:	68 94 48 10 f0       	push   $0xf0104894
...
f01008b6 <boot_alloc>:
	...
	if (!nextfree) {
f01008b6:	83 3d f8 bf 17 f0 00 	cmpl   $0x0,0xf017bff8
f01008bd:	75 11                	jne    f01008d0 <boot_alloc+0x1a>
		extern char end[];
		nextfree = ROUNDUP((char *) end, PGSIZE);
f01008bf:	ba cf dc 17 f0       	mov    $0xf017dccf,%edx
f01008c4:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f01008ca:	89 15 f8 bf 17 f0    	mov    %edx,0xf017bff8
	//
...
f01008ee:	a1 c4 cc 17 f0       	mov    0xf017ccc4,%eax
...
f0100901:	c3                   	ret    
	...
	{
	return nextfree;	
f0100902:	a1 f8 bf 17 f0       	mov    0xf017bff8,%eax
f0100907:	c3                   	ret    
...
f010090b:	83 ec 0c             	sub    $0xc,%esp
    ...
    {
    panic("Out of memory \n");
f010090e:	68 1c 4a 10 f0       	push   $0xf0104a1c
f0100913:	6a 7a                	push   $0x7a
f0100915:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100935:	3b 0d c4 cc 17 f0    	cmp    0xf017ccc4,%ecx
...
f0100944:	68 24 4d 10 f0       	push   $0xf0104d24
f0100949:	68 34 03 00 00       	push   $0x334
f010094e:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010099c:	68 48 4d 10 f0       	push   $0xf0104d48
f01009a1:	68 72 02 00 00       	push   $0x272
f01009a6:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01009be:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f01009f4:	a3 fc bf 17 f0       	mov    %eax,0xf017bffc
//
static void
check_page_free_list(bool only_low_memory)
{
...
f01009f9:	be 01 00 00 00       	mov    $0x1,%esi
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f01009fe:	8b 1d fc bf 17 f0    	mov    0xf017bffc,%ebx
...
f0100a08:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0100a22:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f0100a28:	72 12                	jb     f0100a3c <check_page_free_list+0xb9>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100a2a:	50                   	push   %eax
f0100a2b:	68 24 4d 10 f0       	push   $0xf0104d24
f0100a30:	6a 56                	push   $0x56
f0100a32:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0100a4f:	e8 8f 36 00 00       	call   f01040e3 <memset>
...
f0100a67:	89 45 cc             	mov    %eax,-0x34(%ebp)
	for (pp = page_free_list; pp; pp = pp->pp_link) {
f0100a6a:	8b 15 fc bf 17 f0    	mov    0xf017bffc,%edx
		// check that we didn't corrupt the free list itself
		assert(pp >= pages);
f0100a70:	8b 0d cc cc 17 f0    	mov    0xf017cccc,%ecx
		assert(pp < pages + npages);
f0100a76:	a1 c4 cc 17 f0       	mov    0xf017ccc4,%eax
...
f0100a95:	68 46 4a 10 f0       	push   $0xf0104a46
f0100a9a:	68 52 4a 10 f0       	push   $0xf0104a52
f0100a9f:	68 8c 02 00 00       	push   $0x28c
f0100aa4:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100ab2:	68 67 4a 10 f0       	push   $0xf0104a67
f0100ab7:	68 52 4a 10 f0       	push   $0xf0104a52
f0100abc:	68 8d 02 00 00       	push   $0x28d
f0100ac1:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100ad4:	68 6c 4d 10 f0       	push   $0xf0104d6c
f0100ad9:	68 52 4a 10 f0       	push   $0xf0104a52
f0100ade:	68 8e 02 00 00       	push   $0x28e
f0100ae3:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100af7:	68 7b 4a 10 f0       	push   $0xf0104a7b
f0100afc:	68 52 4a 10 f0       	push   $0xf0104a52
f0100b01:	68 91 02 00 00       	push   $0x291
f0100b06:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100b17:	68 8c 4a 10 f0       	push   $0xf0104a8c
f0100b1c:	68 52 4a 10 f0       	push   $0xf0104a52
f0100b21:	68 92 02 00 00       	push   $0x292
f0100b26:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100b37:	68 a0 4d 10 f0       	push   $0xf0104da0
f0100b3c:	68 52 4a 10 f0       	push   $0xf0104a52
f0100b41:	68 93 02 00 00       	push   $0x293
f0100b46:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100b57:	68 a5 4a 10 f0       	push   $0xf0104aa5
f0100b5c:	68 52 4a 10 f0       	push   $0xf0104a52
f0100b61:	68 94 02 00 00       	push   $0x294
f0100b66:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100b82:	68 24 4d 10 f0       	push   $0xf0104d24
f0100b87:	6a 56                	push   $0x56
f0100b89:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0100b9d:	68 c4 4d 10 f0       	push   $0xf0104dc4
f0100ba2:	68 52 4a 10 f0       	push   $0xf0104a52
f0100ba7:	68 95 02 00 00       	push   $0x295
f0100bac:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100bd0:	68 bf 4a 10 f0       	push   $0xf0104abf
f0100bd5:	68 52 4a 10 f0       	push   $0xf0104a52
f0100bda:	68 9d 02 00 00       	push   $0x29d
f0100bdf:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100bed:	68 d1 4a 10 f0       	push   $0xf0104ad1
f0100bf2:	68 52 4a 10 f0       	push   $0xf0104a52
f0100bf7:	68 9e 02 00 00       	push   $0x29e
f0100bfc:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0100c01:	e8 9a f4 ff ff       	call   f01000a0 <_panic>
	...
	if (!page_free_list)
f0100c06:	a1 fc bf 17 f0       	mov    0xf017bffc,%eax
...
f0100c18:	83 3d fc bf 17 f0 00 	cmpl   $0x0,0xf017bffc
...
f0100c70:	03 15 cc cc 17 f0    	add    0xf017cccc,%edx
f0100c76:	66 c7 42 04 00 00    	movw   $0x0,0x4(%edx)
		pages[i].pp_link = page_free_list;
f0100c7c:	8b 0d fc bf 17 f0    	mov    0xf017bffc,%ecx
f0100c82:	89 0a                	mov    %ecx,(%edx)
		page_free_list = &pages[i];
f0100c84:	03 05 cc cc 17 f0    	add    0xf017cccc,%eax
f0100c8a:	a3 fc bf 17 f0       	mov    %eax,0xf017bffc
	//
	// Change the code to reflect this.
	// NB: DO NOT actually touch the physical memory corresponding to
	// free pages!
...
f0100c92:	3b 1d c4 cc 17 f0    	cmp    0xf017ccc4,%ebx
...
f0100ca7:	8b 1d fc bf 17 f0    	mov    0xf017bffc,%ebx
...
f0100cb3:	a3 fc bf 17 f0       	mov    %eax,0xf017bffc
...
f0100cc6:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0100cd7:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f0100cdd:	72 12                	jb     f0100cf1 <page_alloc+0x51>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100cdf:	50                   	push   %eax
f0100ce0:	68 24 4d 10 f0       	push   $0xf0104d24
f0100ce5:	6a 56                	push   $0x56
f0100ce7:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0100d01:	e8 dd 33 00 00       	call   f01040e3 <memset>
...
f0100d20:	8b 15 fc bf 17 f0    	mov    0xf017bffc,%edx
f0100d26:	89 10                	mov    %edx,(%eax)
	page_free_list=pp;	
f0100d28:	a3 fc bf 17 f0       	mov    %eax,0xf017bffc
	}
	else
...
f0100d32:	68 e2 4a 10 f0       	push   $0xf0104ae2
f0100d37:	68 69 01 00 00       	push   $0x169
f0100d3c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100d96:	39 15 c4 cc 17 f0    	cmp    %edx,0xf017ccc4
f0100d9c:	77 15                	ja     f0100db3 <pgdir_walk+0x44>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100d9e:	50                   	push   %eax
f0100d9f:	68 24 4d 10 f0       	push   $0xf0104d24
f0100da4:	68 96 01 00 00       	push   $0x196
f0100da9:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100dd4:	2b 0d cc cc 17 f0    	sub    0xf017cccc,%ecx
...
f0100de5:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f0100deb:	72 12                	jb     f0100dff <pgdir_walk+0x90>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100ded:	51                   	push   %ecx
f0100dee:	68 24 4d 10 f0       	push   $0xf0104d24
f0100df3:	6a 56                	push   $0x56
f0100df5:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0100e19:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0100e1e:	68 9f 01 00 00       	push   $0x19f
f0100e23:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0100ee3:	3b 05 c4 cc 17 f0    	cmp    0xf017ccc4,%eax
f0100ee9:	72 14                	jb     f0100eff <page_lookup+0x40>
		panic("pa2page called with invalid pa");
f0100eeb:	83 ec 04             	sub    $0x4,%esp
f0100eee:	68 30 4e 10 f0       	push   $0xf0104e30
f0100ef3:	6a 4f                	push   $0x4f
f0100ef5:	68 38 4a 10 f0       	push   $0xf0104a38
f0100efa:	e8 a1 f1 ff ff       	call   f01000a0 <_panic>
	return &pages[PGNUM(pa)];
f0100eff:	8b 15 cc cc 17 f0    	mov    0xf017cccc,%edx
...
f0100f9c:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0101014:	89 15 c4 cc 17 f0    	mov    %edx,0xf017ccc4
...
f0101021:	68 50 4e 10 f0       	push   $0xf0104e50
...
f010104a:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f010105a:	68 0c 4e 10 f0       	push   $0xf0104e0c
f010105f:	68 a1 00 00 00       	push   $0xa1
f0101064:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01010b2:	a3 04 c0 17 f0       	mov    %eax,0xf017c004
...
f01010c9:	83 3d cc cc 17 f0 00 	cmpl   $0x0,0xf017cccc
f01010d0:	75 17                	jne    f01010e9 <mem_init+0x11e>
		panic("'pages' is a null pointer!");
f01010d2:	83 ec 04             	sub    $0x4,%esp
f01010d5:	68 f6 4a 10 f0       	push   $0xf0104af6
f01010da:	68 af 02 00 00       	push   $0x2af
f01010df:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01010e4:	e8 b7 ef ff ff       	call   f01000a0 <_panic>

	// check number of free pages
	for (pp = page_free_list, nfree = 0; pp; pp = pp->pp_link)
f01010e9:	a1 fc bf 17 f0       	mov    0xf017bffc,%eax
...
f0101111:	68 11 4b 10 f0       	push   $0xf0104b11
f0101116:	68 52 4a 10 f0       	push   $0xf0104a52
f010111b:	68 b7 02 00 00       	push   $0x2b7
f0101120:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010113d:	68 27 4b 10 f0       	push   $0xf0104b27
f0101142:	68 52 4a 10 f0       	push   $0xf0104a52
f0101147:	68 b8 02 00 00       	push   $0x2b8
f010114c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010116a:	68 3d 4b 10 f0       	push   $0xf0104b3d
f010116f:	68 52 4a 10 f0       	push   $0xf0104a52
f0101174:	68 b9 02 00 00       	push   $0x2b9
f0101179:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101187:	68 53 4b 10 f0       	push   $0xf0104b53
f010118c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101191:	68 bc 02 00 00       	push   $0x2bc
f0101196:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01011ab:	68 8c 4e 10 f0       	push   $0xf0104e8c
f01011b0:	68 52 4a 10 f0       	push   $0xf0104a52
f01011b5:	68 bd 02 00 00       	push   $0x2bd
f01011ba:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
{
	return (pp - pages) << PGSHIFT;
f01011c4:	8b 0d cc cc 17 f0    	mov    0xf017cccc,%ecx
	assert(page2pa(pp0) < npages*PGSIZE);
f01011ca:	8b 15 c4 cc 17 f0    	mov    0xf017ccc4,%edx
...
f01011e1:	68 65 4b 10 f0       	push   $0xf0104b65
f01011e6:	68 52 4a 10 f0       	push   $0xf0104a52
f01011eb:	68 be 02 00 00       	push   $0x2be
f01011f0:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101208:	68 82 4b 10 f0       	push   $0xf0104b82
f010120d:	68 52 4a 10 f0       	push   $0xf0104a52
f0101212:	68 bf 02 00 00       	push   $0x2bf
f0101217:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101230:	68 9f 4b 10 f0       	push   $0xf0104b9f
f0101235:	68 52 4a 10 f0       	push   $0xf0104a52
f010123a:	68 c0 02 00 00       	push   $0x2c0
f010123f:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101244:	e8 57 ee ff ff       	call   f01000a0 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101249:	a1 fc bf 17 f0       	mov    0xf017bffc,%eax
f010124e:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f0101251:	c7 05 fc bf 17 f0 00 	movl   $0x0,0xf017bffc
f0101258:	00 00 00 
...
f010126c:	68 bc 4b 10 f0       	push   $0xf0104bbc
f0101271:	68 52 4a 10 f0       	push   $0xf0104a52
f0101276:	68 c7 02 00 00       	push   $0x2c7
f010127b:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01012b6:	68 11 4b 10 f0       	push   $0xf0104b11
f01012bb:	68 52 4a 10 f0       	push   $0xf0104a52
f01012c0:	68 ce 02 00 00       	push   $0x2ce
f01012c5:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01012e2:	68 27 4b 10 f0       	push   $0xf0104b27
f01012e7:	68 52 4a 10 f0       	push   $0xf0104a52
f01012ec:	68 cf 02 00 00       	push   $0x2cf
f01012f1:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010130f:	68 3d 4b 10 f0       	push   $0xf0104b3d
f0101314:	68 52 4a 10 f0       	push   $0xf0104a52
f0101319:	68 d0 02 00 00       	push   $0x2d0
f010131e:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101323:	e8 78 ed ff ff       	call   f01000a0 <_panic>
	assert(pp0);
	assert(pp1 && pp1 != pp0);
f0101328:	39 fe                	cmp    %edi,%esi
f010132a:	75 19                	jne    f0101345 <mem_init+0x37a>
f010132c:	68 53 4b 10 f0       	push   $0xf0104b53
f0101331:	68 52 4a 10 f0       	push   $0xf0104a52
f0101336:	68 d2 02 00 00       	push   $0x2d2
f010133b:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101350:	68 8c 4e 10 f0       	push   $0xf0104e8c
f0101355:	68 52 4a 10 f0       	push   $0xf0104a52
f010135a:	68 d3 02 00 00       	push   $0x2d3
f010135f:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010137a:	68 bc 4b 10 f0       	push   $0xf0104bbc
f010137f:	68 52 4a 10 f0       	push   $0xf0104a52
f0101384:	68 d4 02 00 00       	push   $0x2d4
f0101389:	68 2c 4a 10 f0       	push   $0xf0104a2c
f010138e:	e8 0d ed ff ff       	call   f01000a0 <_panic>
f0101393:	89 f0                	mov    %esi,%eax
f0101395:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f01013a6:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f01013ac:	72 12                	jb     f01013c0 <mem_init+0x3f5>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01013ae:	50                   	push   %eax
f01013af:	68 24 4d 10 f0       	push   $0xf0104d24
f01013b4:	6a 56                	push   $0x56
f01013b6:	68 38 4a 10 f0       	push   $0xf0104a38
...
f01013d0:	e8 0e 2d 00 00       	call   f01040e3 <memset>
	page_free(pp0);
...
f01013f0:	68 cb 4b 10 f0       	push   $0xf0104bcb
f01013f5:	68 52 4a 10 f0       	push   $0xf0104a52
f01013fa:	68 d9 02 00 00       	push   $0x2d9
f01013ff:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101404:	e8 97 ec ff ff       	call   f01000a0 <_panic>
	assert(pp && pp0 == pp);
f0101409:	39 c6                	cmp    %eax,%esi
f010140b:	74 19                	je     f0101426 <mem_init+0x45b>
f010140d:	68 e9 4b 10 f0       	push   $0xf0104be9
f0101412:	68 52 4a 10 f0       	push   $0xf0104a52
f0101417:	68 da 02 00 00       	push   $0x2da
f010141c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101428:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0101439:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f010143f:	72 12                	jb     f0101453 <mem_init+0x488>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101441:	50                   	push   %eax
f0101442:	68 24 4d 10 f0       	push   $0xf0104d24
f0101447:	6a 56                	push   $0x56
f0101449:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0101464:	68 f9 4b 10 f0       	push   $0xf0104bf9
f0101469:	68 52 4a 10 f0       	push   $0xf0104a52
f010146e:	68 dd 02 00 00       	push   $0x2dd
f0101473:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101487:	a3 fc bf 17 f0       	mov    %eax,0xf017bffc
...
f01014a3:	e8 68 f8 ff ff       	call   f0100d10 <page_free>
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f01014a8:	a1 fc bf 17 f0       	mov    0xf017bffc,%eax
...
f01014bf:	68 03 4c 10 f0       	push   $0xf0104c03
f01014c4:	68 52 4a 10 f0       	push   $0xf0104a52
f01014c9:	68 ea 02 00 00       	push   $0x2ea
f01014ce:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01014d3:	e8 c8 eb ff ff       	call   f01000a0 <_panic>

	cprintf("check_page_alloc() succeeded!\n");
f01014d8:	83 ec 0c             	sub    $0xc,%esp
f01014db:	68 ac 4e 10 f0       	push   $0xf0104eac
...
f01014fb:	68 11 4b 10 f0       	push   $0xf0104b11
f0101500:	68 52 4a 10 f0       	push   $0xf0104a52
f0101505:	68 48 03 00 00       	push   $0x348
f010150a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101527:	68 27 4b 10 f0       	push   $0xf0104b27
f010152c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101531:	68 49 03 00 00       	push   $0x349
f0101536:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101553:	68 3d 4b 10 f0       	push   $0xf0104b3d
f0101558:	68 52 4a 10 f0       	push   $0xf0104a52
f010155d:	68 4a 03 00 00       	push   $0x34a
f0101562:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101571:	68 53 4b 10 f0       	push   $0xf0104b53
f0101576:	68 52 4a 10 f0       	push   $0xf0104a52
f010157b:	68 4d 03 00 00       	push   $0x34d
f0101580:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101593:	68 8c 4e 10 f0       	push   $0xf0104e8c
f0101598:	68 52 4a 10 f0       	push   $0xf0104a52
f010159d:	68 4e 03 00 00       	push   $0x34e
f01015a2:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01015a7:	e8 f4 ea ff ff       	call   f01000a0 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f01015ac:	a1 fc bf 17 f0       	mov    0xf017bffc,%eax
f01015b1:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f01015b4:	c7 05 fc bf 17 f0 00 	movl   $0x0,0xf017bffc
f01015bb:	00 00 00 
...
f01015cf:	68 bc 4b 10 f0       	push   $0xf0104bbc
f01015d4:	68 52 4a 10 f0       	push   $0xf0104a52
f01015d9:	68 55 03 00 00       	push   $0x355
f01015de:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01015f1:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101603:	68 cc 4e 10 f0       	push   $0xf0104ecc
f0101608:	68 52 4a 10 f0       	push   $0xf0104a52
f010160d:	68 58 03 00 00       	push   $0x358
f0101612:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101621:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101633:	68 04 4f 10 f0       	push   $0xf0104f04
f0101638:	68 52 4a 10 f0       	push   $0xf0104a52
f010163d:	68 5b 03 00 00       	push   $0x35b
f0101642:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010165c:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f010166e:	68 34 4f 10 f0       	push   $0xf0104f34
f0101673:	68 52 4a 10 f0       	push   $0xf0104a52
f0101678:	68 5f 03 00 00       	push   $0x35f
f010167d:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101682:	e8 19 ea ff ff       	call   f01000a0 <_panic>
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0101687:	8b 3d c8 cc 17 f0    	mov    0xf017ccc8,%edi
void	user_mem_assert(struct Env *env, const void *va, size_t len, int perm);
...
{
	return (pp - pages) << PGSHIFT;
f010168d:	a1 cc cc 17 f0       	mov    0xf017cccc,%eax
...
f01016ae:	68 64 4f 10 f0       	push   $0xf0104f64
f01016b3:	68 52 4a 10 f0       	push   $0xf0104a52
f01016b8:	68 60 03 00 00       	push   $0x360
f01016bd:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01016e2:	68 8c 4f 10 f0       	push   $0xf0104f8c
f01016e7:	68 52 4a 10 f0       	push   $0xf0104a52
f01016ec:	68 61 03 00 00       	push   $0x361
f01016f1:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101702:	68 0e 4c 10 f0       	push   $0xf0104c0e
f0101707:	68 52 4a 10 f0       	push   $0xf0104a52
f010170c:	68 62 03 00 00       	push   $0x362
f0101711:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101725:	68 1f 4c 10 f0       	push   $0xf0104c1f
f010172a:	68 52 4a 10 f0       	push   $0xf0104a52
f010172f:	68 63 03 00 00       	push   $0x363
f0101734:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101753:	68 bc 4f 10 f0       	push   $0xf0104fbc
f0101758:	68 52 4a 10 f0       	push   $0xf0104a52
f010175d:	68 66 03 00 00       	push   $0x366
f0101762:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101767:	e8 34 e9 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f010176c:	ba 00 10 00 00       	mov    $0x1000,%edx
f0101771:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
f0101776:	e8 a4 f1 ff ff       	call   f010091f <check_va2pa>
f010177b:	89 f2                	mov    %esi,%edx
f010177d:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f010178d:	68 f8 4f 10 f0       	push   $0xf0104ff8
f0101792:	68 52 4a 10 f0       	push   $0xf0104a52
f0101797:	68 67 03 00 00       	push   $0x367
f010179c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01017ad:	68 30 4c 10 f0       	push   $0xf0104c30
f01017b2:	68 52 4a 10 f0       	push   $0xf0104a52
f01017b7:	68 68 03 00 00       	push   $0x368
f01017bc:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01017d7:	68 bc 4b 10 f0       	push   $0xf0104bbc
f01017dc:	68 52 4a 10 f0       	push   $0xf0104a52
f01017e1:	68 6b 03 00 00       	push   $0x36b
f01017e6:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01017f8:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f010180a:	68 bc 4f 10 f0       	push   $0xf0104fbc
f010180f:	68 52 4a 10 f0       	push   $0xf0104a52
f0101814:	68 6e 03 00 00       	push   $0x36e
f0101819:	68 2c 4a 10 f0       	push   $0xf0104a2c
f010181e:	e8 7d e8 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101823:	ba 00 10 00 00       	mov    $0x1000,%edx
f0101828:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
f010182d:	e8 ed f0 ff ff       	call   f010091f <check_va2pa>
f0101832:	89 f2                	mov    %esi,%edx
f0101834:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f0101844:	68 f8 4f 10 f0       	push   $0xf0104ff8
f0101849:	68 52 4a 10 f0       	push   $0xf0104a52
f010184e:	68 6f 03 00 00       	push   $0x36f
f0101853:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101864:	68 30 4c 10 f0       	push   $0xf0104c30
f0101869:	68 52 4a 10 f0       	push   $0xf0104a52
f010186e:	68 70 03 00 00       	push   $0x370
f0101873:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010188e:	68 bc 4b 10 f0       	push   $0xf0104bbc
f0101893:	68 52 4a 10 f0       	push   $0xf0104a52
f0101898:	68 74 03 00 00       	push   $0x374
f010189d:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01018a2:	e8 f9 e7 ff ff       	call   f01000a0 <_panic>

	// check that pgdir_walk returns a pointer to the pte
	ptep = (pte_t *) KADDR(PTE_ADDR(kern_pgdir[PDX(PGSIZE)]));
f01018a7:	8b 15 c8 cc 17 f0    	mov    0xf017ccc8,%edx
...
f01018b9:	3b 0d c4 cc 17 f0    	cmp    0xf017ccc4,%ecx
f01018bf:	72 15                	jb     f01018d6 <mem_init+0x90b>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01018c1:	50                   	push   %eax
f01018c2:	68 24 4d 10 f0       	push   $0xf0104d24
f01018c7:	68 77 03 00 00       	push   $0x377
f01018cc:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01018fb:	68 28 50 10 f0       	push   $0xf0105028
f0101900:	68 52 4a 10 f0       	push   $0xf0104a52
f0101905:	68 78 03 00 00       	push   $0x378
f010190a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010191c:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f010192e:	68 68 50 10 f0       	push   $0xf0105068
f0101933:	68 52 4a 10 f0       	push   $0xf0104a52
f0101938:	68 7b 03 00 00       	push   $0x37b
f010193d:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101942:	e8 59 e7 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101947:	8b 3d c8 cc 17 f0    	mov    0xf017ccc8,%edi
...
f010195b:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f010196b:	68 f8 4f 10 f0       	push   $0xf0104ff8
f0101970:	68 52 4a 10 f0       	push   $0xf0104a52
f0101975:	68 7c 03 00 00       	push   $0x37c
f010197a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010198b:	68 30 4c 10 f0       	push   $0xf0104c30
f0101990:	68 52 4a 10 f0       	push   $0xf0104a52
f0101995:	68 7d 03 00 00       	push   $0x37d
f010199a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01019bc:	68 a8 50 10 f0       	push   $0xf01050a8
f01019c1:	68 52 4a 10 f0       	push   $0xf0104a52
f01019c6:	68 7e 03 00 00       	push   $0x37e
f01019cb:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01019d0:	e8 cb e6 ff ff       	call   f01000a0 <_panic>
	assert(kern_pgdir[0] & PTE_U);
f01019d5:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
f01019da:	f6 00 04             	testb  $0x4,(%eax)
f01019dd:	75 19                	jne    f01019f8 <mem_init+0xa2d>
f01019df:	68 41 4c 10 f0       	push   $0xf0104c41
f01019e4:	68 52 4a 10 f0       	push   $0xf0104a52
f01019e9:	68 7f 03 00 00       	push   $0x37f
f01019ee:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101a0d:	68 bc 4f 10 f0       	push   $0xf0104fbc
f0101a12:	68 52 4a 10 f0       	push   $0xf0104a52
f0101a17:	68 82 03 00 00       	push   $0x382
f0101a1c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101a30:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101a43:	68 dc 50 10 f0       	push   $0xf01050dc
f0101a48:	68 52 4a 10 f0       	push   $0xf0104a52
f0101a4d:	68 83 03 00 00       	push   $0x383
f0101a52:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101a66:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101a79:	68 10 51 10 f0       	push   $0xf0105110
f0101a7e:	68 52 4a 10 f0       	push   $0xf0104a52
f0101a83:	68 84 03 00 00       	push   $0x384
f0101a88:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101a9c:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101aae:	68 48 51 10 f0       	push   $0xf0105148
f0101ab3:	68 52 4a 10 f0       	push   $0xf0104a52
f0101ab8:	68 87 03 00 00       	push   $0x387
f0101abd:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101acf:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101ae1:	68 80 51 10 f0       	push   $0xf0105180
f0101ae6:	68 52 4a 10 f0       	push   $0xf0104a52
f0101aeb:	68 8a 03 00 00       	push   $0x38a
f0101af0:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101b04:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101b17:	68 10 51 10 f0       	push   $0xf0105110
f0101b1c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101b21:	68 8b 03 00 00       	push   $0x38b
f0101b26:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101b2b:	e8 70 e5 ff ff       	call   f01000a0 <_panic>

	// should have pp1 at both 0 and PGSIZE, pp2 nowhere, ...
	assert(check_va2pa(kern_pgdir, 0) == page2pa(pp1));
f0101b30:	8b 3d c8 cc 17 f0    	mov    0xf017ccc8,%edi
...
f0101b49:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0101b59:	68 bc 51 10 f0       	push   $0xf01051bc
f0101b5e:	68 52 4a 10 f0       	push   $0xf0104a52
f0101b63:	68 8e 03 00 00       	push   $0x38e
f0101b68:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101b83:	68 e8 51 10 f0       	push   $0xf01051e8
f0101b88:	68 52 4a 10 f0       	push   $0xf0104a52
f0101b8d:	68 8f 03 00 00       	push   $0x38f
f0101b92:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101ba3:	68 57 4c 10 f0       	push   $0xf0104c57
f0101ba8:	68 52 4a 10 f0       	push   $0xf0104a52
f0101bad:	68 91 03 00 00       	push   $0x391
f0101bb2:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101bc3:	68 68 4c 10 f0       	push   $0xf0104c68
f0101bc8:	68 52 4a 10 f0       	push   $0xf0104a52
f0101bcd:	68 92 03 00 00       	push   $0x392
f0101bd2:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101bf1:	68 18 52 10 f0       	push   $0xf0105218
f0101bf6:	68 52 4a 10 f0       	push   $0xf0104a52
f0101bfb:	68 95 03 00 00       	push   $0x395
f0101c00:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101c0f:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
f0101c15:	e8 f7 f2 ff ff       	call   f0100f11 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f0101c1a:	8b 3d c8 cc 17 f0    	mov    0xf017ccc8,%edi
...
f0101c34:	68 3c 52 10 f0       	push   $0xf010523c
f0101c39:	68 52 4a 10 f0       	push   $0xf0104a52
f0101c3e:	68 99 03 00 00       	push   $0x399
f0101c43:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101c5b:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f0101c6b:	68 e8 51 10 f0       	push   $0xf01051e8
f0101c70:	68 52 4a 10 f0       	push   $0xf0104a52
f0101c75:	68 9a 03 00 00       	push   $0x39a
f0101c7a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101c8b:	68 0e 4c 10 f0       	push   $0xf0104c0e
f0101c90:	68 52 4a 10 f0       	push   $0xf0104a52
f0101c95:	68 9b 03 00 00       	push   $0x39b
f0101c9a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101cab:	68 68 4c 10 f0       	push   $0xf0104c68
f0101cb0:	68 52 4a 10 f0       	push   $0xf0104a52
f0101cb5:	68 9c 03 00 00       	push   $0x39c
f0101cba:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101cd9:	68 60 52 10 f0       	push   $0xf0105260
f0101cde:	68 52 4a 10 f0       	push   $0xf0104a52
f0101ce3:	68 9f 03 00 00       	push   $0x39f
f0101ce8:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101cf9:	68 79 4c 10 f0       	push   $0xf0104c79
f0101cfe:	68 52 4a 10 f0       	push   $0xf0104a52
f0101d03:	68 a0 03 00 00       	push   $0x3a0
f0101d08:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101d0d:	e8 8e e3 ff ff       	call   f01000a0 <_panic>
	assert(pp1->pp_link == NULL);
f0101d12:	83 3b 00             	cmpl   $0x0,(%ebx)
f0101d15:	74 19                	je     f0101d30 <mem_init+0xd65>
f0101d17:	68 85 4c 10 f0       	push   $0xf0104c85
f0101d1c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101d21:	68 a1 03 00 00       	push   $0x3a1
f0101d26:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101d38:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
f0101d3e:	e8 ce f1 ff ff       	call   f0100f11 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f0101d43:	8b 3d c8 cc 17 f0    	mov    0xf017ccc8,%edi
...
f0101d5d:	68 3c 52 10 f0       	push   $0xf010523c
f0101d62:	68 52 4a 10 f0       	push   $0xf0104a52
f0101d67:	68 a5 03 00 00       	push   $0x3a5
f0101d6c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101d87:	68 98 52 10 f0       	push   $0xf0105298
f0101d8c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101d91:	68 a6 03 00 00       	push   $0x3a6
f0101d96:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101da7:	68 9a 4c 10 f0       	push   $0xf0104c9a
f0101dac:	68 52 4a 10 f0       	push   $0xf0104a52
f0101db1:	68 a7 03 00 00       	push   $0x3a7
f0101db6:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101dc7:	68 68 4c 10 f0       	push   $0xf0104c68
f0101dcc:	68 52 4a 10 f0       	push   $0xf0104a52
f0101dd1:	68 a8 03 00 00       	push   $0x3a8
f0101dd6:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101df5:	68 c0 52 10 f0       	push   $0xf01052c0
f0101dfa:	68 52 4a 10 f0       	push   $0xf0104a52
f0101dff:	68 ab 03 00 00       	push   $0x3ab
f0101e04:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101e1f:	68 bc 4b 10 f0       	push   $0xf0104bbc
f0101e24:	68 52 4a 10 f0       	push   $0xf0104a52
f0101e29:	68 ae 03 00 00       	push   $0x3ae
f0101e2e:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0101e33:	e8 68 e2 ff ff       	call   f01000a0 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0101e38:	8b 0d c8 cc 17 f0    	mov    0xf017ccc8,%ecx
f0101e3e:	8b 11                	mov    (%ecx),%edx
f0101e40:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0101e46:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f0101e49:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0101e59:	68 64 4f 10 f0       	push   $0xf0104f64
f0101e5e:	68 52 4a 10 f0       	push   $0xf0104a52
f0101e63:	68 b1 03 00 00       	push   $0x3b1
f0101e68:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101e82:	68 1f 4c 10 f0       	push   $0xf0104c1f
f0101e87:	68 52 4a 10 f0       	push   $0xf0104a52
f0101e8c:	68 b3 03 00 00       	push   $0x3b3
f0101e91:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
{
	if (PGNUM(pa) >= npages)
f0101ed7:	8b 0d c4 cc 17 f0    	mov    0xf017ccc4,%ecx
...
f0101eea:	68 24 4d 10 f0       	push   $0xf0104d24
f0101eef:	68 ba 03 00 00       	push   $0x3ba
f0101ef4:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101f07:	68 ab 4c 10 f0       	push   $0xf0104cab
f0101f0c:	68 52 4a 10 f0       	push   $0xf0104a52
f0101f11:	68 bb 03 00 00       	push   $0x3bb
f0101f16:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
{
	return (pp - pages) << PGSHIFT;
f0101f33:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0101f49:	68 24 4d 10 f0       	push   $0xf0104d24
f0101f4e:	6a 56                	push   $0x56
f0101f50:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0101f6d:	e8 71 21 00 00       	call   f01040e3 <memset>
	page_free(pp0);
...
f0101f84:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0101f91:	2b 15 cc cc 17 f0    	sub    0xf017cccc,%edx
...
f0101fa5:	3b 05 c4 cc 17 f0    	cmp    0xf017ccc4,%eax
f0101fab:	72 12                	jb     f0101fbf <mem_init+0xff4>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101fad:	52                   	push   %edx
f0101fae:	68 24 4d 10 f0       	push   $0xf0104d24
f0101fb3:	6a 56                	push   $0x56
f0101fb5:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0101fd3:	68 c3 4c 10 f0       	push   $0xf0104cc3
f0101fd8:	68 52 4a 10 f0       	push   $0xf0104a52
f0101fdd:	68 c5 03 00 00       	push   $0x3c5
f0101fe2:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0101ff1:	75 db                	jne    f0101fce <mem_init+0x1003>
		assert((ptep[i] & PTE_P) == 0);
	kern_pgdir[0] = 0;
f0101ff3:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
...
f010200a:	89 3d fc bf 17 f0    	mov    %edi,0xf017bffc
...
f0102029:	c7 04 24 da 4c 10 f0 	movl   $0xf0104cda,(%esp)
...
f0102035:	a1 cc cc 17 f0       	mov    0xf017cccc,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102045:	68 0c 4e 10 f0       	push   $0xf0104e0c
f010204a:	68 ce 00 00 00       	push   $0xce
f010204f:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010206e:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
...
f0102078:	a1 04 c0 17 f0       	mov    0xf017c004,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102088:	68 0c 4e 10 f0       	push   $0xf0104e0c
f010208d:	68 da 00 00 00       	push   $0xda
f0102092:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01020b1:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
...
f01020cb:	68 0c 4e 10 f0       	push   $0xf0104e0c
f01020d0:	68 e6 00 00 00       	push   $0xe6
f01020d5:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01020f3:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
...
f010210e:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
...
check_kern_pgdir(void)
{
	...
	pgdir = kern_pgdir;
f0102118:	8b 1d c8 cc 17 f0    	mov    0xf017ccc8,%ebx

	// check pages array
	n = ROUNDUP(npages*sizeof(struct PageInfo), PGSIZE);
f010211e:	a1 c4 cc 17 f0       	mov    0xf017ccc4,%eax
...
f0102135:	8b 3d cc cc 17 f0    	mov    0xf017cccc,%edi
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f010215f:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102164:	68 02 03 00 00       	push   $0x302
f0102169:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010217e:	68 e4 52 10 f0       	push   $0xf01052e4
f0102183:	68 52 4a 10 f0       	push   $0xf0104a52
f0102188:	68 02 03 00 00       	push   $0x302
f010218d:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01021a2:	8b 3d 04 c0 17 f0    	mov    0xf017c004,%edi
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f01021c3:	68 0c 4e 10 f0       	push   $0xf0104e0c
f01021c8:	68 07 03 00 00       	push   $0x307
f01021cd:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01021e2:	68 18 53 10 f0       	push   $0xf0105318
f01021e7:	68 52 4a 10 f0       	push   $0xf0104a52
f01021ec:	68 07 03 00 00       	push   $0x307
f01021f1:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102227:	68 4c 53 10 f0       	push   $0xf010534c
f010222c:	68 52 4a 10 f0       	push   $0xf0104a52
f0102231:	68 0b 03 00 00       	push   $0x30b
f0102236:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102262:	68 74 53 10 f0       	push   $0xf0105374
f0102267:	68 52 4a 10 f0       	push   $0xf0104a52
f010226c:	68 0f 03 00 00       	push   $0x30f
f0102271:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010229a:	68 bc 53 10 f0       	push   $0xf01053bc
f010229f:	68 52 4a 10 f0       	push   $0xf0104a52
f01022a4:	68 10 03 00 00       	push   $0x310
f01022a9:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01022d2:	68 f3 4c 10 f0       	push   $0xf0104cf3
f01022d7:	68 52 4a 10 f0       	push   $0xf0104a52
f01022dc:	68 19 03 00 00       	push   $0x319
f01022e1:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01022ff:	68 f3 4c 10 f0       	push   $0xf0104cf3
f0102304:	68 52 4a 10 f0       	push   $0xf0104a52
f0102309:	68 1d 03 00 00       	push   $0x31d
f010230e:	68 2c 4a 10 f0       	push   $0xf0104a2c
f0102313:	e8 88 dd ff ff       	call   f01000a0 <_panic>
				assert(pgdir[i] & PTE_W);
f0102318:	f6 c2 02             	test   $0x2,%dl
f010231b:	75 38                	jne    f0102355 <mem_init+0x138a>
f010231d:	68 04 4d 10 f0       	push   $0xf0104d04
f0102322:	68 52 4a 10 f0       	push   $0xf0104a52
f0102327:	68 1e 03 00 00       	push   $0x31e
f010232c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010233c:	68 15 4d 10 f0       	push   $0xf0104d15
f0102341:	68 52 4a 10 f0       	push   $0xf0104a52
f0102346:	68 20 03 00 00       	push   $0x320
f010234b:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102366:	68 ec 53 10 f0       	push   $0xf01053ec
...
f0102370:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102380:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102385:	68 fe 00 00 00       	push   $0xfe
f010238a:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01023c7:	68 11 4b 10 f0       	push   $0xf0104b11
f01023cc:	68 52 4a 10 f0       	push   $0xf0104a52
f01023d1:	68 e0 03 00 00       	push   $0x3e0
f01023d6:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01023f3:	68 27 4b 10 f0       	push   $0xf0104b27
f01023f8:	68 52 4a 10 f0       	push   $0xf0104a52
f01023fd:	68 e1 03 00 00       	push   $0x3e1
f0102402:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010241f:	68 3d 4b 10 f0       	push   $0xf0104b3d
f0102424:	68 52 4a 10 f0       	push   $0xf0104a52
f0102429:	68 e2 03 00 00       	push   $0x3e2
f010242e:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102443:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0102457:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f010245d:	72 12                	jb     f0102471 <mem_init+0x14a6>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010245f:	50                   	push   %eax
f0102460:	68 24 4d 10 f0       	push   $0xf0104d24
f0102465:	6a 56                	push   $0x56
f0102467:	68 38 4a 10 f0       	push   $0xf0104a38
...
f0102481:	e8 5d 1c 00 00       	call   f01040e3 <memset>
void	user_mem_assert(struct Env *env, const void *va, size_t len, int perm);
...
f0102488:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f010249c:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f01024a2:	72 12                	jb     f01024b6 <mem_init+0x14eb>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01024a4:	50                   	push   %eax
f01024a5:	68 24 4d 10 f0       	push   $0xf0104d24
f01024aa:	6a 56                	push   $0x56
f01024ac:	68 38 4a 10 f0       	push   $0xf0104a38
...
f01024c6:	e8 18 1c 00 00       	call   f01040e3 <memset>
	page_insert(kern_pgdir, pp1, (void*) PGSIZE, PTE_W);
f01024cb:	6a 02                	push   $0x2
f01024cd:	68 00 10 00 00       	push   $0x1000
f01024d2:	57                   	push   %edi
f01024d3:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f01024e8:	68 0e 4c 10 f0       	push   $0xf0104c0e
f01024ed:	68 52 4a 10 f0       	push   $0xf0104a52
f01024f2:	68 e7 03 00 00       	push   $0x3e7
f01024f7:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010250d:	68 0c 54 10 f0       	push   $0xf010540c
f0102512:	68 52 4a 10 f0       	push   $0xf0104a52
f0102517:	68 e8 03 00 00       	push   $0x3e8
f010251c:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f010252e:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f0102548:	68 30 54 10 f0       	push   $0xf0105430
f010254d:	68 52 4a 10 f0       	push   $0xf0104a52
f0102552:	68 ea 03 00 00       	push   $0x3ea
f0102557:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102568:	68 30 4c 10 f0       	push   $0xf0104c30
f010256d:	68 52 4a 10 f0       	push   $0xf0104a52
f0102572:	68 eb 03 00 00       	push   $0x3eb
f0102577:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102588:	68 9a 4c 10 f0       	push   $0xf0104c9a
f010258d:	68 52 4a 10 f0       	push   $0xf0104a52
f0102592:	68 ec 03 00 00       	push   $0x3ec
f0102597:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01025ad:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f01025be:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f01025c4:	72 12                	jb     f01025d8 <mem_init+0x160d>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01025c6:	50                   	push   %eax
f01025c7:	68 24 4d 10 f0       	push   $0xf0104d24
f01025cc:	6a 56                	push   $0x56
f01025ce:	68 38 4a 10 f0       	push   $0xf0104a38
...
f01025e4:	68 54 54 10 f0       	push   $0xf0105454
f01025e9:	68 52 4a 10 f0       	push   $0xf0104a52
f01025ee:	68 ee 03 00 00       	push   $0x3ee
f01025f3:	68 2c 4a 10 f0       	push   $0xf0104a2c
f01025f8:	e8 a3 da ff ff       	call   f01000a0 <_panic>
	page_remove(kern_pgdir, (void*) PGSIZE);
f01025fd:	83 ec 08             	sub    $0x8,%esp
f0102600:	68 00 10 00 00       	push   $0x1000
f0102605:	ff 35 c8 cc 17 f0    	pushl  0xf017ccc8
...
f010261a:	68 68 4c 10 f0       	push   $0xf0104c68
f010261f:	68 52 4a 10 f0       	push   $0xf0104a52
f0102624:	68 f0 03 00 00       	push   $0x3f0
f0102629:	68 2c 4a 10 f0       	push   $0xf0104a2c
f010262e:	e8 6d da ff ff       	call   f01000a0 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0102633:	8b 0d c8 cc 17 f0    	mov    0xf017ccc8,%ecx
f0102639:	8b 11                	mov    (%ecx),%edx
f010263b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0102641:	89 d8                	mov    %ebx,%eax
f0102643:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f0102653:	68 64 4f 10 f0       	push   $0xf0104f64
f0102658:	68 52 4a 10 f0       	push   $0xf0104a52
f010265d:	68 f3 03 00 00       	push   $0x3f3
f0102662:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f0102679:	68 1f 4c 10 f0       	push   $0xf0104c1f
f010267e:	68 52 4a 10 f0       	push   $0xf0104a52
f0102683:	68 f5 03 00 00       	push   $0x3f5
f0102688:	68 2c 4a 10 f0       	push   $0xf0104a2c
...
f01026a1:	c7 04 24 80 54 10 f0 	movl   $0xf0105480,(%esp)
...
f0102708:	68 ac 54 10 f0       	push   $0xf01054ac
f010270d:	68 31 01 00 00       	push   $0x131
f0102712:	68 12 55 10 f0       	push   $0xf0105512
...
f0102733:	68 1d 55 10 f0       	push   $0xf010551d
f0102738:	68 34 01 00 00       	push   $0x134
f010273d:	68 12 55 10 f0       	push   $0xf0105512
...
f0102764:	75 11                	jne    f0102777 <envid2env+0x1e>
		*env_store = curenv;
f0102766:	a1 00 c0 17 f0       	mov    0xf017c000,%eax
...
f0102784:	03 05 04 c0 17 f0    	add    0xf017c004,%eax
...
f01027a9:	8b 15 00 c0 17 f0    	mov    0xf017c000,%edx
...
f010280f:	68 30 55 10 f0       	push   $0xf0105530
...
f0102819:	8b 35 04 c0 17 f0    	mov    0xf017c004,%esi
...
f0102845:	89 35 08 c0 17 f0    	mov    %esi,0xf017c008
		envs[i].env_link = env_free_list;
		envs[i].env_status = ENV_FREE;
		env_free_list = &envs[i];
	}
...
f0102853:	68 41 55 10 f0       	push   $0xf0105541
...
f010286b:	83 ec 04             	sub    $0x4,%esp
	...
	if (!(e = env_free_list))
f010286e:	8b 1d 08 c0 17 f0    	mov    0xf017c008,%ebx
...
{
	return (pp - pages) << PGSHIFT;
f0102896:	2b 05 cc cc 17 f0    	sub    0xf017cccc,%eax
...
f01028a7:	3b 15 c4 cc 17 f0    	cmp    0xf017ccc4,%edx
f01028ad:	72 12                	jb     f01028c1 <env_alloc+0x5a>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01028af:	50                   	push   %eax
f01028b0:	68 24 4d 10 f0       	push   $0xf0104d24
f01028b5:	6a 56                	push   $0x56
f01028b7:	68 38 4a 10 f0       	push   $0xf0104a38
...
f01028e2:	8b 15 c8 cc 17 f0    	mov    0xf017ccc8,%edx
...
f0102906:	68 0c 4e 10 f0       	push   $0xf0104e0c
f010290b:	68 d3 00 00 00       	push   $0xd3
f0102910:	68 12 55 10 f0       	push   $0xf0105512
...
f0102940:	2b 15 04 c0 17 f0    	sub    0xf017c004,%edx
...
f0102977:	e8 67 17 00 00       	call   f01040e3 <memset>
...
f010299e:	a3 08 c0 17 f0       	mov    %eax,0xf017c008
	*newenv_store = e;
...
f01029ab:	a1 00 c0 17 f0       	mov    0xf017c000,%eax
...
f01029c6:	68 50 55 10 f0       	push   $0xf0105550
...
f0102a0a:	68 65 55 10 f0       	push   $0xf0105565
f0102a0f:	68 b9 01 00 00       	push   $0x1b9
f0102a14:	68 12 55 10 f0       	push   $0xf0105512
...
f0102a2f:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102a34:	68 7c 01 00 00       	push   $0x17c
f0102a39:	68 12 55 10 f0       	push   $0xf0105512
...
f0102a56:	68 73 55 10 f0       	push   $0xf0105573
f0102a5b:	68 82 01 00 00       	push   $0x182
f0102a60:	68 12 55 10 f0       	push   $0xf0105512
...
f0102a84:	68 85 55 10 f0       	push   $0xf0105585
...
f0102aa3:	68 9c 55 10 f0       	push   $0xf010559c
f0102aa8:	68 94 01 00 00       	push   $0x194
f0102aad:	68 12 55 10 f0       	push   $0xf0105512
...
f0102ad1:	e8 c2 16 00 00       	call   f0104198 <memcpy>
...
f0102ae8:	e8 f6 15 00 00       	call   f01040e3 <memset>
...
f0102b04:	e8 c9 fb ff ff       	call   f01026d2 <region_alloc>
	...
	lcr3(PADDR(kern_pgdir));
f0102b09:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102b16:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102b1b:	68 a0 01 00 00       	push   $0x1a0
f0102b20:	68 12 55 10 f0       	push   $0xf0105512
...
f0102b4c:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	// gets reused.
	if (e == curenv)
f0102b4f:	8b 15 00 c0 17 f0    	mov    0xf017c000,%edx
f0102b55:	39 fa                	cmp    %edi,%edx
f0102b57:	75 29                	jne    f0102b82 <env_free+0x3f>
		lcr3(PADDR(kern_pgdir));
f0102b59:	a1 c8 cc 17 f0       	mov    0xf017ccc8,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102b66:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102b6b:	68 cf 01 00 00       	push   $0x1cf
f0102b70:	68 12 55 10 f0       	push   $0xf0105512
...
f0102b98:	68 b0 55 10 f0       	push   $0xf01055b0
...
f0102bd7:	39 05 c4 cc 17 f0    	cmp    %eax,0xf017ccc4
f0102bdd:	77 15                	ja     f0102bf4 <env_free+0xb1>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0102bdf:	56                   	push   %esi
f0102be0:	68 24 4d 10 f0       	push   $0xf0104d24
f0102be5:	68 de 01 00 00       	push   $0x1de
f0102bea:	68 12 55 10 f0       	push   $0xf0105512
...
f0102c8e:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102c93:	68 ec 01 00 00       	push   $0x1ec
f0102c98:	68 12 55 10 f0       	push   $0xf0105512
...
f0102cb1:	3b 05 c4 cc 17 f0    	cmp    0xf017ccc4,%eax
f0102cb7:	72 14                	jb     f0102ccd <env_free+0x18a>
		panic("pa2page called with invalid pa");
f0102cb9:	83 ec 04             	sub    $0x4,%esp
f0102cbc:	68 30 4e 10 f0       	push   $0xf0104e30
f0102cc1:	6a 4f                	push   $0x4f
f0102cc3:	68 38 4a 10 f0       	push   $0xf0104a38
f0102cc8:	e8 d3 d3 ff ff       	call   f01000a0 <_panic>
	page_decref(pa2page(pa));
f0102ccd:	83 ec 0c             	sub    $0xc,%esp
f0102cd0:	8b 15 cc cc 17 f0    	mov    0xf017cccc,%edx
...
f0102ce6:	a1 08 c0 17 f0       	mov    0xf017c008,%eax
f0102ceb:	89 47 44             	mov    %eax,0x44(%edi)
	env_free_list = e;
f0102cee:	89 3d 08 c0 17 f0    	mov    %edi,0xf017c008
}
...
f0102d0d:	c7 04 24 dc 54 10 f0 	movl   $0xf01054dc,(%esp)
...
f0102d3b:	68 c6 55 10 f0       	push   $0xf01055c6
f0102d40:	68 15 02 00 00       	push   $0x215
f0102d45:	68 12 55 10 f0       	push   $0xf0105512
...
f0102d58:	8b 15 00 c0 17 f0    	mov    0xf017c000,%edx
...
f0102d70:	c7 42 54 02 00 00 00 	movl   $0x2,0x54(%edx)
		...
		curenv = e;
f0102d77:	a3 00 c0 17 f0       	mov    %eax,0xf017c000
...
f0102d92:	68 0c 4e 10 f0       	push   $0xf0104e0c
f0102d97:	68 3f 02 00 00       	push   $0x23f
f0102d9c:	68 12 55 10 f0       	push   $0xf0105512
...
f0102db1:	68 d2 55 10 f0       	push   $0xf01055d2
f0102db6:	e8 75 00 00 00       	call   f0102e30 <cprintf>
	env_pop_tf(&(curenv->env_tf));
f0102dbb:	83 c4 04             	add    $0x4,%esp
f0102dbe:	ff 35 00 c0 17 f0    	pushl  0xf017c000
...
f0102e26:	e8 93 0b 00 00       	call   f01039be <vprintfmt>
	return cnt;
}
...
f0102e47:	b8 40 c8 17 f0       	mov    $0xf017c840,%eax
f0102e4c:	c7 05 44 c8 17 f0 00 	movl   $0xf0000000,0xf017c844
f0102e53:	00 00 f0 
	ts.ts_ss0 = GD_KD;
f0102e56:	66 c7 05 48 c8 17 f0 	movw   $0x10,0xf017c848
f0102e5d:	10 00 
...
f0102ea4:	b8 38 35 10 f0       	mov    $0xf0103538,%eax
f0102ea9:	66 a3 20 c0 17 f0    	mov    %ax,0xf017c020
f0102eaf:	66 c7 05 22 c0 17 f0 	movw   $0x8,0xf017c022
f0102eb6:	08 00 
f0102eb8:	c6 05 24 c0 17 f0 00 	movb   $0x0,0xf017c024
f0102ebf:	c6 05 25 c0 17 f0 8e 	movb   $0x8e,0xf017c025
f0102ec6:	c1 e8 10             	shr    $0x10,%eax
f0102ec9:	66 a3 26 c0 17 f0    	mov    %ax,0xf017c026
    SETGATE(idt[T_BRKPT],0,GD_KT,brkpoint,DPLUSR);
f0102ecf:	b8 42 35 10 f0       	mov    $0xf0103542,%eax
f0102ed4:	66 a3 38 c0 17 f0    	mov    %ax,0xf017c038
f0102eda:	66 c7 05 3a c0 17 f0 	movw   $0x8,0xf017c03a
f0102ee1:	08 00 
f0102ee3:	c6 05 3c c0 17 f0 00 	movb   $0x0,0xf017c03c
f0102eea:	c6 05 3d c0 17 f0 ee 	movb   $0xee,0xf017c03d
f0102ef1:	c1 e8 10             	shr    $0x10,%eax
f0102ef4:	66 a3 3e c0 17 f0    	mov    %ax,0xf017c03e
    SETGATE(idt[T_SEGNP],0,GD_KT,no_seg,DPLKERN);
f0102efa:	b8 4c 35 10 f0       	mov    $0xf010354c,%eax
f0102eff:	66 a3 78 c0 17 f0    	mov    %ax,0xf017c078
f0102f05:	66 c7 05 7a c0 17 f0 	movw   $0x8,0xf017c07a
f0102f0c:	08 00 
f0102f0e:	c6 05 7c c0 17 f0 00 	movb   $0x0,0xf017c07c
f0102f15:	c6 05 7d c0 17 f0 8e 	movb   $0x8e,0xf017c07d
f0102f1c:	c1 e8 10             	shr    $0x10,%eax
f0102f1f:	66 a3 7e c0 17 f0    	mov    %ax,0xf017c07e
    SETGATE(idt[T_DEBUG],0,GD_KT,debug,DPLKERN);
f0102f25:	b8 54 35 10 f0       	mov    $0xf0103554,%eax
f0102f2a:	66 a3 28 c0 17 f0    	mov    %ax,0xf017c028
f0102f30:	66 c7 05 2a c0 17 f0 	movw   $0x8,0xf017c02a
f0102f37:	08 00 
f0102f39:	c6 05 2c c0 17 f0 00 	movb   $0x0,0xf017c02c
f0102f40:	c6 05 2d c0 17 f0 8e 	movb   $0x8e,0xf017c02d
f0102f47:	c1 e8 10             	shr    $0x10,%eax
f0102f4a:	66 a3 2e c0 17 f0    	mov    %ax,0xf017c02e
    SETGATE(idt[T_NMI],0,GD_KT,nmi,DPLKERN);
f0102f50:	b8 5e 35 10 f0       	mov    $0xf010355e,%eax
f0102f55:	66 a3 30 c0 17 f0    	mov    %ax,0xf017c030
f0102f5b:	66 c7 05 32 c0 17 f0 	movw   $0x8,0xf017c032
f0102f62:	08 00 
f0102f64:	c6 05 34 c0 17 f0 00 	movb   $0x0,0xf017c034
f0102f6b:	c6 05 35 c0 17 f0 8e 	movb   $0x8e,0xf017c035
f0102f72:	c1 e8 10             	shr    $0x10,%eax
f0102f75:	66 a3 36 c0 17 f0    	mov    %ax,0xf017c036
    SETGATE(idt[T_OFLOW],0,GD_KT,oflow,DPLKERN);
f0102f7b:	b8 68 35 10 f0       	mov    $0xf0103568,%eax
f0102f80:	66 a3 40 c0 17 f0    	mov    %ax,0xf017c040
f0102f86:	66 c7 05 42 c0 17 f0 	movw   $0x8,0xf017c042
f0102f8d:	08 00 
f0102f8f:	c6 05 44 c0 17 f0 00 	movb   $0x0,0xf017c044
f0102f96:	c6 05 45 c0 17 f0 8e 	movb   $0x8e,0xf017c045
f0102f9d:	c1 e8 10             	shr    $0x10,%eax
f0102fa0:	66 a3 46 c0 17 f0    	mov    %ax,0xf017c046
    SETGATE(idt[T_BOUND],0,GD_KT,bound,DPLKERN);
f0102fa6:	b8 72 35 10 f0       	mov    $0xf0103572,%eax
f0102fab:	66 a3 48 c0 17 f0    	mov    %ax,0xf017c048
f0102fb1:	66 c7 05 4a c0 17 f0 	movw   $0x8,0xf017c04a
f0102fb8:	08 00 
f0102fba:	c6 05 4c c0 17 f0 00 	movb   $0x0,0xf017c04c
f0102fc1:	c6 05 4d c0 17 f0 8e 	movb   $0x8e,0xf017c04d
f0102fc8:	c1 e8 10             	shr    $0x10,%eax
f0102fcb:	66 a3 4e c0 17 f0    	mov    %ax,0xf017c04e
    SETGATE(idt[T_ILLOP],0,GD_KT,illop,DPLKERN);
f0102fd1:	b8 7c 35 10 f0       	mov    $0xf010357c,%eax
f0102fd6:	66 a3 50 c0 17 f0    	mov    %ax,0xf017c050
f0102fdc:	66 c7 05 52 c0 17 f0 	movw   $0x8,0xf017c052
f0102fe3:	08 00 
f0102fe5:	c6 05 54 c0 17 f0 00 	movb   $0x0,0xf017c054
f0102fec:	c6 05 55 c0 17 f0 8e 	movb   $0x8e,0xf017c055
f0102ff3:	c1 e8 10             	shr    $0x10,%eax
f0102ff6:	66 a3 56 c0 17 f0    	mov    %ax,0xf017c056
    SETGATE(idt[T_DEVICE],0,GD_KT,device,DPLKERN);
f0102ffc:	b8 86 35 10 f0       	mov    $0xf0103586,%eax
f0103001:	66 a3 58 c0 17 f0    	mov    %ax,0xf017c058
f0103007:	66 c7 05 5a c0 17 f0 	movw   $0x8,0xf017c05a
f010300e:	08 00 
f0103010:	c6 05 5c c0 17 f0 00 	movb   $0x0,0xf017c05c
f0103017:	c6 05 5d c0 17 f0 8e 	movb   $0x8e,0xf017c05d
f010301e:	c1 e8 10             	shr    $0x10,%eax
f0103021:	66 a3 5e c0 17 f0    	mov    %ax,0xf017c05e
    SETGATE(idt[T_DBLFLT],0,GD_KT,dblflt,DPLKERN);
f0103027:	b8 90 35 10 f0       	mov    $0xf0103590,%eax
f010302c:	66 a3 60 c0 17 f0    	mov    %ax,0xf017c060
f0103032:	66 c7 05 62 c0 17 f0 	movw   $0x8,0xf017c062
f0103039:	08 00 
f010303b:	c6 05 64 c0 17 f0 00 	movb   $0x0,0xf017c064
f0103042:	c6 05 65 c0 17 f0 8e 	movb   $0x8e,0xf017c065
f0103049:	c1 e8 10             	shr    $0x10,%eax
f010304c:	66 a3 66 c0 17 f0    	mov    %ax,0xf017c066
    SETGATE(idt[T_TSS], 0, GD_KT, tss, DPLKERN);
f0103052:	b8 98 35 10 f0       	mov    $0xf0103598,%eax
f0103057:	66 a3 70 c0 17 f0    	mov    %ax,0xf017c070
f010305d:	66 c7 05 72 c0 17 f0 	movw   $0x8,0xf017c072
f0103064:	08 00 
f0103066:	c6 05 74 c0 17 f0 00 	movb   $0x0,0xf017c074
f010306d:	c6 05 75 c0 17 f0 8e 	movb   $0x8e,0xf017c075
f0103074:	c1 e8 10             	shr    $0x10,%eax
f0103077:	66 a3 76 c0 17 f0    	mov    %ax,0xf017c076
    SETGATE(idt[T_STACK], 0, GD_KT, stack, DPLKERN);
f010307d:	b8 a0 35 10 f0       	mov    $0xf01035a0,%eax
f0103082:	66 a3 80 c0 17 f0    	mov    %ax,0xf017c080
f0103088:	66 c7 05 82 c0 17 f0 	movw   $0x8,0xf017c082
f010308f:	08 00 
f0103091:	c6 05 84 c0 17 f0 00 	movb   $0x0,0xf017c084
f0103098:	c6 05 85 c0 17 f0 8e 	movb   $0x8e,0xf017c085
f010309f:	c1 e8 10             	shr    $0x10,%eax
f01030a2:	66 a3 86 c0 17 f0    	mov    %ax,0xf017c086
    SETGATE(idt[T_GPFLT], 0, GD_KT, gpflt, DPLKERN);
f01030a8:	b8 a8 35 10 f0       	mov    $0xf01035a8,%eax
f01030ad:	66 a3 88 c0 17 f0    	mov    %ax,0xf017c088
f01030b3:	66 c7 05 8a c0 17 f0 	movw   $0x8,0xf017c08a
f01030ba:	08 00 
f01030bc:	c6 05 8c c0 17 f0 00 	movb   $0x0,0xf017c08c
f01030c3:	c6 05 8d c0 17 f0 8e 	movb   $0x8e,0xf017c08d
f01030ca:	c1 e8 10             	shr    $0x10,%eax
f01030cd:	66 a3 8e c0 17 f0    	mov    %ax,0xf017c08e
    SETGATE(idt[T_PGFLT], 0, GD_KT, pgflt, DPLKERN);
f01030d3:	b8 b0 35 10 f0       	mov    $0xf01035b0,%eax
f01030d8:	66 a3 90 c0 17 f0    	mov    %ax,0xf017c090
f01030de:	66 c7 05 92 c0 17 f0 	movw   $0x8,0xf017c092
f01030e5:	08 00 
f01030e7:	c6 05 94 c0 17 f0 00 	movb   $0x0,0xf017c094
f01030ee:	c6 05 95 c0 17 f0 8e 	movb   $0x8e,0xf017c095
f01030f5:	c1 e8 10             	shr    $0x10,%eax
f01030f8:	66 a3 96 c0 17 f0    	mov    %ax,0xf017c096
    SETGATE(idt[T_FPERR], 0, GD_KT, fperr, DPLKERN);
f01030fe:	b8 b8 35 10 f0       	mov    $0xf01035b8,%eax
f0103103:	66 a3 a0 c0 17 f0    	mov    %ax,0xf017c0a0
f0103109:	66 c7 05 a2 c0 17 f0 	movw   $0x8,0xf017c0a2
f0103110:	08 00 
f0103112:	c6 05 a4 c0 17 f0 00 	movb   $0x0,0xf017c0a4
f0103119:	c6 05 a5 c0 17 f0 8e 	movb   $0x8e,0xf017c0a5
f0103120:	c1 e8 10             	shr    $0x10,%eax
f0103123:	66 a3 a6 c0 17 f0    	mov    %ax,0xf017c0a6
    SETGATE(idt[T_ALIGN], 0, GD_KT, align, DPLKERN);
f0103129:	b8 c2 35 10 f0       	mov    $0xf01035c2,%eax
f010312e:	66 a3 a8 c0 17 f0    	mov    %ax,0xf017c0a8
f0103134:	66 c7 05 aa c0 17 f0 	movw   $0x8,0xf017c0aa
f010313b:	08 00 
f010313d:	c6 05 ac c0 17 f0 00 	movb   $0x0,0xf017c0ac
f0103144:	c6 05 ad c0 17 f0 8e 	movb   $0x8e,0xf017c0ad
f010314b:	c1 e8 10             	shr    $0x10,%eax
f010314e:	66 a3 ae c0 17 f0    	mov    %ax,0xf017c0ae
    SETGATE(idt[T_MCHK], 0, GD_KT, mchk, DPLKERN);
f0103154:	b8 ca 35 10 f0       	mov    $0xf01035ca,%eax
f0103159:	66 a3 b0 c0 17 f0    	mov    %ax,0xf017c0b0
f010315f:	66 c7 05 b2 c0 17 f0 	movw   $0x8,0xf017c0b2
f0103166:	08 00 
f0103168:	c6 05 b4 c0 17 f0 00 	movb   $0x0,0xf017c0b4
f010316f:	c6 05 b5 c0 17 f0 8e 	movb   $0x8e,0xf017c0b5
f0103176:	c1 e8 10             	shr    $0x10,%eax
f0103179:	66 a3 b6 c0 17 f0    	mov    %ax,0xf017c0b6
    SETGATE(idt[T_SIMDERR], 0, GD_KT, simderr, DPLKERN);
f010317f:	b8 d4 35 10 f0       	mov    $0xf01035d4,%eax
f0103184:	66 a3 b8 c0 17 f0    	mov    %ax,0xf017c0b8
f010318a:	66 c7 05 ba c0 17 f0 	movw   $0x8,0xf017c0ba
f0103191:	08 00 
f0103193:	c6 05 bc c0 17 f0 00 	movb   $0x0,0xf017c0bc
f010319a:	c6 05 bd c0 17 f0 8e 	movb   $0x8e,0xf017c0bd
f01031a1:	c1 e8 10             	shr    $0x10,%eax
f01031a4:	66 a3 be c0 17 f0    	mov    %ax,0xf017c0be


    SETGATE(idt[T_SYSCALL], 0, GD_KT, syscalls, DPLUSR);
f01031aa:	b8 de 35 10 f0       	mov    $0xf01035de,%eax
f01031af:	66 a3 a0 c1 17 f0    	mov    %ax,0xf017c1a0
f01031b5:	66 c7 05 a2 c1 17 f0 	movw   $0x8,0xf017c1a2
f01031bc:	08 00 
f01031be:	c6 05 a4 c1 17 f0 00 	movb   $0x0,0xf017c1a4
f01031c5:	c6 05 a5 c1 17 f0 ee 	movb   $0xee,0xf017c1a5
f01031cc:	c1 e8 10             	shr    $0x10,%eax
f01031cf:	66 a3 a6 c1 17 f0    	mov    %ax,0xf017c1a6



	// Per-CPU setup 
	trap_init_percpu();
f01031d5:	e8 6a fc ff ff       	call   f0102e44 <trap_init_percpu>
}
f01031da:	5d                   	pop    %ebp
f01031db:	c3                   	ret    
...
f01031df:	53                   	push   %ebx
f01031e0:	83 ec 0c             	sub    $0xc,%esp
f01031e3:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("  edi  0x%08x\n", regs->reg_edi);
f01031e6:	ff 33                	pushl  (%ebx)
f01031e8:	68 de 55 10 f0       	push   $0xf01055de
f01031ed:	e8 3e fc ff ff       	call   f0102e30 <cprintf>
	cprintf("  esi  0x%08x\n", regs->reg_esi);
f01031f2:	83 c4 08             	add    $0x8,%esp
f01031f5:	ff 73 04             	pushl  0x4(%ebx)
f01031f8:	68 ed 55 10 f0       	push   $0xf01055ed
f01031fd:	e8 2e fc ff ff       	call   f0102e30 <cprintf>
	cprintf("  ebp  0x%08x\n", regs->reg_ebp);
f0103202:	83 c4 08             	add    $0x8,%esp
f0103205:	ff 73 08             	pushl  0x8(%ebx)
f0103208:	68 fc 55 10 f0       	push   $0xf01055fc
f010320d:	e8 1e fc ff ff       	call   f0102e30 <cprintf>
	cprintf("  oesp 0x%08x\n", regs->reg_oesp);
f0103212:	83 c4 08             	add    $0x8,%esp
f0103215:	ff 73 0c             	pushl  0xc(%ebx)
f0103218:	68 0b 56 10 f0       	push   $0xf010560b
f010321d:	e8 0e fc ff ff       	call   f0102e30 <cprintf>
	cprintf("  ebx  0x%08x\n", regs->reg_ebx);
f0103222:	83 c4 08             	add    $0x8,%esp
f0103225:	ff 73 10             	pushl  0x10(%ebx)
f0103228:	68 1a 56 10 f0       	push   $0xf010561a
f010322d:	e8 fe fb ff ff       	call   f0102e30 <cprintf>
	cprintf("  edx  0x%08x\n", regs->reg_edx);
f0103232:	83 c4 08             	add    $0x8,%esp
f0103235:	ff 73 14             	pushl  0x14(%ebx)
f0103238:	68 29 56 10 f0       	push   $0xf0105629
f010323d:	e8 ee fb ff ff       	call   f0102e30 <cprintf>
	cprintf("  ecx  0x%08x\n", regs->reg_ecx);
f0103242:	83 c4 08             	add    $0x8,%esp
f0103245:	ff 73 18             	pushl  0x18(%ebx)
f0103248:	68 38 56 10 f0       	push   $0xf0105638
f010324d:	e8 de fb ff ff       	call   f0102e30 <cprintf>
	cprintf("  eax  0x%08x\n", regs->reg_eax);
f0103252:	83 c4 08             	add    $0x8,%esp
f0103255:	ff 73 1c             	pushl  0x1c(%ebx)
f0103258:	68 47 56 10 f0       	push   $0xf0105647
f010325d:	e8 ce fb ff ff       	call   f0102e30 <cprintf>
}
f0103262:	83 c4 10             	add    $0x10,%esp
f0103265:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0103268:	c9                   	leave  
f0103269:	c3                   	ret    

f010326a <print_trapframe>:
	lidt(&idt_pd);
}
...
f010326f:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("TRAP frame at %p\n", tf);
f0103272:	83 ec 08             	sub    $0x8,%esp
f0103275:	53                   	push   %ebx
f0103276:	68 94 57 10 f0       	push   $0xf0105794
f010327b:	e8 b0 fb ff ff       	call   f0102e30 <cprintf>
	print_regs(&tf->tf_regs);
f0103280:	89 1c 24             	mov    %ebx,(%esp)
f0103283:	e8 54 ff ff ff       	call   f01031dc <print_regs>
	cprintf("  es   0x----%04x\n", tf->tf_es);
f0103288:	83 c4 08             	add    $0x8,%esp
f010328b:	0f b7 43 20          	movzwl 0x20(%ebx),%eax
f010328f:	50                   	push   %eax
f0103290:	68 98 56 10 f0       	push   $0xf0105698
f0103295:	e8 96 fb ff ff       	call   f0102e30 <cprintf>
	cprintf("  ds   0x----%04x\n", tf->tf_ds);
f010329a:	83 c4 08             	add    $0x8,%esp
f010329d:	0f b7 43 24          	movzwl 0x24(%ebx),%eax
f01032a1:	50                   	push   %eax
f01032a2:	68 ab 56 10 f0       	push   $0xf01056ab
f01032a7:	e8 84 fb ff ff       	call   f0102e30 <cprintf>
	cprintf("  trap 0x%08x %s\n", tf->tf_trapno, trapname(tf->tf_trapno));
f01032ac:	8b 43 28             	mov    0x28(%ebx),%eax
		"Alignment Check",
		"Machine-Check",
...
f01032b2:	83 f8 13             	cmp    $0x13,%eax
f01032b5:	77 09                	ja     f01032c0 <print_trapframe+0x56>
		return excnames[trapno];
f01032b7:	8b 14 85 60 59 10 f0 	mov    -0xfefa6a0(,%eax,4),%edx
f01032be:	eb 10                	jmp    f01032d0 <print_trapframe+0x66>
	if (trapno == T_SYSCALL)
		return "System call";
	return "(unknown trap)";
f01032c0:	83 f8 30             	cmp    $0x30,%eax
f01032c3:	b9 62 56 10 f0       	mov    $0xf0105662,%ecx
f01032c8:	ba 56 56 10 f0       	mov    $0xf0105656,%edx
f01032cd:	0f 45 d1             	cmovne %ecx,%edx
{
	cprintf("TRAP frame at %p\n", tf);
	print_regs(&tf->tf_regs);
	cprintf("  es   0x----%04x\n", tf->tf_es);
...
f01032d3:	52                   	push   %edx
f01032d4:	50                   	push   %eax
f01032d5:	68 be 56 10 f0       	push   $0xf01056be
f01032da:	e8 51 fb ff ff       	call   f0102e30 <cprintf>
	// If this trap was a page fault that just happened
	// (so %cr2 is meaningful), print the faulting linear address.
	if (tf == last_tf && tf->tf_trapno == T_PGFLT)
f01032df:	83 c4 10             	add    $0x10,%esp
f01032e2:	3b 1d 20 c8 17 f0    	cmp    0xf017c820,%ebx
f01032e8:	75 1a                	jne    f0103304 <print_trapframe+0x9a>
f01032ea:	83 7b 28 0e          	cmpl   $0xe,0x28(%ebx)
f01032ee:	75 14                	jne    f0103304 <print_trapframe+0x9a>
...
f01032f0:	0f 20 d0             	mov    %cr2,%eax
		cprintf("  cr2  0x%08x\n", rcr2());
f01032f3:	83 ec 08             	sub    $0x8,%esp
f01032f6:	50                   	push   %eax
f01032f7:	68 d0 56 10 f0       	push   $0xf01056d0
f01032fc:	e8 2f fb ff ff       	call   f0102e30 <cprintf>
f0103301:	83 c4 10             	add    $0x10,%esp
	cprintf("  err  0x%08x", tf->tf_err);
f0103304:	83 ec 08             	sub    $0x8,%esp
f0103307:	ff 73 2c             	pushl  0x2c(%ebx)
f010330a:	68 df 56 10 f0       	push   $0xf01056df
f010330f:	e8 1c fb ff ff       	call   f0102e30 <cprintf>
...
f0103317:	83 7b 28 0e          	cmpl   $0xe,0x28(%ebx)
f010331b:	75 49                	jne    f0103366 <print_trapframe+0xfc>
		cprintf(" [%s, %s, %s]\n",
			tf->tf_err & 4 ? "user" : "kernel",
			tf->tf_err & 2 ? "write" : "read",
			tf->tf_err & 1 ? "protection" : "not-present");
f010331d:	8b 43 2c             	mov    0x2c(%ebx),%eax
	// For page faults, print decoded fault error code:
	// U/K=fault occurred in user/kernel mode
	// W/R=a write/read caused the fault
	// PR=a protection violation caused the fault (NP=page not present).
	if (tf->tf_trapno == T_PGFLT)
		cprintf(" [%s, %s, %s]\n",
f0103320:	89 c2                	mov    %eax,%edx
f0103322:	83 e2 01             	and    $0x1,%edx
f0103325:	ba 7c 56 10 f0       	mov    $0xf010567c,%edx
f010332a:	b9 71 56 10 f0       	mov    $0xf0105671,%ecx
f010332f:	0f 44 ca             	cmove  %edx,%ecx
f0103332:	89 c2                	mov    %eax,%edx
f0103334:	83 e2 02             	and    $0x2,%edx
f0103337:	ba 8e 56 10 f0       	mov    $0xf010568e,%edx
f010333c:	be 88 56 10 f0       	mov    $0xf0105688,%esi
f0103341:	0f 45 d6             	cmovne %esi,%edx
f0103344:	83 e0 04             	and    $0x4,%eax
f0103347:	be bf 57 10 f0       	mov    $0xf01057bf,%esi
f010334c:	b8 93 56 10 f0       	mov    $0xf0105693,%eax
f0103351:	0f 44 c6             	cmove  %esi,%eax
f0103354:	51                   	push   %ecx
f0103355:	52                   	push   %edx
f0103356:	50                   	push   %eax
f0103357:	68 ed 56 10 f0       	push   $0xf01056ed
f010335c:	e8 cf fa ff ff       	call   f0102e30 <cprintf>
f0103361:	83 c4 10             	add    $0x10,%esp
f0103364:	eb 10                	jmp    f0103376 <print_trapframe+0x10c>
			tf->tf_err & 4 ? "user" : "kernel",
			tf->tf_err & 2 ? "write" : "read",
			tf->tf_err & 1 ? "protection" : "not-present");
	else
...
f0103369:	68 3f 55 10 f0       	push   $0xf010553f
f010336e:	e8 bd fa ff ff       	call   f0102e30 <cprintf>
f0103373:	83 c4 10             	add    $0x10,%esp
	cprintf("  eip  0x%08x\n", tf->tf_eip);
f0103376:	83 ec 08             	sub    $0x8,%esp
f0103379:	ff 73 30             	pushl  0x30(%ebx)
f010337c:	68 fc 56 10 f0       	push   $0xf01056fc
f0103381:	e8 aa fa ff ff       	call   f0102e30 <cprintf>
	cprintf("  cs   0x----%04x\n", tf->tf_cs);
f0103386:	83 c4 08             	add    $0x8,%esp
f0103389:	0f b7 43 34          	movzwl 0x34(%ebx),%eax
f010338d:	50                   	push   %eax
f010338e:	68 0b 57 10 f0       	push   $0xf010570b
f0103393:	e8 98 fa ff ff       	call   f0102e30 <cprintf>
	cprintf("  flag 0x%08x\n", tf->tf_eflags);
f0103398:	83 c4 08             	add    $0x8,%esp
f010339b:	ff 73 38             	pushl  0x38(%ebx)
f010339e:	68 1e 57 10 f0       	push   $0xf010571e
f01033a3:	e8 88 fa ff ff       	call   f0102e30 <cprintf>
	if ((tf->tf_cs & 3) != 0) {
f01033a8:	83 c4 10             	add    $0x10,%esp
f01033ab:	f6 43 34 03          	testb  $0x3,0x34(%ebx)
f01033af:	74 25                	je     f01033d6 <print_trapframe+0x16c>
		cprintf("  esp  0x%08x\n", tf->tf_esp);
f01033b1:	83 ec 08             	sub    $0x8,%esp
f01033b4:	ff 73 3c             	pushl  0x3c(%ebx)
f01033b7:	68 2d 57 10 f0       	push   $0xf010572d
f01033bc:	e8 6f fa ff ff       	call   f0102e30 <cprintf>
		cprintf("  ss   0x----%04x\n", tf->tf_ss);
f01033c1:	83 c4 08             	add    $0x8,%esp
f01033c4:	0f b7 43 40          	movzwl 0x40(%ebx),%eax
f01033c8:	50                   	push   %eax
f01033c9:	68 3c 57 10 f0       	push   $0xf010573c
f01033ce:	e8 5d fa ff ff       	call   f0102e30 <cprintf>
f01033d3:	83 c4 10             	add    $0x10,%esp
	}
}
f01033d6:	8d 65 f8             	lea    -0x8(%ebp),%esp
f01033d9:	5b                   	pop    %ebx
f01033da:	5e                   	pop    %esi
f01033db:	5d                   	pop    %ebp
f01033dc:	c3                   	ret    

f01033dd <page_fault_handler>:
}
...
f01033e7:	0f 20 d0             	mov    %cr2,%eax
	...
	if((tf->tf_cs & 3)==0)
f01033ea:	f6 43 34 03          	testb  $0x3,0x34(%ebx)
f01033ee:	75 17                	jne    f0103407 <page_fault_handler+0x2a>
	    panic("page fault kernel mode");
f01033f0:	83 ec 04             	sub    $0x4,%esp
f01033f3:	68 4f 57 10 f0       	push   $0xf010574f
f01033f8:	68 06 01 00 00       	push   $0x106
f01033fd:	68 66 57 10 f0       	push   $0xf0105766
f0103402:	e8 99 cc ff ff       	call   f01000a0 <_panic>
...
f0103407:	ff 73 30             	pushl  0x30(%ebx)
f010340a:	50                   	push   %eax
f010340b:	a1 00 c0 17 f0       	mov    0xf017c000,%eax
f0103410:	ff 70 48             	pushl  0x48(%eax)
f0103413:	68 0c 59 10 f0       	push   $0xf010590c
f0103418:	e8 13 fa ff ff       	call   f0102e30 <cprintf>
		curenv->env_id, fault_va, tf->tf_eip);
	print_trapframe(tf);
f010341d:	89 1c 24             	mov    %ebx,(%esp)
f0103420:	e8 45 fe ff ff       	call   f010326a <print_trapframe>
	env_destroy(curenv);
f0103425:	83 c4 04             	add    $0x4,%esp
f0103428:	ff 35 00 c0 17 f0    	pushl  0xf017c000
f010342e:	e8 cc f8 ff ff       	call   f0102cff <env_destroy>
}
f0103433:	83 c4 10             	add    $0x10,%esp
f0103436:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0103439:	c9                   	leave  
f010343a:	c3                   	ret    
...
f0103446:	f6 c4 02             	test   $0x2,%ah
f0103449:	74 19                	je     f0103464 <trap+0x29>
f010344b:	68 72 57 10 f0       	push   $0xf0105772
f0103450:	68 52 4a 10 f0       	push   $0xf0104a52
f0103455:	68 df 00 00 00       	push   $0xdf
f010345a:	68 66 57 10 f0       	push   $0xf0105766
f010345f:	e8 3c cc ff ff       	call   f01000a0 <_panic>

	cprintf("Incoming TRAP frame at %p\n", tf);
f0103464:	83 ec 08             	sub    $0x8,%esp
f0103467:	56                   	push   %esi
f0103468:	68 8b 57 10 f0       	push   $0xf010578b
f010346d:	e8 be f9 ff ff       	call   f0102e30 <cprintf>

	if ((tf->tf_cs & 3) == 3) {
f0103472:	0f b7 46 34          	movzwl 0x34(%esi),%eax
f0103476:	83 e0 03             	and    $0x3,%eax
f0103479:	83 c4 10             	add    $0x10,%esp
f010347c:	66 83 f8 03          	cmp    $0x3,%ax
f0103480:	75 31                	jne    f01034b3 <trap+0x78>
		// Trapped from user mode.
		assert(curenv);
f0103482:	a1 00 c0 17 f0       	mov    0xf017c000,%eax
f0103487:	85 c0                	test   %eax,%eax
f0103489:	75 19                	jne    f01034a4 <trap+0x69>
f010348b:	68 a6 57 10 f0       	push   $0xf01057a6
f0103490:	68 52 4a 10 f0       	push   $0xf0104a52
f0103495:	68 e5 00 00 00       	push   $0xe5
f010349a:	68 66 57 10 f0       	push   $0xf0105766
f010349f:	e8 fc cb ff ff       	call   f01000a0 <_panic>

		// Copy trap frame (which is currently on the stack)
		// into 'curenv->env_tf', so that running the environment
		// will restart at the trap point.
		curenv->env_tf = *tf;
f01034a4:	b9 11 00 00 00       	mov    $0x11,%ecx
f01034a9:	89 c7                	mov    %eax,%edi
f01034ab:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		// The trapframe on the stack should be ignored from here on.
		tf = &curenv->env_tf;
f01034ad:	8b 35 00 c0 17 f0    	mov    0xf017c000,%esi
	}

	// Record that tf is the last real trapframe so
	// print_trapframe can print some additional information.
	last_tf = tf;
f01034b3:	89 35 20 c8 17 f0    	mov    %esi,0xf017c820
static void
trap_dispatch(struct Trapframe *tf)
{
	...
	// LAB 3: Your code here.
	if(tf->tf_trapno==14)
f01034b9:	83 7e 28 0e          	cmpl   $0xe,0x28(%esi)
f01034bd:	75 0c                	jne    f01034cb <trap+0x90>
        page_fault_handler(tf);
f01034bf:	83 ec 0c             	sub    $0xc,%esp
f01034c2:	56                   	push   %esi
f01034c3:	e8 15 ff ff ff       	call   f01033dd <page_fault_handler>
f01034c8:	83 c4 10             	add    $0x10,%esp
	// Unexpected trap: The user process or the kernel has a bug.
	print_trapframe(tf);
f01034cb:	83 ec 0c             	sub    $0xc,%esp
f01034ce:	56                   	push   %esi
f01034cf:	e8 96 fd ff ff       	call   f010326a <print_trapframe>
	if (tf->tf_cs == GD_KT)
f01034d4:	83 c4 10             	add    $0x10,%esp
f01034d7:	66 83 7e 34 08       	cmpw   $0x8,0x34(%esi)
f01034dc:	75 17                	jne    f01034f5 <trap+0xba>
		panic("unhandled trap in kernel");
f01034de:	83 ec 04             	sub    $0x4,%esp
f01034e1:	68 ad 57 10 f0       	push   $0xf01057ad
f01034e6:	68 ce 00 00 00       	push   $0xce
f01034eb:	68 66 57 10 f0       	push   $0xf0105766
f01034f0:	e8 ab cb ff ff       	call   f01000a0 <_panic>
	else {
		env_destroy(curenv);
f01034f5:	83 ec 0c             	sub    $0xc,%esp
f01034f8:	ff 35 00 c0 17 f0    	pushl  0xf017c000
f01034fe:	e8 fc f7 ff ff       	call   f0102cff <env_destroy>
...
f0103503:	a1 00 c0 17 f0       	mov    0xf017c000,%eax
f0103508:	83 c4 10             	add    $0x10,%esp
f010350b:	85 c0                	test   %eax,%eax
f010350d:	74 06                	je     f0103515 <trap+0xda>
f010350f:	83 78 54 03          	cmpl   $0x3,0x54(%eax)
f0103513:	74 19                	je     f010352e <trap+0xf3>
f0103515:	68 30 59 10 f0       	push   $0xf0105930
f010351a:	68 52 4a 10 f0       	push   $0xf0104a52
f010351f:	68 f7 00 00 00       	push   $0xf7
f0103524:	68 66 57 10 f0       	push   $0xf0105766
f0103529:	e8 72 cb ff ff       	call   f01000a0 <_panic>
	env_run(curenv);
f010352e:	83 ec 0c             	sub    $0xc,%esp
f0103531:	50                   	push   %eax
f0103532:	e8 18 f8 ff ff       	call   f0102d4f <env_run>
f0103537:	90                   	nop

f0103538 <divide_zero>:
.text
...
f010353c:	e9 a6 00 00 00       	jmp    f01035e7 <_alltraps>
f0103541:	90                   	nop
...
f0103546:	e9 9c 00 00 00       	jmp    f01035e7 <_alltraps>
f010354b:	90                   	nop

f010354c <no_seg>:
TRAPHANDLER(no_seg,T_SEGNP)
f010354c:	6a 0b                	push   $0xb
f010354e:	e9 94 00 00 00       	jmp    f01035e7 <_alltraps>
f0103553:	90                   	nop

f0103554 <debug>:
TRAPHANDLER_NOEC(debug,T_DEBUG)
f0103554:	6a 00                	push   $0x0
f0103556:	6a 01                	push   $0x1
f0103558:	e9 8a 00 00 00       	jmp    f01035e7 <_alltraps>
f010355d:	90                   	nop

f010355e <nmi>:
TRAPHANDLER_NOEC(nmi,T_NMI)
f010355e:	6a 00                	push   $0x0
f0103560:	6a 02                	push   $0x2
f0103562:	e9 80 00 00 00       	jmp    f01035e7 <_alltraps>
f0103567:	90                   	nop

f0103568 <oflow>:
TRAPHANDLER_NOEC(oflow,T_OFLOW)
f0103568:	6a 00                	push   $0x0
f010356a:	6a 04                	push   $0x4
f010356c:	e9 76 00 00 00       	jmp    f01035e7 <_alltraps>
f0103571:	90                   	nop

f0103572 <bound>:
TRAPHANDLER_NOEC(bound,T_BOUND)
f0103572:	6a 00                	push   $0x0
f0103574:	6a 05                	push   $0x5
f0103576:	e9 6c 00 00 00       	jmp    f01035e7 <_alltraps>
f010357b:	90                   	nop

f010357c <illop>:
TRAPHANDLER_NOEC(illop,T_ILLOP)
f010357c:	6a 00                	push   $0x0
f010357e:	6a 06                	push   $0x6
f0103580:	e9 62 00 00 00       	jmp    f01035e7 <_alltraps>
f0103585:	90                   	nop

f0103586 <device>:
TRAPHANDLER_NOEC(device,T_DEVICE)
f0103586:	6a 00                	push   $0x0
f0103588:	6a 07                	push   $0x7
f010358a:	e9 58 00 00 00       	jmp    f01035e7 <_alltraps>
f010358f:	90                   	nop

f0103590 <dblflt>:
TRAPHANDLER(dblflt,T_DBLFLT)
f0103590:	6a 08                	push   $0x8
f0103592:	e9 50 00 00 00       	jmp    f01035e7 <_alltraps>
f0103597:	90                   	nop

f0103598 <tss>:
TRAPHANDLER(tss, T_TSS)
f0103598:	6a 0a                	push   $0xa
f010359a:	e9 48 00 00 00       	jmp    f01035e7 <_alltraps>
f010359f:	90                   	nop

f01035a0 <stack>:

TRAPHANDLER(stack, T_STACK)
f01035a0:	6a 0c                	push   $0xc
f01035a2:	e9 40 00 00 00       	jmp    f01035e7 <_alltraps>
f01035a7:	90                   	nop

f01035a8 <gpflt>:
TRAPHANDLER(gpflt, T_GPFLT)
f01035a8:	6a 0d                	push   $0xd
f01035aa:	e9 38 00 00 00       	jmp    f01035e7 <_alltraps>
f01035af:	90                   	nop

f01035b0 <pgflt>:
TRAPHANDLER(pgflt, T_PGFLT)
f01035b0:	6a 0e                	push   $0xe
f01035b2:	e9 30 00 00 00       	jmp    f01035e7 <_alltraps>
f01035b7:	90                   	nop
...
f01035ba:	6a 10                	push   $0x10
f01035bc:	e9 26 00 00 00       	jmp    f01035e7 <_alltraps>
f01035c1:	90                   	nop

f01035c2 <align>:
TRAPHANDLER(align, T_ALIGN)
f01035c2:	6a 11                	push   $0x11
f01035c4:	e9 1e 00 00 00       	jmp    f01035e7 <_alltraps>
f01035c9:	90                   	nop

f01035ca <mchk>:
TRAPHANDLER_NOEC(mchk, T_MCHK)
f01035ca:	6a 00                	push   $0x0
f01035cc:	6a 12                	push   $0x12
f01035ce:	e9 14 00 00 00       	jmp    f01035e7 <_alltraps>
f01035d3:	90                   	nop

f01035d4 <simderr>:
TRAPHANDLER_NOEC(simderr, T_SIMDERR)
f01035d4:	6a 00                	push   $0x0
f01035d6:	6a 13                	push   $0x13
f01035d8:	e9 0a 00 00 00       	jmp    f01035e7 <_alltraps>
f01035dd:	90                   	nop
...
f01035e0:	6a 30                	push   $0x30
f01035e2:	e9 00 00 00 00       	jmp    f01035e7 <_alltraps>
...
f01035e9:	60                   	pusha  
	...
	movw $GD_KD, %ax
f01035ea:	66 b8 10 00          	mov    $0x10,%ax
	movw %ax, %ds
f01035ee:	8e d8                	mov    %eax,%ds
	movw %ax, %es 
f01035f0:	8e c0                	mov    %eax,%es

    pushl %esp  /* trap(%esp) */
f01035f2:	54                   	push   %esp
    call trap
f01035f3:	e8 43 fe ff ff       	call   f010343b <trap>
...
f01035fe:	68 b0 59 10 f0       	push   $0xf01059b0
f0103603:	6a 49                	push   $0x49
f0103605:	68 c8 59 10 f0       	push   $0xf01059c8
f010360a:	e8 91 ca ff ff       	call   f01000a0 <_panic>

f010360f <stab_binsearch>:
...
f0103612:	57                   	push   %edi
f0103613:	56                   	push   %esi
f0103614:	53                   	push   %ebx
f0103615:	83 ec 14             	sub    $0x14,%esp
f0103618:	89 45 ec             	mov    %eax,-0x14(%ebp)
f010361b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
f010361e:	89 4d e0             	mov    %ecx,-0x20(%ebp)
f0103621:	8b 7d 08             	mov    0x8(%ebp),%edi
	int l = *region_left, r = *region_right, any_matches = 0;
f0103624:	8b 1a                	mov    (%edx),%ebx
f0103626:	8b 01                	mov    (%ecx),%eax
f0103628:	89 45 f0             	mov    %eax,-0x10(%ebp)
f010362b:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)

	while (l <= r) {
f0103632:	eb 7f                	jmp    f01036b3 <stab_binsearch+0xa4>
		int true_m = (l + r) / 2, m = true_m;
f0103634:	8b 45 f0             	mov    -0x10(%ebp),%eax
f0103637:	01 d8                	add    %ebx,%eax
f0103639:	89 c6                	mov    %eax,%esi
f010363b:	c1 ee 1f             	shr    $0x1f,%esi
f010363e:	01 c6                	add    %eax,%esi
f0103640:	d1 fe                	sar    %esi
f0103642:	8d 04 76             	lea    (%esi,%esi,2),%eax
f0103645:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f0103648:	8d 14 81             	lea    (%ecx,%eax,4),%edx
f010364b:	89 f0                	mov    %esi,%eax

		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f010364d:	eb 03                	jmp    f0103652 <stab_binsearch+0x43>
			m--;
f010364f:	83 e8 01             	sub    $0x1,%eax
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0103652:	39 c3                	cmp    %eax,%ebx
f0103654:	7f 0d                	jg     f0103663 <stab_binsearch+0x54>
f0103656:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f010365a:	83 ea 0c             	sub    $0xc,%edx
f010365d:	39 f9                	cmp    %edi,%ecx
f010365f:	75 ee                	jne    f010364f <stab_binsearch+0x40>
f0103661:	eb 05                	jmp    f0103668 <stab_binsearch+0x59>
			m--;
		if (m < l) {	// no match in [l, m]
			l = true_m + 1;
f0103663:	8d 5e 01             	lea    0x1(%esi),%ebx
			continue;
f0103666:	eb 4b                	jmp    f01036b3 <stab_binsearch+0xa4>
		}

		// actual binary search
		any_matches = 1;
		if (stabs[m].n_value < addr) {
f0103668:	8d 14 40             	lea    (%eax,%eax,2),%edx
f010366b:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f010366e:	8b 54 91 08          	mov    0x8(%ecx,%edx,4),%edx
f0103672:	39 55 0c             	cmp    %edx,0xc(%ebp)
f0103675:	76 11                	jbe    f0103688 <stab_binsearch+0x79>
			*region_left = m;
f0103677:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
f010367a:	89 03                	mov    %eax,(%ebx)
			l = true_m + 1;
f010367c:	8d 5e 01             	lea    0x1(%esi),%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f010367f:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f0103686:	eb 2b                	jmp    f01036b3 <stab_binsearch+0xa4>
		if (stabs[m].n_value < addr) {
			*region_left = m;
			l = true_m + 1;
		} else if (stabs[m].n_value > addr) {
f0103688:	39 55 0c             	cmp    %edx,0xc(%ebp)
f010368b:	73 14                	jae    f01036a1 <stab_binsearch+0x92>
			*region_right = m - 1;
f010368d:	83 e8 01             	sub    $0x1,%eax
f0103690:	89 45 f0             	mov    %eax,-0x10(%ebp)
f0103693:	8b 75 e0             	mov    -0x20(%ebp),%esi
f0103696:	89 06                	mov    %eax,(%esi)
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f0103698:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f010369f:	eb 12                	jmp    f01036b3 <stab_binsearch+0xa4>
			*region_right = m - 1;
			r = m - 1;
		} else {
			...
			// *region_right
			*region_left = m;
f01036a1:	8b 75 e4             	mov    -0x1c(%ebp),%esi
f01036a4:	89 06                	mov    %eax,(%esi)
			l = m;
			addr++;
f01036a6:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
f01036aa:	89 c3                	mov    %eax,%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f01036ac:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
stab_binsearch(const struct Stab *stabs, int *region_left, int *region_right,
	       int type, uintptr_t addr)
{
	int l = *region_left, r = *region_right, any_matches = 0;
	...
	while (l <= r) {
f01036b3:	3b 5d f0             	cmp    -0x10(%ebp),%ebx
f01036b6:	0f 8e 78 ff ff ff    	jle    f0103634 <stab_binsearch+0x25>
			l = m;
			addr++;
		}
	}
	...
	if (!any_matches)
f01036bc:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
f01036c0:	75 0f                	jne    f01036d1 <stab_binsearch+0xc2>
		*region_right = *region_left - 1;
f01036c2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f01036c5:	8b 00                	mov    (%eax),%eax
f01036c7:	83 e8 01             	sub    $0x1,%eax
f01036ca:	8b 75 e0             	mov    -0x20(%ebp),%esi
f01036cd:	89 06                	mov    %eax,(%esi)
f01036cf:	eb 2c                	jmp    f01036fd <stab_binsearch+0xee>
	else {
...
f01036d6:	8b 75 e4             	mov    -0x1c(%ebp),%esi
f01036d9:	8b 0e                	mov    (%esi),%ecx
f01036db:	8d 14 40             	lea    (%eax,%eax,2),%edx
f01036de:	8b 75 ec             	mov    -0x14(%ebp),%esi
f01036e1:	8d 14 96             	lea    (%esi,%edx,4),%edx
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01036e4:	eb 03                	jmp    f01036e9 <stab_binsearch+0xda>
		     l > *region_left && stabs[l].n_type != type;
		     l--)
f01036e6:	83 e8 01             	sub    $0x1,%eax
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01036e9:	39 c8                	cmp    %ecx,%eax
f01036eb:	7e 0b                	jle    f01036f8 <stab_binsearch+0xe9>
		     l > *region_left && stabs[l].n_type != type;
f01036ed:	0f b6 5a 04          	movzbl 0x4(%edx),%ebx
f01036f1:	83 ea 0c             	sub    $0xc,%edx
f01036f4:	39 df                	cmp    %ebx,%edi
f01036f6:	75 ee                	jne    f01036e6 <stab_binsearch+0xd7>
		     l--)
			/* do nothing */;
		*region_left = l;
f01036f8:	8b 75 e4             	mov    -0x1c(%ebp),%esi
f01036fb:	89 06                	mov    %eax,(%esi)
	}
}
f01036fd:	83 c4 14             	add    $0x14,%esp
f0103700:	5b                   	pop    %ebx
f0103701:	5e                   	pop    %esi
f0103702:	5f                   	pop    %edi
f0103703:	5d                   	pop    %ebp
...
f0103708:	57                   	push   %edi
f0103709:	56                   	push   %esi
f010370a:	53                   	push   %ebx
f010370b:	83 ec 2c             	sub    $0x2c,%esp
f010370e:	8b 7d 08             	mov    0x8(%ebp),%edi
f0103711:	8b 75 0c             	mov    0xc(%ebp),%esi
...
f0103714:	c7 06 d7 59 10 f0    	movl   $0xf01059d7,(%esi)
	info->eip_line = 0;
f010371a:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
	info->eip_fn_name = "<unknown>";
f0103721:	c7 46 08 d7 59 10 f0 	movl   $0xf01059d7,0x8(%esi)
	info->eip_fn_namelen = 9;
f0103728:	c7 46 0c 09 00 00 00 	movl   $0x9,0xc(%esi)
	info->eip_fn_addr = addr;
f010372f:	89 7e 10             	mov    %edi,0x10(%esi)
	info->eip_fn_narg = 0;
f0103732:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)

	// Find the relevant set of stabs
	if (addr >= ULIM) {
f0103739:	81 ff ff ff 7f ef    	cmp    $0xef7fffff,%edi
f010373f:	77 21                	ja     f0103762 <debuginfo_eip+0x5d>
		...
		stabs = usd->stabs;
f0103741:	a1 00 00 20 00       	mov    0x200000,%eax
f0103746:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		stab_end = usd->stab_end;
f0103749:	a1 04 00 20 00       	mov    0x200004,%eax
		stabstr = usd->stabstr;
f010374e:	8b 0d 08 00 20 00    	mov    0x200008,%ecx
f0103754:	89 4d cc             	mov    %ecx,-0x34(%ebp)
		stabstr_end = usd->stabstr_end;
f0103757:	8b 0d 0c 00 20 00    	mov    0x20000c,%ecx
f010375d:	89 4d d0             	mov    %ecx,-0x30(%ebp)
f0103760:	eb 1a                	jmp    f010377c <debuginfo_eip+0x77>
	// Find the relevant set of stabs
	if (addr >= ULIM) {
...
f0103762:	c7 45 d0 81 fa 10 f0 	movl   $0xf010fa81,-0x30(%ebp)
	...
	if (addr >= ULIM) {
		...
		stab_end = __STAB_END__;
		stabstr = __STABSTR_BEGIN__;
f0103769:	c7 45 cc cd d0 10 f0 	movl   $0xf010d0cd,-0x34(%ebp)
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
		stab_end = __STAB_END__;
f0103770:	b8 cc d0 10 f0       	mov    $0xf010d0cc,%eax
	info->eip_fn_addr = addr;
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
f0103775:	c7 45 d4 f0 5b 10 f0 	movl   $0xf0105bf0,-0x2c(%ebp)
...
f010377c:	8b 4d d0             	mov    -0x30(%ebp),%ecx
f010377f:	39 4d cc             	cmp    %ecx,-0x34(%ebp)
f0103782:	0f 83 2b 01 00 00    	jae    f01038b3 <debuginfo_eip+0x1ae>
f0103788:	80 79 ff 00          	cmpb   $0x0,-0x1(%ecx)
f010378c:	0f 85 28 01 00 00    	jne    f01038ba <debuginfo_eip+0x1b5>
	...
	lfile = 0;
f0103792:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	rfile = (stab_end - stabs) - 1;
f0103799:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
f010379c:	29 d8                	sub    %ebx,%eax
f010379e:	c1 f8 02             	sar    $0x2,%eax
f01037a1:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
f01037a7:	83 e8 01             	sub    $0x1,%eax
f01037aa:	89 45 e0             	mov    %eax,-0x20(%ebp)
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
f01037ad:	57                   	push   %edi
f01037ae:	6a 64                	push   $0x64
f01037b0:	8d 45 e0             	lea    -0x20(%ebp),%eax
f01037b3:	89 c1                	mov    %eax,%ecx
f01037b5:	8d 55 e4             	lea    -0x1c(%ebp),%edx
f01037b8:	89 d8                	mov    %ebx,%eax
f01037ba:	e8 50 fe ff ff       	call   f010360f <stab_binsearch>
	if (lfile == 0)
f01037bf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f01037c2:	83 c4 08             	add    $0x8,%esp
f01037c5:	85 c0                	test   %eax,%eax
f01037c7:	0f 84 f4 00 00 00    	je     f01038c1 <debuginfo_eip+0x1bc>
		return -1;

	// Search within that file's stabs for the function definition
	// (N_FUN).
	lfun = lfile;
f01037cd:	89 45 dc             	mov    %eax,-0x24(%ebp)
	rfun = rfile;
f01037d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
f01037d3:	89 45 d8             	mov    %eax,-0x28(%ebp)
	stab_binsearch(stabs, &lfun, &rfun, N_FUN, addr);
f01037d6:	57                   	push   %edi
f01037d7:	6a 24                	push   $0x24
f01037d9:	8d 45 d8             	lea    -0x28(%ebp),%eax
f01037dc:	89 c1                	mov    %eax,%ecx
f01037de:	8d 55 dc             	lea    -0x24(%ebp),%edx
f01037e1:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
f01037e4:	89 d8                	mov    %ebx,%eax
f01037e6:	e8 24 fe ff ff       	call   f010360f <stab_binsearch>

	if (lfun <= rfun) {
f01037eb:	8b 5d dc             	mov    -0x24(%ebp),%ebx
f01037ee:	83 c4 08             	add    $0x8,%esp
f01037f1:	3b 5d d8             	cmp    -0x28(%ebp),%ebx
f01037f4:	7f 24                	jg     f010381a <debuginfo_eip+0x115>
		// stabs[lfun] points to the function name
		// in the string table, but check bounds just in case.
		if (stabs[lfun].n_strx < stabstr_end - stabstr)
f01037f6:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f01037f9:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
f01037fc:	8d 14 81             	lea    (%ecx,%eax,4),%edx
f01037ff:	8b 02                	mov    (%edx),%eax
f0103801:	8b 4d d0             	mov    -0x30(%ebp),%ecx
f0103804:	8b 7d cc             	mov    -0x34(%ebp),%edi
f0103807:	29 f9                	sub    %edi,%ecx
f0103809:	39 c8                	cmp    %ecx,%eax
f010380b:	73 05                	jae    f0103812 <debuginfo_eip+0x10d>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f010380d:	01 f8                	add    %edi,%eax
f010380f:	89 46 08             	mov    %eax,0x8(%esi)
		info->eip_fn_addr = stabs[lfun].n_value;
f0103812:	8b 42 08             	mov    0x8(%edx),%eax
f0103815:	89 46 10             	mov    %eax,0x10(%esi)
f0103818:	eb 06                	jmp    f0103820 <debuginfo_eip+0x11b>
		lline = lfun;
		rline = rfun;
	} else {
		...
		info->eip_fn_addr = addr;
f010381a:	89 7e 10             	mov    %edi,0x10(%esi)
		lline = lfile;
...
f0103820:	83 ec 08             	sub    $0x8,%esp
f0103823:	6a 3a                	push   $0x3a
f0103825:	ff 76 08             	pushl  0x8(%esi)
f0103828:	e8 9a 08 00 00       	call   f01040c7 <strfind>
f010382d:	2b 46 08             	sub    0x8(%esi),%eax
f0103830:	89 46 0c             	mov    %eax,0xc(%esi)
	...
	while (lline >= lfile
f0103833:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103836:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f0103839:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
f010383c:	8d 04 81             	lea    (%ecx,%eax,4),%eax
f010383f:	83 c4 10             	add    $0x10,%esp
f0103842:	eb 06                	jmp    f010384a <debuginfo_eip+0x145>
	       && stabs[lline].n_type != N_SOL
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
		lline--;
f0103844:	83 eb 01             	sub    $0x1,%ebx
f0103847:	83 e8 0c             	sub    $0xc,%eax
	// Search backwards from the line number for the relevant filename
	// stab.
	// We can't just use the "lfile" stab because inlined functions
	// can interpolate code from a different file!
	// Such included source files use the N_SOL stab type.
	while (lline >= lfile
f010384a:	39 fb                	cmp    %edi,%ebx
f010384c:	7c 2d                	jl     f010387b <debuginfo_eip+0x176>
	       && stabs[lline].n_type != N_SOL
f010384e:	0f b6 50 04          	movzbl 0x4(%eax),%edx
f0103852:	80 fa 84             	cmp    $0x84,%dl
f0103855:	74 0b                	je     f0103862 <debuginfo_eip+0x15d>
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
f0103857:	80 fa 64             	cmp    $0x64,%dl
f010385a:	75 e8                	jne    f0103844 <debuginfo_eip+0x13f>
f010385c:	83 78 08 00          	cmpl   $0x0,0x8(%eax)
f0103860:	74 e2                	je     f0103844 <debuginfo_eip+0x13f>
		lline--;
	if (lline >= lfile && stabs[lline].n_strx < stabstr_end - stabstr)
f0103862:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f0103865:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f0103868:	8b 14 87             	mov    (%edi,%eax,4),%edx
f010386b:	8b 45 d0             	mov    -0x30(%ebp),%eax
f010386e:	8b 7d cc             	mov    -0x34(%ebp),%edi
f0103871:	29 f8                	sub    %edi,%eax
f0103873:	39 c2                	cmp    %eax,%edx
f0103875:	73 04                	jae    f010387b <debuginfo_eip+0x176>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0103877:	01 fa                	add    %edi,%edx
f0103879:	89 16                	mov    %edx,(%esi)


	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
f010387b:	8b 5d dc             	mov    -0x24(%ebp),%ebx
f010387e:	8b 4d d8             	mov    -0x28(%ebp),%ecx
		for (lline = lfun + 1;
	...
	return 0;
f0103881:	b8 00 00 00 00       	mov    $0x0,%eax
		info->eip_file = stabstr + stabs[lline].n_strx;
	...
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0103886:	39 cb                	cmp    %ecx,%ebx
f0103888:	7d 43                	jge    f01038cd <debuginfo_eip+0x1c8>
		for (lline = lfun + 1;
f010388a:	8d 53 01             	lea    0x1(%ebx),%edx
f010388d:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f0103890:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f0103893:	8d 04 87             	lea    (%edi,%eax,4),%eax
f0103896:	eb 07                	jmp    f010389f <debuginfo_eip+0x19a>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
f0103898:	83 46 14 01          	addl   $0x1,0x14(%esi)
	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
		for (lline = lfun + 1;
...
f010389c:	83 c2 01             	add    $0x1,%edx
	...
	if (lfun < rfun)
		for (lline = lfun + 1;
f010389f:	39 ca                	cmp    %ecx,%edx
f01038a1:	74 25                	je     f01038c8 <debuginfo_eip+0x1c3>
f01038a3:	83 c0 0c             	add    $0xc,%eax
		     lline < rfun && stabs[lline].n_type == N_PSYM;
f01038a6:	80 78 04 a0          	cmpb   $0xa0,0x4(%eax)
f01038aa:	74 ec                	je     f0103898 <debuginfo_eip+0x193>
		     lline++)
			info->eip_fn_narg++;

	return 0;
f01038ac:	b8 00 00 00 00       	mov    $0x0,%eax
f01038b1:	eb 1a                	jmp    f01038cd <debuginfo_eip+0x1c8>
		// LAB 3: Your code here.
	}
	...
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
		return -1;
f01038b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01038b8:	eb 13                	jmp    f01038cd <debuginfo_eip+0x1c8>
f01038ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01038bf:	eb 0c                	jmp    f01038cd <debuginfo_eip+0x1c8>
	// Search the entire set of stabs for the source file (type N_SO).
	lfile = 0;
	rfile = (stab_end - stabs) - 1;
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
...
f01038c6:	eb 05                	jmp    f01038cd <debuginfo_eip+0x1c8>
		for (lline = lfun + 1;
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
	...
	return 0;
f01038c8:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
f01038d8:	57                   	push   %edi
f01038d9:	56                   	push   %esi
f01038da:	53                   	push   %ebx
f01038db:	83 ec 1c             	sub    $0x1c,%esp
f01038de:	89 c7                	mov    %eax,%edi
f01038e0:	89 d6                	mov    %edx,%esi
f01038e2:	8b 45 08             	mov    0x8(%ebp),%eax
f01038e5:	8b 55 0c             	mov    0xc(%ebp),%edx
f01038e8:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01038eb:	89 55 dc             	mov    %edx,-0x24(%ebp)
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
f01038ee:	8b 4d 10             	mov    0x10(%ebp),%ecx
f01038f1:	bb 00 00 00 00       	mov    $0x0,%ebx
f01038f6:	89 4d e0             	mov    %ecx,-0x20(%ebp)
f01038f9:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
f01038fc:	39 d3                	cmp    %edx,%ebx
f01038fe:	72 05                	jb     f0103905 <printnum+0x30>
f0103900:	39 45 10             	cmp    %eax,0x10(%ebp)
f0103903:	77 45                	ja     f010394a <printnum+0x75>
		printnum(putch, putdat, num / base, base, width - 1, padc);
f0103905:	83 ec 0c             	sub    $0xc,%esp
f0103908:	ff 75 18             	pushl  0x18(%ebp)
f010390b:	8b 45 14             	mov    0x14(%ebp),%eax
f010390e:	8d 58 ff             	lea    -0x1(%eax),%ebx
...
f0103924:	e8 c7 09 00 00       	call   f01042f0 <__udivdi3>
f0103929:	83 c4 18             	add    $0x18,%esp
f010392c:	52                   	push   %edx
f010392d:	50                   	push   %eax
f010392e:	89 f2                	mov    %esi,%edx
f0103930:	89 f8                	mov    %edi,%eax
f0103932:	e8 9e ff ff ff       	call   f01038d5 <printnum>
f0103937:	83 c4 20             	add    $0x20,%esp
f010393a:	eb 18                	jmp    f0103954 <printnum+0x7f>
	} else {
...
f0103940:	ff 75 18             	pushl  0x18(%ebp)
f0103943:	ff d7                	call   *%edi
f0103945:	83 c4 10             	add    $0x10,%esp
f0103948:	eb 03                	jmp    f010394d <printnum+0x78>
f010394a:	8b 5d 14             	mov    0x14(%ebp),%ebx
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
		printnum(putch, putdat, num / base, base, width - 1, padc);
	} else {
		// print any needed pad characters before first digit
		while (--width > 0)
f010394d:	83 eb 01             	sub    $0x1,%ebx
f0103950:	85 db                	test   %ebx,%ebx
f0103952:	7f e8                	jg     f010393c <printnum+0x67>
			putch(padc, putdat);
	}

	// then print this (the least significant) digit
	putch("0123456789abcdef"[num % base], putdat);
f0103954:	83 ec 08             	sub    $0x8,%esp
f0103957:	56                   	push   %esi
f0103958:	83 ec 04             	sub    $0x4,%esp
f010395b:	ff 75 e4             	pushl  -0x1c(%ebp)
f010395e:	ff 75 e0             	pushl  -0x20(%ebp)
f0103961:	ff 75 dc             	pushl  -0x24(%ebp)
f0103964:	ff 75 d8             	pushl  -0x28(%ebp)
f0103967:	e8 b4 0a 00 00       	call   f0104420 <__umoddi3>
f010396c:	83 c4 14             	add    $0x14,%esp
f010396f:	0f be 80 e1 59 10 f0 	movsbl -0xfefa61f(%eax),%eax
f0103976:	50                   	push   %eax
f0103977:	ff d7                	call   *%edi
}
f0103979:	83 c4 10             	add    $0x10,%esp
f010397c:	8d 65 f4             	lea    -0xc(%ebp),%esp
f010397f:	5b                   	pop    %ebx
f0103980:	5e                   	pop    %esi
f0103981:	5f                   	pop    %edi
f0103982:	5d                   	pop    %ebp
...
f0103987:	8b 45 0c             	mov    0xc(%ebp),%eax
	b->cnt++;
f010398a:	83 40 08 01          	addl   $0x1,0x8(%eax)
	if (b->buf < b->ebuf)
f010398e:	8b 10                	mov    (%eax),%edx
f0103990:	3b 50 04             	cmp    0x4(%eax),%edx
f0103993:	73 0a                	jae    f010399f <sprintputch+0x1b>
		*b->buf++ = ch;
f0103995:	8d 4a 01             	lea    0x1(%edx),%ecx
f0103998:	89 08                	mov    %ecx,(%eax)
f010399a:	8b 45 08             	mov    0x8(%ebp),%eax
f010399d:	88 02                	mov    %al,(%edx)
}
f010399f:	5d                   	pop    %ebp
f01039a0:	c3                   	ret    
...
f01039a4:	83 ec 08             	sub    $0x8,%esp
	...
	va_start(ap, fmt);
f01039a7:	8d 45 14             	lea    0x14(%ebp),%eax
	vprintfmt(putch, putdat, fmt, ap);
f01039aa:	50                   	push   %eax
f01039ab:	ff 75 10             	pushl  0x10(%ebp)
f01039ae:	ff 75 0c             	pushl  0xc(%ebp)
f01039b1:	ff 75 08             	pushl  0x8(%ebp)
f01039b4:	e8 05 00 00 00       	call   f01039be <vprintfmt>
	va_end(ap);
}
...
f01039c4:	83 ec 2c             	sub    $0x2c,%esp
f01039c7:	8b 75 08             	mov    0x8(%ebp),%esi
f01039ca:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f01039cd:	8b 7d 10             	mov    0x10(%ebp),%edi
f01039d0:	eb 12                	jmp    f01039e4 <vprintfmt+0x26>
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
			if (ch == '\0')
f01039d2:	85 c0                	test   %eax,%eax
f01039d4:	0f 84 42 04 00 00    	je     f0103e1c <vprintfmt+0x45e>
				return;
			putch(ch, putdat);
f01039da:	83 ec 08             	sub    $0x8,%esp
f01039dd:	53                   	push   %ebx
f01039de:	50                   	push   %eax
f01039df:	ff d6                	call   *%esi
f01039e1:	83 c4 10             	add    $0x10,%esp
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
f01039e4:	83 c7 01             	add    $0x1,%edi
f01039e7:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
f01039eb:	83 f8 25             	cmp    $0x25,%eax
f01039ee:	75 e2                	jne    f01039d2 <vprintfmt+0x14>
f01039f0:	c6 45 d4 20          	movb   $0x20,-0x2c(%ebp)
f01039f4:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
f01039fb:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
f0103a02:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
f0103a09:	b9 00 00 00 00       	mov    $0x0,%ecx
f0103a0e:	eb 07                	jmp    f0103a17 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0103a10:	8b 7d e4             	mov    -0x1c(%ebp),%edi

		// flag to pad on the right
		case '-':
			padc = '-';
f0103a13:	c6 45 d4 2d          	movb   $0x2d,-0x2c(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103a17:	8d 47 01             	lea    0x1(%edi),%eax
f0103a1a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f0103a1d:	0f b6 07             	movzbl (%edi),%eax
f0103a20:	0f b6 d0             	movzbl %al,%edx
f0103a23:	83 e8 23             	sub    $0x23,%eax
f0103a26:	3c 55                	cmp    $0x55,%al
f0103a28:	0f 87 d3 03 00 00    	ja     f0103e01 <vprintfmt+0x443>
f0103a2e:	0f b6 c0             	movzbl %al,%eax
f0103a31:	ff 24 85 6c 5a 10 f0 	jmp    *-0xfefa594(,%eax,4)
f0103a38:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '0':
			padc = '0';
f0103a3b:	c6 45 d4 30          	movb   $0x30,-0x2c(%ebp)
f0103a3f:	eb d6                	jmp    f0103a17 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103a41:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103a44:	b8 00 00 00 00       	mov    $0x0,%eax
f0103a49:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		case '6':
		case '7':
		case '8':
		case '9':
...
f0103a4c:	8d 04 80             	lea    (%eax,%eax,4),%eax
f0103a4f:	8d 44 42 d0          	lea    -0x30(%edx,%eax,2),%eax
				ch = *fmt;
f0103a53:	0f be 17             	movsbl (%edi),%edx
				if (ch < '0' || ch > '9')
f0103a56:	8d 4a d0             	lea    -0x30(%edx),%ecx
f0103a59:	83 f9 09             	cmp    $0x9,%ecx
f0103a5c:	77 3f                	ja     f0103a9d <vprintfmt+0xdf>
		case '5':
		case '6':
		case '7':
		case '8':
		case '9':
			for (precision = 0; ; ++fmt) {
f0103a5e:	83 c7 01             	add    $0x1,%edi
				precision = precision * 10 + ch - '0';
				ch = *fmt;
				if (ch < '0' || ch > '9')
					break;
			}
f0103a61:	eb e9                	jmp    f0103a4c <vprintfmt+0x8e>
			goto process_precision;

		case '*':
			precision = va_arg(ap, int);
f0103a63:	8b 45 14             	mov    0x14(%ebp),%eax
f0103a66:	8b 00                	mov    (%eax),%eax
f0103a68:	89 45 d0             	mov    %eax,-0x30(%ebp)
f0103a6b:	8b 45 14             	mov    0x14(%ebp),%eax
f0103a6e:	8d 40 04             	lea    0x4(%eax),%eax
f0103a71:	89 45 14             	mov    %eax,0x14(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103a74:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			}
			goto process_precision;
		...
		case '*':
			precision = va_arg(ap, int);
			goto process_precision;
f0103a77:	eb 2a                	jmp    f0103aa3 <vprintfmt+0xe5>
f0103a79:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0103a7c:	85 c0                	test   %eax,%eax
f0103a7e:	ba 00 00 00 00       	mov    $0x0,%edx
f0103a83:	0f 49 d0             	cmovns %eax,%edx
f0103a86:	89 55 e0             	mov    %edx,-0x20(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103a89:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103a8c:	eb 89                	jmp    f0103a17 <vprintfmt+0x59>
f0103a8e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '#':
			altflag = 1;
f0103a91:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
			goto reswitch;
f0103a98:	e9 7a ff ff ff       	jmp    f0103a17 <vprintfmt+0x59>
f0103a9d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f0103aa0:	89 45 d0             	mov    %eax,-0x30(%ebp)

		process_precision:
			if (width < 0)
f0103aa3:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
f0103aa7:	0f 89 6a ff ff ff    	jns    f0103a17 <vprintfmt+0x59>
				width = precision, precision = -1;
f0103aad:	8b 45 d0             	mov    -0x30(%ebp),%eax
f0103ab0:	89 45 e0             	mov    %eax,-0x20(%ebp)
f0103ab3:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
f0103aba:	e9 58 ff ff ff       	jmp    f0103a17 <vprintfmt+0x59>
			goto reswitch;

		// long flag (doubled for long long)
		case 'l':
			lflag++;
f0103abf:	83 c1 01             	add    $0x1,%ecx
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0103ac2:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'l':
			lflag++;
			goto reswitch;
f0103ac5:	e9 4d ff ff ff       	jmp    f0103a17 <vprintfmt+0x59>

		// character
		case 'c':
			putch(va_arg(ap, int), putdat);
f0103aca:	8b 45 14             	mov    0x14(%ebp),%eax
f0103acd:	8d 78 04             	lea    0x4(%eax),%edi
f0103ad0:	83 ec 08             	sub    $0x8,%esp
f0103ad3:	53                   	push   %ebx
f0103ad4:	ff 30                	pushl  (%eax)
...
f0103ad8:	83 c4 10             	add    $0x10,%esp
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
f0103adb:	89 7d 14             	mov    %edi,0x14(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103ade:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			goto reswitch;
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
			break;
f0103ae1:	e9 fe fe ff ff       	jmp    f01039e4 <vprintfmt+0x26>

		// error message
		case 'e':
			err = va_arg(ap, int);
f0103ae6:	8b 45 14             	mov    0x14(%ebp),%eax
f0103ae9:	8d 78 04             	lea    0x4(%eax),%edi
f0103aec:	8b 00                	mov    (%eax),%eax
f0103aee:	99                   	cltd   
f0103aef:	31 d0                	xor    %edx,%eax
f0103af1:	29 d0                	sub    %edx,%eax
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
f0103af3:	83 f8 06             	cmp    $0x6,%eax
f0103af6:	7f 0b                	jg     f0103b03 <vprintfmt+0x145>
f0103af8:	8b 14 85 c4 5b 10 f0 	mov    -0xfefa43c(,%eax,4),%edx
f0103aff:	85 d2                	test   %edx,%edx
f0103b01:	75 1b                	jne    f0103b1e <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
f0103b03:	50                   	push   %eax
f0103b04:	68 f9 59 10 f0       	push   $0xf01059f9
f0103b09:	53                   	push   %ebx
f0103b0a:	56                   	push   %esi
f0103b0b:	e8 91 fe ff ff       	call   f01039a1 <printfmt>
f0103b10:	83 c4 10             	add    $0x10,%esp
		...
		case 'e':
			err = va_arg(ap, int);
f0103b13:	89 7d 14             	mov    %edi,0x14(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103b16:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'e':
			err = va_arg(ap, int);
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
f0103b19:	e9 c6 fe ff ff       	jmp    f01039e4 <vprintfmt+0x26>
			else
				printfmt(putch, putdat, "%s", p);
f0103b1e:	52                   	push   %edx
f0103b1f:	68 64 4a 10 f0       	push   $0xf0104a64
f0103b24:	53                   	push   %ebx
f0103b25:	56                   	push   %esi
f0103b26:	e8 76 fe ff ff       	call   f01039a1 <printfmt>
f0103b2b:	83 c4 10             	add    $0x10,%esp
		...
		case 'e':
			err = va_arg(ap, int);
f0103b2e:	89 7d 14             	mov    %edi,0x14(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0103b34:	e9 ab fe ff ff       	jmp    f01039e4 <vprintfmt+0x26>
				printfmt(putch, putdat, "%s", p);
			break;
...
f0103b39:	8b 45 14             	mov    0x14(%ebp),%eax
f0103b3c:	83 c0 04             	add    $0x4,%eax
f0103b3f:	89 45 cc             	mov    %eax,-0x34(%ebp)
f0103b42:	8b 45 14             	mov    0x14(%ebp),%eax
f0103b45:	8b 38                	mov    (%eax),%edi
				p = "(null)";
f0103b47:	85 ff                	test   %edi,%edi
f0103b49:	b8 f2 59 10 f0       	mov    $0xf01059f2,%eax
f0103b4e:	0f 44 f8             	cmove  %eax,%edi
			if (width > 0 && padc != '-')
f0103b51:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
f0103b55:	0f 8e 94 00 00 00    	jle    f0103bef <vprintfmt+0x231>
f0103b5b:	80 7d d4 2d          	cmpb   $0x2d,-0x2c(%ebp)
f0103b5f:	0f 84 98 00 00 00    	je     f0103bfd <vprintfmt+0x23f>
				for (width -= strnlen(p, precision); width > 0; width--)
f0103b65:	83 ec 08             	sub    $0x8,%esp
f0103b68:	ff 75 d0             	pushl  -0x30(%ebp)
f0103b6b:	57                   	push   %edi
f0103b6c:	e8 0c 04 00 00       	call   f0103f7d <strnlen>
f0103b71:	8b 4d e0             	mov    -0x20(%ebp),%ecx
f0103b74:	29 c1                	sub    %eax,%ecx
f0103b76:	89 4d c8             	mov    %ecx,-0x38(%ebp)
f0103b79:	83 c4 10             	add    $0x10,%esp
					putch(padc, putdat);
f0103b7c:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
f0103b80:	89 45 e0             	mov    %eax,-0x20(%ebp)
f0103b83:	89 7d d4             	mov    %edi,-0x2c(%ebp)
f0103b86:	89 cf                	mov    %ecx,%edi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f0103b88:	eb 0f                	jmp    f0103b99 <vprintfmt+0x1db>
					putch(padc, putdat);
f0103b8a:	83 ec 08             	sub    $0x8,%esp
f0103b8d:	53                   	push   %ebx
f0103b8e:	ff 75 e0             	pushl  -0x20(%ebp)
f0103b91:	ff d6                	call   *%esi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f0103b93:	83 ef 01             	sub    $0x1,%edi
f0103b96:	83 c4 10             	add    $0x10,%esp
f0103b99:	85 ff                	test   %edi,%edi
f0103b9b:	7f ed                	jg     f0103b8a <vprintfmt+0x1cc>
f0103b9d:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f0103ba0:	8b 4d c8             	mov    -0x38(%ebp),%ecx
f0103ba3:	85 c9                	test   %ecx,%ecx
f0103ba5:	b8 00 00 00 00       	mov    $0x0,%eax
f0103baa:	0f 49 c1             	cmovns %ecx,%eax
f0103bad:	29 c1                	sub    %eax,%ecx
f0103baf:	89 75 08             	mov    %esi,0x8(%ebp)
f0103bb2:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0103bb5:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0103bb8:	89 cb                	mov    %ecx,%ebx
f0103bba:	eb 4d                	jmp    f0103c09 <vprintfmt+0x24b>
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
f0103bbc:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
f0103bc0:	74 1b                	je     f0103bdd <vprintfmt+0x21f>
f0103bc2:	0f be c0             	movsbl %al,%eax
f0103bc5:	83 e8 20             	sub    $0x20,%eax
f0103bc8:	83 f8 5e             	cmp    $0x5e,%eax
f0103bcb:	76 10                	jbe    f0103bdd <vprintfmt+0x21f>
					putch('?', putdat);
f0103bcd:	83 ec 08             	sub    $0x8,%esp
f0103bd0:	ff 75 0c             	pushl  0xc(%ebp)
f0103bd3:	6a 3f                	push   $0x3f
f0103bd5:	ff 55 08             	call   *0x8(%ebp)
f0103bd8:	83 c4 10             	add    $0x10,%esp
f0103bdb:	eb 0d                	jmp    f0103bea <vprintfmt+0x22c>
				else
					putch(ch, putdat);
f0103bdd:	83 ec 08             	sub    $0x8,%esp
f0103be0:	ff 75 0c             	pushl  0xc(%ebp)
f0103be3:	52                   	push   %edx
f0103be4:	ff 55 08             	call   *0x8(%ebp)
f0103be7:	83 c4 10             	add    $0x10,%esp
			...
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
f0103bea:	83 eb 01             	sub    $0x1,%ebx
f0103bed:	eb 1a                	jmp    f0103c09 <vprintfmt+0x24b>
f0103bef:	89 75 08             	mov    %esi,0x8(%ebp)
f0103bf2:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0103bf5:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0103bf8:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f0103bfb:	eb 0c                	jmp    f0103c09 <vprintfmt+0x24b>
f0103bfd:	89 75 08             	mov    %esi,0x8(%ebp)
f0103c00:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0103c03:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0103c06:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f0103c09:	83 c7 01             	add    $0x1,%edi
f0103c0c:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
f0103c10:	0f be d0             	movsbl %al,%edx
f0103c13:	85 d2                	test   %edx,%edx
f0103c15:	74 23                	je     f0103c3a <vprintfmt+0x27c>
f0103c17:	85 f6                	test   %esi,%esi
f0103c19:	78 a1                	js     f0103bbc <vprintfmt+0x1fe>
f0103c1b:	83 ee 01             	sub    $0x1,%esi
f0103c1e:	79 9c                	jns    f0103bbc <vprintfmt+0x1fe>
f0103c20:	89 df                	mov    %ebx,%edi
f0103c22:	8b 75 08             	mov    0x8(%ebp),%esi
f0103c25:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0103c28:	eb 18                	jmp    f0103c42 <vprintfmt+0x284>
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
...
f0103c2d:	53                   	push   %ebx
f0103c2e:	6a 20                	push   $0x20
f0103c30:	ff d6                	call   *%esi
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
			for (; width > 0; width--)
f0103c32:	83 ef 01             	sub    $0x1,%edi
f0103c35:	83 c4 10             	add    $0x10,%esp
f0103c38:	eb 08                	jmp    f0103c42 <vprintfmt+0x284>
f0103c3a:	89 df                	mov    %ebx,%edi
f0103c3c:	8b 75 08             	mov    0x8(%ebp),%esi
f0103c3f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0103c42:	85 ff                	test   %edi,%edi
f0103c44:	7f e4                	jg     f0103c2a <vprintfmt+0x26c>
				printfmt(putch, putdat, "%s", p);
			break;
		...
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
f0103c46:	8b 45 cc             	mov    -0x34(%ebp),%eax
...
f0103c4f:	e9 90 fd ff ff       	jmp    f01039e4 <vprintfmt+0x26>
...
{
	if (lflag >= 2)
f0103c54:	83 f9 01             	cmp    $0x1,%ecx
f0103c57:	7e 19                	jle    f0103c72 <vprintfmt+0x2b4>
		return va_arg(*ap, long long);
f0103c59:	8b 45 14             	mov    0x14(%ebp),%eax
f0103c5c:	8b 50 04             	mov    0x4(%eax),%edx
f0103c5f:	8b 00                	mov    (%eax),%eax
f0103c61:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0103c64:	89 55 dc             	mov    %edx,-0x24(%ebp)
f0103c67:	8b 45 14             	mov    0x14(%ebp),%eax
f0103c6a:	8d 40 08             	lea    0x8(%eax),%eax
f0103c6d:	89 45 14             	mov    %eax,0x14(%ebp)
f0103c70:	eb 38                	jmp    f0103caa <vprintfmt+0x2ec>
	else if (lflag)
f0103c72:	85 c9                	test   %ecx,%ecx
f0103c74:	74 1b                	je     f0103c91 <vprintfmt+0x2d3>
		return va_arg(*ap, long);
f0103c76:	8b 45 14             	mov    0x14(%ebp),%eax
f0103c79:	8b 00                	mov    (%eax),%eax
f0103c7b:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0103c7e:	89 c1                	mov    %eax,%ecx
f0103c80:	c1 f9 1f             	sar    $0x1f,%ecx
f0103c83:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f0103c86:	8b 45 14             	mov    0x14(%ebp),%eax
f0103c89:	8d 40 04             	lea    0x4(%eax),%eax
f0103c8c:	89 45 14             	mov    %eax,0x14(%ebp)
f0103c8f:	eb 19                	jmp    f0103caa <vprintfmt+0x2ec>
	else
		return va_arg(*ap, int);
f0103c91:	8b 45 14             	mov    0x14(%ebp),%eax
f0103c94:	8b 00                	mov    (%eax),%eax
f0103c96:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0103c99:	89 c1                	mov    %eax,%ecx
f0103c9b:	c1 f9 1f             	sar    $0x1f,%ecx
f0103c9e:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f0103ca1:	8b 45 14             	mov    0x14(%ebp),%eax
f0103ca4:	8d 40 04             	lea    0x4(%eax),%eax
f0103ca7:	89 45 14             	mov    %eax,0x14(%ebp)
				putch(' ', putdat);
			break;
...
f0103cad:	8b 4d dc             	mov    -0x24(%ebp),%ecx
			...
			base = 10;
f0103cb0:	b8 0a 00 00 00       	mov    $0xa,%eax
			break;
		...
		case 'd':
			num = getint(&ap, lflag);
			if ((long long) num < 0) {
f0103cb5:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
f0103cb9:	0f 89 0e 01 00 00    	jns    f0103dcd <vprintfmt+0x40f>
				putch('-', putdat);
f0103cbf:	83 ec 08             	sub    $0x8,%esp
f0103cc2:	53                   	push   %ebx
f0103cc3:	6a 2d                	push   $0x2d
f0103cc5:	ff d6                	call   *%esi
				num = -(long long) num;
f0103cc7:	8b 55 d8             	mov    -0x28(%ebp),%edx
f0103cca:	8b 4d dc             	mov    -0x24(%ebp),%ecx
f0103ccd:	f7 da                	neg    %edx
f0103ccf:	83 d1 00             	adc    $0x0,%ecx
f0103cd2:	f7 d9                	neg    %ecx
f0103cd4:	83 c4 10             	add    $0x10,%esp
			}
			base = 10;
f0103cd7:	b8 0a 00 00 00       	mov    $0xa,%eax
f0103cdc:	e9 ec 00 00 00       	jmp    f0103dcd <vprintfmt+0x40f>
...
{
	if (lflag >= 2)
f0103ce1:	83 f9 01             	cmp    $0x1,%ecx
f0103ce4:	7e 18                	jle    f0103cfe <vprintfmt+0x340>
		return va_arg(*ap, unsigned long long);
f0103ce6:	8b 45 14             	mov    0x14(%ebp),%eax
f0103ce9:	8b 10                	mov    (%eax),%edx
f0103ceb:	8b 48 04             	mov    0x4(%eax),%ecx
f0103cee:	8d 40 08             	lea    0x8(%eax),%eax
f0103cf1:	89 45 14             	mov    %eax,0x14(%ebp)
			goto number;
		...
		case 'u':
			...
			base = 10;
f0103cf4:	b8 0a 00 00 00       	mov    $0xa,%eax
f0103cf9:	e9 cf 00 00 00       	jmp    f0103dcd <vprintfmt+0x40f>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
...
f0103cfe:	85 c9                	test   %ecx,%ecx
f0103d00:	74 1a                	je     f0103d1c <vprintfmt+0x35e>
		return va_arg(*ap, unsigned long);
f0103d02:	8b 45 14             	mov    0x14(%ebp),%eax
f0103d05:	8b 10                	mov    (%eax),%edx
f0103d07:	b9 00 00 00 00       	mov    $0x0,%ecx
f0103d0c:	8d 40 04             	lea    0x4(%eax),%eax
f0103d0f:	89 45 14             	mov    %eax,0x14(%ebp)
			goto number;
		...
		case 'u':
			num = getuint(&ap, lflag);
			base = 10;
f0103d12:	b8 0a 00 00 00       	mov    $0xa,%eax
f0103d17:	e9 b1 00 00 00       	jmp    f0103dcd <vprintfmt+0x40f>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
...
f0103d21:	b9 00 00 00 00       	mov    $0x0,%ecx
f0103d26:	8d 40 04             	lea    0x4(%eax),%eax
f0103d29:	89 45 14             	mov    %eax,0x14(%ebp)
			goto number;
		...
		case 'u':
			num = getuint(&ap, lflag);
			base = 10;
f0103d2c:	b8 0a 00 00 00       	mov    $0xa,%eax
f0103d31:	e9 97 00 00 00       	jmp    f0103dcd <vprintfmt+0x40f>
			goto number;
		...
		case 'o':
			...
			putch('X', putdat);
f0103d36:	83 ec 08             	sub    $0x8,%esp
f0103d39:	53                   	push   %ebx
f0103d3a:	6a 58                	push   $0x58
f0103d3c:	ff d6                	call   *%esi
			putch('X', putdat);
f0103d3e:	83 c4 08             	add    $0x8,%esp
f0103d41:	53                   	push   %ebx
f0103d42:	6a 58                	push   $0x58
f0103d44:	ff d6                	call   *%esi
			putch('X', putdat);
f0103d46:	83 c4 08             	add    $0x8,%esp
f0103d49:	53                   	push   %ebx
f0103d4a:	6a 58                	push   $0x58
f0103d4c:	ff d6                	call   *%esi
			break;
f0103d4e:	83 c4 10             	add    $0x10,%esp
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103d51:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'o':
			// Replace this with your code.
			putch('X', putdat);
			putch('X', putdat);
			putch('X', putdat);
			break;
f0103d54:	e9 8b fc ff ff       	jmp    f01039e4 <vprintfmt+0x26>
...
f0103d5d:	6a 30                	push   $0x30
f0103d5f:	ff d6                	call   *%esi
			putch('x', putdat);
f0103d61:	83 c4 08             	add    $0x8,%esp
f0103d64:	53                   	push   %ebx
f0103d65:	6a 78                	push   $0x78
f0103d67:	ff d6                	call   *%esi
			num = (unsigned long long)
f0103d69:	8b 45 14             	mov    0x14(%ebp),%eax
f0103d6c:	8b 10                	mov    (%eax),%edx
f0103d6e:	b9 00 00 00 00       	mov    $0x0,%ecx
...
f0103d73:	83 c4 10             	add    $0x10,%esp
		...
		case 'p':
			...
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
f0103d76:	8d 40 04             	lea    0x4(%eax),%eax
f0103d79:	89 45 14             	mov    %eax,0x14(%ebp)
			base = 16;
f0103d7c:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
f0103d81:	eb 4a                	jmp    f0103dcd <vprintfmt+0x40f>
// Get an unsigned int of various possible sizes from a varargs list,
// depending on the lflag parameter.
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
f0103d83:	83 f9 01             	cmp    $0x1,%ecx
f0103d86:	7e 15                	jle    f0103d9d <vprintfmt+0x3df>
		return va_arg(*ap, unsigned long long);
f0103d88:	8b 45 14             	mov    0x14(%ebp),%eax
f0103d8b:	8b 10                	mov    (%eax),%edx
f0103d8d:	8b 48 04             	mov    0x4(%eax),%ecx
f0103d90:	8d 40 08             	lea    0x8(%eax),%eax
f0103d93:	89 45 14             	mov    %eax,0x14(%ebp)
		...
		case 'x':
			num = getuint(&ap, lflag);
			base = 16;
f0103d96:	b8 10 00 00 00       	mov    $0x10,%eax
f0103d9b:	eb 30                	jmp    f0103dcd <vprintfmt+0x40f>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
...
f0103d9f:	74 17                	je     f0103db8 <vprintfmt+0x3fa>
		return va_arg(*ap, unsigned long);
f0103da1:	8b 45 14             	mov    0x14(%ebp),%eax
f0103da4:	8b 10                	mov    (%eax),%edx
f0103da6:	b9 00 00 00 00       	mov    $0x0,%ecx
...
f0103db6:	eb 15                	jmp    f0103dcd <vprintfmt+0x40f>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
...
f0103dbd:	b9 00 00 00 00       	mov    $0x0,%ecx
...
f0103dc5:	89 45 14             	mov    %eax,0x14(%ebp)
		...
		case 'x':
			num = getuint(&ap, lflag);
			base = 16;
f0103dc8:	b8 10 00 00 00       	mov    $0x10,%eax
		number:
			printnum(putch, putdat, num, base, width, padc);
f0103dcd:	83 ec 0c             	sub    $0xc,%esp
f0103dd0:	0f be 7d d4          	movsbl -0x2c(%ebp),%edi
f0103dd4:	57                   	push   %edi
f0103dd5:	ff 75 e0             	pushl  -0x20(%ebp)
f0103dd8:	50                   	push   %eax
f0103dd9:	51                   	push   %ecx
f0103dda:	52                   	push   %edx
f0103ddb:	89 da                	mov    %ebx,%edx
f0103ddd:	89 f0                	mov    %esi,%eax
f0103ddf:	e8 f1 fa ff ff       	call   f01038d5 <printnum>
			break;
f0103de4:	83 c4 20             	add    $0x20,%esp
f0103de7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103dea:	e9 f5 fb ff ff       	jmp    f01039e4 <vprintfmt+0x26>

		// escaped '%' character
		case '%':
			putch(ch, putdat);
f0103def:	83 ec 08             	sub    $0x8,%esp
f0103df2:	53                   	push   %ebx
f0103df3:	52                   	push   %edx
f0103df4:	ff d6                	call   *%esi
			break;
...
f0103df9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
f0103dfc:	e9 e3 fb ff ff       	jmp    f01039e4 <vprintfmt+0x26>
...
f0103e05:	6a 25                	push   $0x25
f0103e07:	ff d6                	call   *%esi
			for (fmt--; fmt[-1] != '%'; fmt--)
f0103e09:	83 c4 10             	add    $0x10,%esp
f0103e0c:	eb 03                	jmp    f0103e11 <vprintfmt+0x453>
f0103e0e:	83 ef 01             	sub    $0x1,%edi
f0103e11:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
f0103e15:	75 f7                	jne    f0103e0e <vprintfmt+0x450>
f0103e17:	e9 c8 fb ff ff       	jmp    f01039e4 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
}
f0103e1c:	8d 65 f4             	lea    -0xc(%ebp),%esp
f0103e1f:	5b                   	pop    %ebx
f0103e20:	5e                   	pop    %esi
f0103e21:	5f                   	pop    %edi
f0103e22:	5d                   	pop    %ebp
...
f0103e30:	89 45 ec             	mov    %eax,-0x14(%ebp)
f0103e33:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
f0103e37:	89 4d f0             	mov    %ecx,-0x10(%ebp)
f0103e3a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
f0103e41:	85 c0                	test   %eax,%eax
f0103e43:	74 26                	je     f0103e6b <vsnprintf+0x47>
f0103e45:	85 d2                	test   %edx,%edx
f0103e47:	7e 22                	jle    f0103e6b <vsnprintf+0x47>
		return -E_INVAL;

	// print the string to the buffer
	vprintfmt((void*)sprintputch, &b, fmt, ap);
f0103e49:	ff 75 14             	pushl  0x14(%ebp)
f0103e4c:	ff 75 10             	pushl  0x10(%ebp)
f0103e4f:	8d 45 ec             	lea    -0x14(%ebp),%eax
f0103e52:	50                   	push   %eax
f0103e53:	68 84 39 10 f0       	push   $0xf0103984
f0103e58:	e8 61 fb ff ff       	call   f01039be <vprintfmt>

	// null terminate the buffer
	*b.buf = '\0';
f0103e5d:	8b 45 ec             	mov    -0x14(%ebp),%eax
f0103e60:	c6 00 00             	movb   $0x0,(%eax)

	return b.cnt;
f0103e63:	8b 45 f4             	mov    -0xc(%ebp),%eax
f0103e66:	83 c4 10             	add    $0x10,%esp
f0103e69:	eb 05                	jmp    f0103e70 <vsnprintf+0x4c>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
	...
	if (buf == NULL || n < 1)
		return -E_INVAL;
f0103e6b:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
...
f0103e75:	83 ec 08             	sub    $0x8,%esp
	...
	va_start(ap, fmt);
f0103e78:	8d 45 14             	lea    0x14(%ebp),%eax
	rc = vsnprintf(buf, n, fmt, ap);
f0103e7b:	50                   	push   %eax
f0103e7c:	ff 75 10             	pushl  0x10(%ebp)
f0103e7f:	ff 75 0c             	pushl  0xc(%ebp)
f0103e82:	ff 75 08             	pushl  0x8(%ebp)
f0103e85:	e8 9a ff ff ff       	call   f0103e24 <vsnprintf>
	va_end(ap);
...
f0103e95:	8b 45 08             	mov    0x8(%ebp),%eax
	...
	if (prompt != NULL)
f0103e98:	85 c0                	test   %eax,%eax
f0103e9a:	74 11                	je     f0103ead <readline+0x21>
		cprintf("%s", prompt);
f0103e9c:	83 ec 08             	sub    $0x8,%esp
f0103e9f:	50                   	push   %eax
f0103ea0:	68 64 4a 10 f0       	push   $0xf0104a64
f0103ea5:	e8 86 ef ff ff       	call   f0102e30 <cprintf>
f0103eaa:	83 c4 10             	add    $0x10,%esp

	i = 0;
	echoing = iscons(0);
f0103ead:	83 ec 0c             	sub    $0xc,%esp
f0103eb0:	6a 00                	push   $0x0
f0103eb2:	e8 7f c7 ff ff       	call   f0100636 <iscons>
f0103eb7:	89 c7                	mov    %eax,%edi
f0103eb9:	83 c4 10             	add    $0x10,%esp
	...
	i = 0;
f0103ebc:	be 00 00 00 00       	mov    $0x0,%esi
	echoing = iscons(0);
	while (1) {
		c = getchar();
f0103ec1:	e8 5f c7 ff ff       	call   f0100625 <getchar>
f0103ec6:	89 c3                	mov    %eax,%ebx
		if (c < 0) {
f0103ec8:	85 c0                	test   %eax,%eax
f0103eca:	79 18                	jns    f0103ee4 <readline+0x58>
			cprintf("read error: %e\n", c);
f0103ecc:	83 ec 08             	sub    $0x8,%esp
f0103ecf:	50                   	push   %eax
f0103ed0:	68 e0 5b 10 f0       	push   $0xf0105be0
f0103ed5:	e8 56 ef ff ff       	call   f0102e30 <cprintf>
			return NULL;
f0103eda:	83 c4 10             	add    $0x10,%esp
f0103edd:	b8 00 00 00 00       	mov    $0x0,%eax
f0103ee2:	eb 79                	jmp    f0103f5d <readline+0xd1>
		} else if ((c == '\b' || c == '\x7f') && i > 0) {
f0103ee4:	83 f8 08             	cmp    $0x8,%eax
f0103ee7:	0f 94 c2             	sete   %dl
f0103eea:	83 f8 7f             	cmp    $0x7f,%eax
f0103eed:	0f 94 c0             	sete   %al
f0103ef0:	08 c2                	or     %al,%dl
f0103ef2:	74 1a                	je     f0103f0e <readline+0x82>
f0103ef4:	85 f6                	test   %esi,%esi
f0103ef6:	7e 16                	jle    f0103f0e <readline+0x82>
			if (echoing)
f0103ef8:	85 ff                	test   %edi,%edi
f0103efa:	74 0d                	je     f0103f09 <readline+0x7d>
				cputchar('\b');
f0103efc:	83 ec 0c             	sub    $0xc,%esp
f0103eff:	6a 08                	push   $0x8
f0103f01:	e8 0f c7 ff ff       	call   f0100615 <cputchar>
f0103f06:	83 c4 10             	add    $0x10,%esp
			i--;
f0103f09:	83 ee 01             	sub    $0x1,%esi
f0103f0c:	eb b3                	jmp    f0103ec1 <readline+0x35>
		} else if (c >= ' ' && i < BUFLEN-1) {
f0103f0e:	83 fb 1f             	cmp    $0x1f,%ebx
f0103f11:	7e 23                	jle    f0103f36 <readline+0xaa>
f0103f13:	81 fe fe 03 00 00    	cmp    $0x3fe,%esi
f0103f19:	7f 1b                	jg     f0103f36 <readline+0xaa>
			if (echoing)
f0103f1b:	85 ff                	test   %edi,%edi
f0103f1d:	74 0c                	je     f0103f2b <readline+0x9f>
				cputchar(c);
f0103f1f:	83 ec 0c             	sub    $0xc,%esp
f0103f22:	53                   	push   %ebx
f0103f23:	e8 ed c6 ff ff       	call   f0100615 <cputchar>
f0103f28:	83 c4 10             	add    $0x10,%esp
			buf[i++] = c;
f0103f2b:	88 9e c0 c8 17 f0    	mov    %bl,-0xfe83740(%esi)
f0103f31:	8d 76 01             	lea    0x1(%esi),%esi
f0103f34:	eb 8b                	jmp    f0103ec1 <readline+0x35>
		} else if (c == '\n' || c == '\r') {
f0103f36:	83 fb 0a             	cmp    $0xa,%ebx
f0103f39:	74 05                	je     f0103f40 <readline+0xb4>
f0103f3b:	83 fb 0d             	cmp    $0xd,%ebx
f0103f3e:	75 81                	jne    f0103ec1 <readline+0x35>
			if (echoing)
f0103f40:	85 ff                	test   %edi,%edi
f0103f42:	74 0d                	je     f0103f51 <readline+0xc5>
				cputchar('\n');
f0103f44:	83 ec 0c             	sub    $0xc,%esp
f0103f47:	6a 0a                	push   $0xa
f0103f49:	e8 c7 c6 ff ff       	call   f0100615 <cputchar>
f0103f4e:	83 c4 10             	add    $0x10,%esp
			buf[i] = 0;
f0103f51:	c6 86 c0 c8 17 f0 00 	movb   $0x0,-0xfe83740(%esi)
			return buf;
f0103f58:	b8 c0 c8 17 f0       	mov    $0xf017c8c0,%eax
		}
	}
}
f0103f5d:	8d 65 f4             	lea    -0xc(%ebp),%esp
f0103f60:	5b                   	pop    %ebx
f0103f61:	5e                   	pop    %esi
f0103f62:	5f                   	pop    %edi
f0103f63:	5d                   	pop    %ebp
...
f0103f68:	8b 55 08             	mov    0x8(%ebp),%edx
	int n;

	for (n = 0; *s != '\0'; s++)
f0103f6b:	b8 00 00 00 00       	mov    $0x0,%eax
f0103f70:	eb 03                	jmp    f0103f75 <strlen+0x10>
		n++;
...
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
f0103f75:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
f0103f79:	75 f7                	jne    f0103f72 <strlen+0xd>
		n++;
	return n;
}
f0103f7b:	5d                   	pop    %ebp
...
f0103f80:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0103f83:	8b 45 0c             	mov    0xc(%ebp),%eax
	int n;

	for (n = 0; size > 0 && *s != '\0'; s++, size--)
f0103f86:	ba 00 00 00 00       	mov    $0x0,%edx
f0103f8b:	eb 03                	jmp    f0103f90 <strnlen+0x13>
		n++;
...
f0103f92:	74 08                	je     f0103f9c <strnlen+0x1f>
f0103f94:	80 3c 11 00          	cmpb   $0x0,(%ecx,%edx,1)
f0103f98:	75 f3                	jne    f0103f8d <strnlen+0x10>
...
{
f0103f9e:	55                   	push   %ebp
f0103f9f:	89 e5                	mov    %esp,%ebp
...
f0103fa5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	...
	ret = dst;
	while ((*dst++ = *src++) != '\0')
f0103fa8:	89 c2                	mov    %eax,%edx
f0103faa:	83 c2 01             	add    $0x1,%edx
f0103fad:	83 c1 01             	add    $0x1,%ecx
f0103fb0:	0f b6 59 ff          	movzbl -0x1(%ecx),%ebx
f0103fb4:	88 5a ff             	mov    %bl,-0x1(%edx)
f0103fb7:	84 db                	test   %bl,%bl
f0103fb9:	75 ef                	jne    f0103faa <strcpy+0xc>
		/* do nothing */;
	return ret;
}
f0103fbb:	5b                   	pop    %ebx
...
f0103fc1:	53                   	push   %ebx
f0103fc2:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int len = strlen(dst);
f0103fc5:	53                   	push   %ebx
f0103fc6:	e8 9a ff ff ff       	call   f0103f65 <strlen>
f0103fcb:	83 c4 04             	add    $0x4,%esp
	strcpy(dst + len, src);
f0103fce:	ff 75 0c             	pushl  0xc(%ebp)
f0103fd1:	01 d8                	add    %ebx,%eax
f0103fd3:	50                   	push   %eax
f0103fd4:	e8 c5 ff ff ff       	call   f0103f9e <strcpy>
	return dst;
}
f0103fd9:	89 d8                	mov    %ebx,%eax
f0103fdb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0103fde:	c9                   	leave  
f0103fdf:	c3                   	ret    
...
f0103fe5:	8b 75 08             	mov    0x8(%ebp),%esi
f0103fe8:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0103feb:	89 f3                	mov    %esi,%ebx
f0103fed:	03 5d 10             	add    0x10(%ebp),%ebx
	size_t i;
	char *ret;
...
f0103ff2:	eb 0f                	jmp    f0104003 <strncpy+0x23>
		*dst++ = *src;
f0103ff4:	83 c2 01             	add    $0x1,%edx
f0103ff7:	0f b6 01             	movzbl (%ecx),%eax
f0103ffa:	88 42 ff             	mov    %al,-0x1(%edx)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
f0103ffd:	80 39 01             	cmpb   $0x1,(%ecx)
f0104000:	83 d9 ff             	sbb    $0xffffffff,%ecx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	ret = dst;
	for (i = 0; i < size; i++) {
f0104003:	39 da                	cmp    %ebx,%edx
f0104005:	75 ed                	jne    f0103ff4 <strncpy+0x14>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
f0104012:	8b 75 08             	mov    0x8(%ebp),%esi
f0104015:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0104018:	8b 55 10             	mov    0x10(%ebp),%edx
f010401b:	89 f0                	mov    %esi,%eax
	char *dst_in;

	dst_in = dst;
	if (size > 0) {
f010401d:	85 d2                	test   %edx,%edx
f010401f:	74 21                	je     f0104042 <strlcpy+0x35>
f0104021:	8d 44 16 ff          	lea    -0x1(%esi,%edx,1),%eax
f0104025:	89 f2                	mov    %esi,%edx
f0104027:	eb 09                	jmp    f0104032 <strlcpy+0x25>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
f0104029:	83 c2 01             	add    $0x1,%edx
f010402c:	83 c1 01             	add    $0x1,%ecx
f010402f:	88 5a ff             	mov    %bl,-0x1(%edx)
{
	char *dst_in;
	...
	if (size > 0) {
		while (--size > 0 && *src != '\0')
f0104032:	39 c2                	cmp    %eax,%edx
f0104034:	74 09                	je     f010403f <strlcpy+0x32>
f0104036:	0f b6 19             	movzbl (%ecx),%ebx
f0104039:	84 db                	test   %bl,%bl
f010403b:	75 ec                	jne    f0104029 <strlcpy+0x1c>
f010403d:	89 d0                	mov    %edx,%eax
			*dst++ = *src++;
		*dst = '\0';
f010403f:	c6 00 00             	movb   $0x0,(%eax)
	}
	return dst - dst_in;
f0104042:	29 f0                	sub    %esi,%eax
}
f0104044:	5b                   	pop    %ebx
f0104045:	5e                   	pop    %esi
f0104046:	5d                   	pop    %ebp
...
f010404b:	8b 4d 08             	mov    0x8(%ebp),%ecx
f010404e:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
f0104051:	eb 06                	jmp    f0104059 <strcmp+0x11>
		p++, q++;
f0104053:	83 c1 01             	add    $0x1,%ecx
...
{
	while (*p && *p == *q)
f0104059:	0f b6 01             	movzbl (%ecx),%eax
f010405c:	84 c0                	test   %al,%al
f010405e:	74 04                	je     f0104064 <strcmp+0x1c>
f0104060:	3a 02                	cmp    (%edx),%al
f0104062:	74 ef                	je     f0104053 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
f0104064:	0f b6 c0             	movzbl %al,%eax
f0104067:	0f b6 12             	movzbl (%edx),%edx
f010406a:	29 d0                	sub    %edx,%eax
}
f010406c:	5d                   	pop    %ebp
f010406d:	c3                   	ret    
...
f0104075:	8b 55 0c             	mov    0xc(%ebp),%edx
f0104078:	89 c3                	mov    %eax,%ebx
f010407a:	03 5d 10             	add    0x10(%ebp),%ebx
	while (n > 0 && *p && *p == *q)
f010407d:	eb 06                	jmp    f0104085 <strncmp+0x17>
		n--, p++, q++;
f010407f:	83 c0 01             	add    $0x1,%eax
f0104082:	83 c2 01             	add    $0x1,%edx
}
...
{
	while (n > 0 && *p && *p == *q)
f0104085:	39 d8                	cmp    %ebx,%eax
f0104087:	74 15                	je     f010409e <strncmp+0x30>
f0104089:	0f b6 08             	movzbl (%eax),%ecx
f010408c:	84 c9                	test   %cl,%cl
f010408e:	74 04                	je     f0104094 <strncmp+0x26>
f0104090:	3a 0a                	cmp    (%edx),%cl
f0104092:	74 eb                	je     f010407f <strncmp+0x11>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
f0104094:	0f b6 00             	movzbl (%eax),%eax
f0104097:	0f b6 12             	movzbl (%edx),%edx
f010409a:	29 d0                	sub    %edx,%eax
f010409c:	eb 05                	jmp    f01040a3 <strncmp+0x35>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
f01040ac:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f01040b0:	eb 07                	jmp    f01040b9 <strchr+0x13>
		if (*s == c)
f01040b2:	38 ca                	cmp    %cl,%dl
f01040b4:	74 0f                	je     f01040c5 <strchr+0x1f>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
{
	for (; *s; s++)
f01040b6:	83 c0 01             	add    $0x1,%eax
f01040b9:	0f b6 10             	movzbl (%eax),%edx
f01040bc:	84 d2                	test   %dl,%dl
f01040be:	75 f2                	jne    f01040b2 <strchr+0xc>
		if (*s == c)
			return (char *) s;
	return 0;
...
f01040cd:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f01040d1:	eb 03                	jmp    f01040d6 <strfind+0xf>
f01040d3:	83 c0 01             	add    $0x1,%eax
f01040d6:	0f b6 10             	movzbl (%eax),%edx
		if (*s == c)
f01040d9:	38 ca                	cmp    %cl,%dl
f01040db:	74 04                	je     f01040e1 <strfind+0x1a>
f01040dd:	84 d2                	test   %dl,%dl
f01040df:	75 f2                	jne    f01040d3 <strfind+0xc>
			break;
	return (char *) s;
}
f01040e1:	5d                   	pop    %ebp
...
f01040e8:	53                   	push   %ebx
f01040e9:	8b 7d 08             	mov    0x8(%ebp),%edi
f01040ec:	8b 4d 10             	mov    0x10(%ebp),%ecx
	char *p;

	if (n == 0)
f01040ef:	85 c9                	test   %ecx,%ecx
f01040f1:	74 36                	je     f0104129 <memset+0x46>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
f01040f3:	f7 c7 03 00 00 00    	test   $0x3,%edi
f01040f9:	75 28                	jne    f0104123 <memset+0x40>
f01040fb:	f6 c1 03             	test   $0x3,%cl
f01040fe:	75 23                	jne    f0104123 <memset+0x40>
		c &= 0xFF;
f0104100:	0f b6 55 0c          	movzbl 0xc(%ebp),%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
f0104104:	89 d3                	mov    %edx,%ebx
f0104106:	c1 e3 08             	shl    $0x8,%ebx
f0104109:	89 d6                	mov    %edx,%esi
f010410b:	c1 e6 18             	shl    $0x18,%esi
f010410e:	89 d0                	mov    %edx,%eax
f0104110:	c1 e0 10             	shl    $0x10,%eax
f0104113:	09 f0                	or     %esi,%eax
f0104115:	09 c2                	or     %eax,%edx
		asm volatile("cld; rep stosl\n"
f0104117:	89 d8                	mov    %ebx,%eax
f0104119:	09 d0                	or     %edx,%eax
f010411b:	c1 e9 02             	shr    $0x2,%ecx
f010411e:	fc                   	cld    
f010411f:	f3 ab                	rep stos %eax,%es:(%edi)
f0104121:	eb 06                	jmp    f0104129 <memset+0x46>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
...
f0104126:	fc                   	cld    
f0104127:	f3 aa                	rep stos %al,%es:(%edi)
			:: "D" (v), "a" (c), "c" (n)
			: "cc", "memory");
	return v;
}
...
f0104138:	8b 75 0c             	mov    0xc(%ebp),%esi
f010413b:	8b 4d 10             	mov    0x10(%ebp),%ecx
	...
	d = dst;
	if (s < d && s + n > d) {
f010413e:	39 c6                	cmp    %eax,%esi
f0104140:	73 35                	jae    f0104177 <memmove+0x47>
f0104142:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
f0104145:	39 d0                	cmp    %edx,%eax
f0104147:	73 2e                	jae    f0104177 <memmove+0x47>
		s += n;
		d += n;
f0104149:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f010414c:	89 d6                	mov    %edx,%esi
f010414e:	09 fe                	or     %edi,%esi
f0104150:	f7 c6 03 00 00 00    	test   $0x3,%esi
f0104156:	75 13                	jne    f010416b <memmove+0x3b>
f0104158:	f6 c1 03             	test   $0x3,%cl
f010415b:	75 0e                	jne    f010416b <memmove+0x3b>
			asm volatile("std; rep movsl\n"
f010415d:	83 ef 04             	sub    $0x4,%edi
f0104160:	8d 72 fc             	lea    -0x4(%edx),%esi
f0104163:	c1 e9 02             	shr    $0x2,%ecx
f0104166:	fd                   	std    
f0104167:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f0104169:	eb 09                	jmp    f0104174 <memmove+0x44>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
f010416b:	83 ef 01             	sub    $0x1,%edi
f010416e:	8d 72 ff             	lea    -0x1(%edx),%esi
f0104171:	fd                   	std    
f0104172:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
f0104174:	fc                   	cld    
f0104175:	eb 1d                	jmp    f0104194 <memmove+0x64>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f0104177:	89 f2                	mov    %esi,%edx
f0104179:	09 c2                	or     %eax,%edx
f010417b:	f6 c2 03             	test   $0x3,%dl
f010417e:	75 0f                	jne    f010418f <memmove+0x5f>
f0104180:	f6 c1 03             	test   $0x3,%cl
f0104183:	75 0a                	jne    f010418f <memmove+0x5f>
			asm volatile("cld; rep movsl\n"
f0104185:	c1 e9 02             	shr    $0x2,%ecx
f0104188:	89 c7                	mov    %eax,%edi
f010418a:	fc                   	cld    
f010418b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f010418d:	eb 05                	jmp    f0104194 <memmove+0x64>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
			asm volatile("cld; rep movsb\n"
f010418f:	89 c7                	mov    %eax,%edi
f0104191:	fc                   	cld    
f0104192:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
...
f010419b:	ff 75 10             	pushl  0x10(%ebp)
f010419e:	ff 75 0c             	pushl  0xc(%ebp)
f01041a1:	ff 75 08             	pushl  0x8(%ebp)
f01041a4:	e8 87 ff ff ff       	call   f0104130 <memmove>
}
f01041a9:	c9                   	leave  
f01041aa:	c3                   	ret    
...
f01041b3:	8b 55 0c             	mov    0xc(%ebp),%edx
f01041b6:	89 c6                	mov    %eax,%esi
f01041b8:	03 75 10             	add    0x10(%ebp),%esi
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;

	while (n-- > 0) {
f01041bb:	eb 1a                	jmp    f01041d7 <memcmp+0x2c>
		if (*s1 != *s2)
f01041bd:	0f b6 08             	movzbl (%eax),%ecx
f01041c0:	0f b6 1a             	movzbl (%edx),%ebx
f01041c3:	38 d9                	cmp    %bl,%cl
f01041c5:	74 0a                	je     f01041d1 <memcmp+0x26>
			return (int) *s1 - (int) *s2;
f01041c7:	0f b6 c1             	movzbl %cl,%eax
f01041ca:	0f b6 db             	movzbl %bl,%ebx
f01041cd:	29 d8                	sub    %ebx,%eax
f01041cf:	eb 0f                	jmp    f01041e0 <memcmp+0x35>
		s1++, s2++;
...
memcmp(const void *v1, const void *v2, size_t n)
{
	...
	while (n-- > 0) {
f01041d7:	39 f0                	cmp    %esi,%eax
f01041d9:	75 e2                	jne    f01041bd <memcmp+0x12>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
	...
	return 0;
f01041db:	b8 00 00 00 00       	mov    $0x0,%eax
}
f01041e0:	5b                   	pop    %ebx
f01041e1:	5e                   	pop    %esi
f01041e2:	5d                   	pop    %ebp
...
f01041eb:	89 c1                	mov    %eax,%ecx
f01041ed:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
f01041f0:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
f01041f4:	eb 0a                	jmp    f0104200 <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
f01041f6:	0f b6 10             	movzbl (%eax),%edx
f01041f9:	39 da                	cmp    %ebx,%edx
f01041fb:	74 07                	je     f0104204 <memfind+0x20>
...
f0104200:	39 c8                	cmp    %ecx,%eax
f0104202:	72 f2                	jb     f01041f6 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
f010420d:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0104210:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int neg = 0;
	long val = 0;

	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0104213:	eb 03                	jmp    f0104218 <strtol+0x11>
		s++;
...
f010421b:	3c 20                	cmp    $0x20,%al
f010421d:	74 f6                	je     f0104215 <strtol+0xe>
f010421f:	3c 09                	cmp    $0x9,%al
f0104221:	74 f2                	je     f0104215 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
f0104223:	3c 2b                	cmp    $0x2b,%al
f0104225:	75 0a                	jne    f0104231 <strtol+0x2a>
		s++;
f0104227:	83 c1 01             	add    $0x1,%ecx
}
...
{
	int neg = 0;
f010422a:	bf 00 00 00 00       	mov    $0x0,%edi
f010422f:	eb 11                	jmp    f0104242 <strtol+0x3b>
f0104231:	bf 00 00 00 00       	mov    $0x0,%edi
		s++;
...
f0104236:	3c 2d                	cmp    $0x2d,%al
f0104238:	75 08                	jne    f0104242 <strtol+0x3b>
		s++, neg = 1;
f010423a:	83 c1 01             	add    $0x1,%ecx
f010423d:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
f0104242:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
f0104248:	75 15                	jne    f010425f <strtol+0x58>
f010424a:	80 39 30             	cmpb   $0x30,(%ecx)
f010424d:	75 10                	jne    f010425f <strtol+0x58>
f010424f:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
f0104253:	75 7c                	jne    f01042d1 <strtol+0xca>
		s += 2, base = 16;
f0104255:	83 c1 02             	add    $0x2,%ecx
f0104258:	bb 10 00 00 00       	mov    $0x10,%ebx
f010425d:	eb 16                	jmp    f0104275 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
f010425f:	85 db                	test   %ebx,%ebx
f0104261:	75 12                	jne    f0104275 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
f0104263:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
...
f0104268:	80 39 30             	cmpb   $0x30,(%ecx)
f010426b:	75 08                	jne    f0104275 <strtol+0x6e>
		s++, base = 8;
f010426d:	83 c1 01             	add    $0x1,%ecx
f0104270:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
f0104275:	b8 00 00 00 00       	mov    $0x0,%eax
f010427a:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
f010427d:	0f b6 11             	movzbl (%ecx),%edx
f0104280:	8d 72 d0             	lea    -0x30(%edx),%esi
f0104283:	89 f3                	mov    %esi,%ebx
f0104285:	80 fb 09             	cmp    $0x9,%bl
f0104288:	77 08                	ja     f0104292 <strtol+0x8b>
			dig = *s - '0';
f010428a:	0f be d2             	movsbl %dl,%edx
f010428d:	83 ea 30             	sub    $0x30,%edx
f0104290:	eb 22                	jmp    f01042b4 <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
f0104292:	8d 72 9f             	lea    -0x61(%edx),%esi
f0104295:	89 f3                	mov    %esi,%ebx
f0104297:	80 fb 19             	cmp    $0x19,%bl
f010429a:	77 08                	ja     f01042a4 <strtol+0x9d>
			dig = *s - 'a' + 10;
f010429c:	0f be d2             	movsbl %dl,%edx
f010429f:	83 ea 57             	sub    $0x57,%edx
f01042a2:	eb 10                	jmp    f01042b4 <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
f01042a4:	8d 72 bf             	lea    -0x41(%edx),%esi
f01042a7:	89 f3                	mov    %esi,%ebx
f01042a9:	80 fb 19             	cmp    $0x19,%bl
f01042ac:	77 16                	ja     f01042c4 <strtol+0xbd>
			dig = *s - 'A' + 10;
f01042ae:	0f be d2             	movsbl %dl,%edx
f01042b1:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
f01042b4:	3b 55 10             	cmp    0x10(%ebp),%edx
f01042b7:	7d 0b                	jge    f01042c4 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
f01042b9:	83 c1 01             	add    $0x1,%ecx
f01042bc:	0f af 45 10          	imul   0x10(%ebp),%eax
f01042c0:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
f01042c2:	eb b9                	jmp    f010427d <strtol+0x76>

	if (endptr)
f01042c4:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
f01042c8:	74 0d                	je     f01042d7 <strtol+0xd0>
		*endptr = (char *) s;
f01042ca:	8b 75 0c             	mov    0xc(%ebp),%esi
f01042cd:	89 0e                	mov    %ecx,(%esi)
f01042cf:	eb 06                	jmp    f01042d7 <strtol+0xd0>
		s++, neg = 1;
...
f01042d1:	85 db                	test   %ebx,%ebx
f01042d3:	74 98                	je     f010426d <strtol+0x66>
f01042d5:	eb 9e                	jmp    f0104275 <strtol+0x6e>
		// we don't properly detect overflow!
	}
	...
	if (endptr)
		*endptr = (char *) s;
	return (neg ? -val : val);
f01042d7:	89 c2                	mov    %eax,%edx
f01042d9:	f7 da                	neg    %edx
f01042db:	85 ff                	test   %edi,%edi
f01042dd:	0f 45 c2             	cmovne %edx,%eax
}
f01042e0:	5b                   	pop    %ebx
f01042e1:	5e                   	pop    %esi
f01042e2:	5f                   	pop    %edi
f01042e3:	5d                   	pop    %ebp
f01042e4:	c3                   	ret    
f01042e5:	66 90                	xchg   %ax,%ax
f01042e7:	66 90                	xchg   %ax,%ax
f01042e9:	66 90                	xchg   %ax,%ax
f01042eb:	66 90                	xchg   %ax,%ax
f01042ed:	66 90                	xchg   %ax,%ax
f01042ef:	90                   	nop

f01042f0 <__udivdi3>:
f01042f0:	55                   	push   %ebp
f01042f1:	57                   	push   %edi
f01042f2:	56                   	push   %esi
f01042f3:	53                   	push   %ebx
f01042f4:	83 ec 1c             	sub    $0x1c,%esp
f01042f7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
f01042fb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
f01042ff:	8b 4c 24 34          	mov    0x34(%esp),%ecx
f0104303:	8b 7c 24 38          	mov    0x38(%esp),%edi
f0104307:	85 f6                	test   %esi,%esi
f0104309:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f010430d:	89 ca                	mov    %ecx,%edx
f010430f:	89 f8                	mov    %edi,%eax
f0104311:	75 3d                	jne    f0104350 <__udivdi3+0x60>
f0104313:	39 cf                	cmp    %ecx,%edi
f0104315:	0f 87 c5 00 00 00    	ja     f01043e0 <__udivdi3+0xf0>
f010431b:	85 ff                	test   %edi,%edi
f010431d:	89 fd                	mov    %edi,%ebp
f010431f:	75 0b                	jne    f010432c <__udivdi3+0x3c>
f0104321:	b8 01 00 00 00       	mov    $0x1,%eax
f0104326:	31 d2                	xor    %edx,%edx
f0104328:	f7 f7                	div    %edi
f010432a:	89 c5                	mov    %eax,%ebp
f010432c:	89 c8                	mov    %ecx,%eax
f010432e:	31 d2                	xor    %edx,%edx
f0104330:	f7 f5                	div    %ebp
f0104332:	89 c1                	mov    %eax,%ecx
f0104334:	89 d8                	mov    %ebx,%eax
f0104336:	89 cf                	mov    %ecx,%edi
f0104338:	f7 f5                	div    %ebp
f010433a:	89 c3                	mov    %eax,%ebx
f010433c:	89 d8                	mov    %ebx,%eax
f010433e:	89 fa                	mov    %edi,%edx
f0104340:	83 c4 1c             	add    $0x1c,%esp
f0104343:	5b                   	pop    %ebx
f0104344:	5e                   	pop    %esi
f0104345:	5f                   	pop    %edi
f0104346:	5d                   	pop    %ebp
f0104347:	c3                   	ret    
f0104348:	90                   	nop
f0104349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f0104350:	39 ce                	cmp    %ecx,%esi
f0104352:	77 74                	ja     f01043c8 <__udivdi3+0xd8>
f0104354:	0f bd fe             	bsr    %esi,%edi
f0104357:	83 f7 1f             	xor    $0x1f,%edi
f010435a:	0f 84 98 00 00 00    	je     f01043f8 <__udivdi3+0x108>
f0104360:	bb 20 00 00 00       	mov    $0x20,%ebx
f0104365:	89 f9                	mov    %edi,%ecx
f0104367:	89 c5                	mov    %eax,%ebp
f0104369:	29 fb                	sub    %edi,%ebx
f010436b:	d3 e6                	shl    %cl,%esi
f010436d:	89 d9                	mov    %ebx,%ecx
f010436f:	d3 ed                	shr    %cl,%ebp
f0104371:	89 f9                	mov    %edi,%ecx
f0104373:	d3 e0                	shl    %cl,%eax
f0104375:	09 ee                	or     %ebp,%esi
f0104377:	89 d9                	mov    %ebx,%ecx
f0104379:	89 44 24 0c          	mov    %eax,0xc(%esp)
f010437d:	89 d5                	mov    %edx,%ebp
f010437f:	8b 44 24 08          	mov    0x8(%esp),%eax
f0104383:	d3 ed                	shr    %cl,%ebp
f0104385:	89 f9                	mov    %edi,%ecx
f0104387:	d3 e2                	shl    %cl,%edx
f0104389:	89 d9                	mov    %ebx,%ecx
f010438b:	d3 e8                	shr    %cl,%eax
f010438d:	09 c2                	or     %eax,%edx
f010438f:	89 d0                	mov    %edx,%eax
f0104391:	89 ea                	mov    %ebp,%edx
f0104393:	f7 f6                	div    %esi
f0104395:	89 d5                	mov    %edx,%ebp
f0104397:	89 c3                	mov    %eax,%ebx
f0104399:	f7 64 24 0c          	mull   0xc(%esp)
f010439d:	39 d5                	cmp    %edx,%ebp
f010439f:	72 10                	jb     f01043b1 <__udivdi3+0xc1>
f01043a1:	8b 74 24 08          	mov    0x8(%esp),%esi
f01043a5:	89 f9                	mov    %edi,%ecx
f01043a7:	d3 e6                	shl    %cl,%esi
f01043a9:	39 c6                	cmp    %eax,%esi
f01043ab:	73 07                	jae    f01043b4 <__udivdi3+0xc4>
f01043ad:	39 d5                	cmp    %edx,%ebp
f01043af:	75 03                	jne    f01043b4 <__udivdi3+0xc4>
f01043b1:	83 eb 01             	sub    $0x1,%ebx
f01043b4:	31 ff                	xor    %edi,%edi
f01043b6:	89 d8                	mov    %ebx,%eax
f01043b8:	89 fa                	mov    %edi,%edx
...
f01043c8:	31 ff                	xor    %edi,%edi
f01043ca:	31 db                	xor    %ebx,%ebx
f01043cc:	89 d8                	mov    %ebx,%eax
f01043ce:	89 fa                	mov    %edi,%edx
...
f01043d7:	c3                   	ret    
f01043d8:	90                   	nop
f01043d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f01043e0:	89 d8                	mov    %ebx,%eax
f01043e2:	f7 f7                	div    %edi
f01043e4:	31 ff                	xor    %edi,%edi
f01043e6:	89 c3                	mov    %eax,%ebx
f01043e8:	89 d8                	mov    %ebx,%eax
f01043ea:	89 fa                	mov    %edi,%edx
...
f01043f2:	5d                   	pop    %ebp
f01043f3:	c3                   	ret    
f01043f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f01043f8:	39 ce                	cmp    %ecx,%esi
f01043fa:	72 0c                	jb     f0104408 <__udivdi3+0x118>
f01043fc:	31 db                	xor    %ebx,%ebx
f01043fe:	3b 44 24 08          	cmp    0x8(%esp),%eax
f0104402:	0f 87 34 ff ff ff    	ja     f010433c <__udivdi3+0x4c>
f0104408:	bb 01 00 00 00       	mov    $0x1,%ebx
f010440d:	e9 2a ff ff ff       	jmp    f010433c <__udivdi3+0x4c>
f0104412:	66 90                	xchg   %ax,%ax
f0104414:	66 90                	xchg   %ax,%ax
...
f0104427:	8b 54 24 3c          	mov    0x3c(%esp),%edx
f010442b:	8b 4c 24 30          	mov    0x30(%esp),%ecx
f010442f:	8b 74 24 34          	mov    0x34(%esp),%esi
f0104433:	8b 7c 24 38          	mov    0x38(%esp),%edi
f0104437:	85 d2                	test   %edx,%edx
f0104439:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
f010443d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0104441:	89 f3                	mov    %esi,%ebx
f0104443:	89 3c 24             	mov    %edi,(%esp)
f0104446:	89 74 24 04          	mov    %esi,0x4(%esp)
f010444a:	75 1c                	jne    f0104468 <__umoddi3+0x48>
f010444c:	39 f7                	cmp    %esi,%edi
f010444e:	76 50                	jbe    f01044a0 <__umoddi3+0x80>
f0104450:	89 c8                	mov    %ecx,%eax
f0104452:	89 f2                	mov    %esi,%edx
f0104454:	f7 f7                	div    %edi
f0104456:	89 d0                	mov    %edx,%eax
f0104458:	31 d2                	xor    %edx,%edx
f010445a:	83 c4 1c             	add    $0x1c,%esp
f010445d:	5b                   	pop    %ebx
f010445e:	5e                   	pop    %esi
f010445f:	5f                   	pop    %edi
f0104460:	5d                   	pop    %ebp
f0104461:	c3                   	ret    
f0104462:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
f0104468:	39 f2                	cmp    %esi,%edx
f010446a:	89 d0                	mov    %edx,%eax
f010446c:	77 52                	ja     f01044c0 <__umoddi3+0xa0>
f010446e:	0f bd ea             	bsr    %edx,%ebp
f0104471:	83 f5 1f             	xor    $0x1f,%ebp
f0104474:	75 5a                	jne    f01044d0 <__umoddi3+0xb0>
f0104476:	3b 54 24 04          	cmp    0x4(%esp),%edx
f010447a:	0f 82 e0 00 00 00    	jb     f0104560 <__umoddi3+0x140>
f0104480:	39 0c 24             	cmp    %ecx,(%esp)
f0104483:	0f 86 d7 00 00 00    	jbe    f0104560 <__umoddi3+0x140>
f0104489:	8b 44 24 08          	mov    0x8(%esp),%eax
f010448d:	8b 54 24 04          	mov    0x4(%esp),%edx
f0104491:	83 c4 1c             	add    $0x1c,%esp
f0104494:	5b                   	pop    %ebx
f0104495:	5e                   	pop    %esi
f0104496:	5f                   	pop    %edi
f0104497:	5d                   	pop    %ebp
...
f01044a0:	85 ff                	test   %edi,%edi
f01044a2:	89 fd                	mov    %edi,%ebp
f01044a4:	75 0b                	jne    f01044b1 <__umoddi3+0x91>
f01044a6:	b8 01 00 00 00       	mov    $0x1,%eax
f01044ab:	31 d2                	xor    %edx,%edx
f01044ad:	f7 f7                	div    %edi
f01044af:	89 c5                	mov    %eax,%ebp
f01044b1:	89 f0                	mov    %esi,%eax
f01044b3:	31 d2                	xor    %edx,%edx
f01044b5:	f7 f5                	div    %ebp
f01044b7:	89 c8                	mov    %ecx,%eax
f01044b9:	f7 f5                	div    %ebp
f01044bb:	89 d0                	mov    %edx,%eax
f01044bd:	eb 99                	jmp    f0104458 <__umoddi3+0x38>
f01044bf:	90                   	nop
f01044c0:	89 c8                	mov    %ecx,%eax
f01044c2:	89 f2                	mov    %esi,%edx
f01044c4:	83 c4 1c             	add    $0x1c,%esp
f01044c7:	5b                   	pop    %ebx
f01044c8:	5e                   	pop    %esi
f01044c9:	5f                   	pop    %edi
f01044ca:	5d                   	pop    %ebp
f01044cb:	c3                   	ret    
f01044cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f01044d0:	8b 34 24             	mov    (%esp),%esi
f01044d3:	bf 20 00 00 00       	mov    $0x20,%edi
f01044d8:	89 e9                	mov    %ebp,%ecx
f01044da:	29 ef                	sub    %ebp,%edi
f01044dc:	d3 e0                	shl    %cl,%eax
f01044de:	89 f9                	mov    %edi,%ecx
f01044e0:	89 f2                	mov    %esi,%edx
f01044e2:	d3 ea                	shr    %cl,%edx
f01044e4:	89 e9                	mov    %ebp,%ecx
f01044e6:	09 c2                	or     %eax,%edx
f01044e8:	89 d8                	mov    %ebx,%eax
f01044ea:	89 14 24             	mov    %edx,(%esp)
f01044ed:	89 f2                	mov    %esi,%edx
f01044ef:	d3 e2                	shl    %cl,%edx
f01044f1:	89 f9                	mov    %edi,%ecx
f01044f3:	89 54 24 04          	mov    %edx,0x4(%esp)
f01044f7:	8b 54 24 0c          	mov    0xc(%esp),%edx
f01044fb:	d3 e8                	shr    %cl,%eax
f01044fd:	89 e9                	mov    %ebp,%ecx
f01044ff:	89 c6                	mov    %eax,%esi
f0104501:	d3 e3                	shl    %cl,%ebx
f0104503:	89 f9                	mov    %edi,%ecx
f0104505:	89 d0                	mov    %edx,%eax
f0104507:	d3 e8                	shr    %cl,%eax
f0104509:	89 e9                	mov    %ebp,%ecx
f010450b:	09 d8                	or     %ebx,%eax
f010450d:	89 d3                	mov    %edx,%ebx
f010450f:	89 f2                	mov    %esi,%edx
f0104511:	f7 34 24             	divl   (%esp)
f0104514:	89 d6                	mov    %edx,%esi
f0104516:	d3 e3                	shl    %cl,%ebx
f0104518:	f7 64 24 04          	mull   0x4(%esp)
f010451c:	39 d6                	cmp    %edx,%esi
f010451e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f0104522:	89 d1                	mov    %edx,%ecx
f0104524:	89 c3                	mov    %eax,%ebx
f0104526:	72 08                	jb     f0104530 <__umoddi3+0x110>
f0104528:	75 11                	jne    f010453b <__umoddi3+0x11b>
f010452a:	39 44 24 08          	cmp    %eax,0x8(%esp)
f010452e:	73 0b                	jae    f010453b <__umoddi3+0x11b>
f0104530:	2b 44 24 04          	sub    0x4(%esp),%eax
f0104534:	1b 14 24             	sbb    (%esp),%edx
f0104537:	89 d1                	mov    %edx,%ecx
f0104539:	89 c3                	mov    %eax,%ebx
f010453b:	8b 54 24 08          	mov    0x8(%esp),%edx
f010453f:	29 da                	sub    %ebx,%edx
f0104541:	19 ce                	sbb    %ecx,%esi
f0104543:	89 f9                	mov    %edi,%ecx
f0104545:	89 f0                	mov    %esi,%eax
f0104547:	d3 e0                	shl    %cl,%eax
f0104549:	89 e9                	mov    %ebp,%ecx
f010454b:	d3 ea                	shr    %cl,%edx
f010454d:	89 e9                	mov    %ebp,%ecx
f010454f:	d3 ee                	shr    %cl,%esi
f0104551:	09 d0                	or     %edx,%eax
f0104553:	89 f2                	mov    %esi,%edx
f0104555:	83 c4 1c             	add    $0x1c,%esp
f0104558:	5b                   	pop    %ebx
f0104559:	5e                   	pop    %esi
f010455a:	5f                   	pop    %edi
f010455b:	5d                   	pop    %ebp
...
f0104560:	29 f9                	sub    %edi,%ecx
f0104562:	19 d6                	sbb    %edx,%esi
f0104564:	89 74 24 04          	mov    %esi,0x4(%esp)
f0104568:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f010456c:	e9 18 ff ff ff       	jmp    f0104489 <__umoddi3+0x69>
