...
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabn	162,0,0,0
	.stabs	"./inc/elf.h",130,0,0,0
	.stabs	"Elf:T(5,1)=s52e_magic:(4,9),0,32;e_elf:(5,2)=ar(2,3);0;11;(4,5),32,96;e_type:(4,7),128,16;e_machine:(4,7),144,16;e_version:(4,9),160,32;e_entry:(4,9),192,32;e_phoff:(4,9),224,32;e_shoff:(4,9),256,32;e_flags:(4,9),288,32;e_ehsize:(4,7),320,16;e_phentsize:(4,7),336,16;e_phnum:(4,7),352,16;e_shentsize:(4,7),368,16;e_shnum:(4,7),384,16;e_shstrndx:(4,7),400,16;;",128,0,0,0
	.stabs	"Proghdr:T(5,3)=s32p_type:(4,9),0,32;p_offset:(4,9),32,32;p_va:(4,9),64,32;p_pa:(4,9),96,32;p_filesz:(4,9),128,32;p_memsz:(4,9),160,32;p_flags:(4,9),192,32;p_align:(4,9),224,32;;",128,0,0,0
	.stabs	"Secthdr:T(5,4)=s40sh_name:(4,9),0,32;sh_type:(4,9),32,32;sh_flags:(4,9),64,32;sh_addr:(4,9),96,32;sh_offset:(4,9),128,32;sh_size:(4,9),160,32;sh_link:(4,9),192,32;sh_info:(4,9),224,32;sh_addralign:(4,9),256,32;sh_entsize:(4,9),288,32;;",128,0,0,0
	.stabn	162,0,0,0
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L10:
	.stabn	68,0,59,.LM23-.LFBB3
.LM23:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,62,.LM24-.LFBB3
.LM24:
	cmpq	$0, panicstr(%rip)
	je	.L15
	.p2align 4,,10
...
.LM31:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,71,.LM32-.LFBB3
.LM32:
	movq	%rbx, %rdi
	movq	%rsp, %rsi
	call	vcprintf
	.stabn	68,0,72,.LM33-.LFBB3
.LM33:
	movl	$.LC7, %edi
	xorl	%eax, %eax
	call	cprintf
